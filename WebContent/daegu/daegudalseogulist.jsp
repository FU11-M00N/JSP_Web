...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">이월드</font>
			</div>
			<div class="admin4">
				<font class="board2">호산공원</font>
			</div>
			<div class="slideshow">
					<a href="eworld.jsp" class="aaa"><img src=".\..\img\이월드.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="hosanpark.jsp" class="aaa"><img src=".\..\img\호산공원.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>