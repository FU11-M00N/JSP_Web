...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.830220,128.701928); // 위치값 위도 경도
	var Y_point			= 35.830220;		// Y 좌표
	var X_point			= 128.701928;		// X 좌표
	var zoomLevel		= 15;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "노변동 사직단";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>노변동 사직단</h2>'+
	'<p>대구광역시 수성구 노변동 유니버시아드로</p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" ><a href=".\..\daegu\daegujunggulist.jsp" class="aaa">중구</a></th>
		    <th class="top2"><a href=".\..\daegu\daegubukgulist.jsp" class="aaa">북구</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		    <td class="bottom" style="font-weight:bold"><a href=".\..\daegu\daegususunggulist.jsp" class="aaa">수성구</a></td>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">노변동 사직단</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\노변동사직단.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			자연을 벗 삼은 대구문화재<br><br>

			대구광역시 수성구 노변동에는 조선시대 사직단인 노변동 사직단이 자리 잡고 있습니다. <br>
			대구기념물 제16호로 지정되어 있으며, 자연을 벗 삼아 둘러볼 수 있는 문화재입니다. <br>
			사직단이란 임금이 백성을 위하여 토신인 사와 곡신인 직에게 제사를 지내던 제단입니다.<br>
			사직단과 주변을 공원화시켜 유적공원을 조성하였으며, 탁 트인 공원에서 힐링을 즐기며 유적지를 둘러보기 좋습니다.<br><br>
			
			위치: 대구광역시 수성구 노변동 유니버시아드로<br>
