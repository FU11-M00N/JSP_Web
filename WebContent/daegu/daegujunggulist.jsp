...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">달성공원</font>
			</div>
			<div class="admin4">
				<font class="board2">관덕정 순교 기념관</font>
			</div>
			<div class="slideshow">
					<a href="dalseongpark.jsp" class="aaa"><img src=".\..\img\달성공원.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="gwandukjung.jsp" class="aaa"><img src=".\..\img\관덕정순교기념관.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>