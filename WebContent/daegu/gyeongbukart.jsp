...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.892630,128.609792); // 위치값 위도 경도
	var Y_point			= 35.892630;		// Y 좌표
	var X_point			= 128.609792;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "경북대학교 미술관";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>경북대학교 미술관</h2>'+
	'<p>대구광역시 북구 산격동 대학로 80</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">경북대학교 미술관</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\경북대학교미술관.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			다양한 전시 및 공연을 관람할 수 있는 곳<br><br>

			대구광역시 북구에 위치해있는 경북대학교 내 미술관은 총 3개의 전시실에서 미술품이 전시되고 있으며,<br>
			미술작품뿐만 아니라 여러 공연 및 학술행사도 열리고 있어 다양한 볼거리, 즐길 거리를 제공하고 있습니다. <br>
			근, 현대 미술품을 만날 수 있는 곳이라 문화 생활을 하며 둘러 보기 좋은 곳입니다.<br><br>
			
			위치: 대구광역시 북구 산격동 대학로 80<br>
