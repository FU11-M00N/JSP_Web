...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">경북대학교 미술관</font>
			</div>
			<div class="admin4">
				<font class="board2">하중도</font>
			</div>
			<div class="slideshow">
					<a href="gyeongbukart.jsp" class="aaa"><img src=".\..\img\경북대학교미술관.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="hajungdo.jsp" class="aaa"><img src=".\..\img\하중도.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>