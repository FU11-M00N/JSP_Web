...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.351407,128.789262); // 위치값 위도 경도
	var Y_point			= 37.351407;		// Y 좌표
	var X_point			= 128.789262;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "화암동굴";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	...
	<div>
		...
		<thead>
		  <tr>
		    ...
		    <th class="top2"><a href=".\..\gangwondo\gangneunglist.jsp" class="aaa">강릉</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		    <td class="bottom"><a href=".\..\gangwondo\sokcholist.jsp" class="aaa">속초</a></td>
		    <td class="bottom2" style="font-weight:bold"><a href=".\..\gangwondo\jeongseonlist.jsp" class="aaa">정선</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">화암동굴</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\화암동굴.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			자연의 신비를 체험해볼 수 있는 동굴 <br>
			화암관광단지 내 금광산과 석회석 생성물을 관찰해볼 수 있는 화암동굴은 역사이야기를 알아보고, 알록달록하게 꾸며진 동화 속 테마 동굴을 체험해볼 수 있는 곳으로 자연의 신비로움까지 느껴볼 수 있습니다 <br>
			정선 화암동굴은 화암관광단지 내에 위치한 금광산과 석회석 생성물을 관찰해 볼 수 있는 동굴로 환상적인 동굴을 테마별로 나누어 자세히 알아보고 체험해 볼 수 있는 이색적인 관광지입니다 <br><br>


			위치: 강원 정선군 화암면 화암리 540
		</div>
		</div>
		</div>
</body>
