...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">동명항, 영금정</font>
			</div>
			<div class="admin4">
				<font class="board2">엑스포타워</font>
			</div>
			<div class="slideshow">
					<a href="dongmyeongport.jsp" class="aaa"><img src=".\..\img\동명항,영금정.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="expo.jsp" class="aaa"><img src=".\..\img\속초엑스포타워 야경.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>