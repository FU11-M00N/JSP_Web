...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.864147,127.753712); // 위치값 위도 경도
	var Y_point			= 37.864147;		// Y 좌표
	var X_point			= 127.753712;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "국립 춘천박물관";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">국립 춘천박물관</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\국립춘천박물관.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			강원도 역사와 문화의 중심 <br>
			강원도 춘천시에 위치한 국립 박물관으로 춘천지역 강원지역의 역사와 문화를 보고 듣고 체험까지 해볼 수 있는 복합문화공간입니다 <br>
			국립춘천 박물관은 강원지역 문화를 널리 알리기 위해 설립된 공간으로 박물관의 개념을 깨기 위해 자작나무와 소나무 숲 속에 자연친화적인 숲 속의 배움터를 만들어 강원의 역사와 문화를 직접 체험할 수 있도록 만든 신개념의 열린 문화공간입니다 <br><br>
