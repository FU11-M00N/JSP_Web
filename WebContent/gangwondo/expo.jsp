...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(38.191660,128.583085); // 위치값 위도 경도
	var Y_point			= 38.191660;		// Y 좌표
	var X_point			= 128.583085;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "엑스포타워";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>엑스포타워</h2>'+
	'<p>속초시 엑스포로 조양동 엑스포로 72</p>' +
...
<body>
	...
	<div>
		...
		<tbody>
		  <tr>
		    <td class="bottom" style="font-weight:bold"><a href=".\..\gangwondo\sokcholist.jsp" class="aaa">속초</a></td>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">엑스포타워</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\속초엑스포타워 야경.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			속초의 랜드마크 아름다운 엑스포타워 <br>
			속초 엑스포타워는 아름다운 경관을 자랑하는 청초호변에 위치해 있는 곳으로 자연과 현대 건축의 예술적 조화가 특징이며, <br>
			특히 환상적인 야경을 자랑하여 속초의 랜드마크로 통하고 있습니다. 독특한 외관과 더불어 산과 호수가 어우러진 자연공원 속 하이테크 전망타워로 속초의 대표 관광지로 자리 잡고 있는 곳입니다 <br><br>


			위치: 강원 속초시 엑스포로 조양동 엑스포로 72
		</div>
		</div>
		</div>
</body>
