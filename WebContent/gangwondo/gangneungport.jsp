...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.770968,128.950327); // 위치값 위도 경도
	var Y_point			= 37.770968;		// Y 좌표
	var X_point			= 128.950327;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "강릉항";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>강릉항</h2>'+
	'<p>강릉시 창해로14번길 55-7</p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top"><a href=".\..\gangwondo\chuncheonlist.jsp" class="aaa">춘천</a></th>
		    <th class="top2" style="font-weight:bold"><a href=".\..\gangwondo\gangneunglist.jsp" class="aaa">강릉</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		    <td class="bottom"><a href=".\..\gangwondo\sokcholist.jsp" class="aaa">속초</a></td>
		    <td class="bottom2"><a href=".\..\gangwondo\jeongseonlist.jsp" class="aaa">정선</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">강릉항</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\강릉항.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			빨간등대, 푸른바다 그리고 시원한바람 <br>
			강릉시 견소동에 위치한 강릉항은 푸른 바다와 빨간 등대가 자연과 잘 조화를 이루며, 안목해변에는 안목카페거리가 있어 바닷가의 낭만적인 분위기를 즐길 수 있습니다 <br>
			강릉의 주요 하천인 남대천 하류에 있는 항구로 인근에 안목해수욕장이 있어 백사장과 해송이 멋진 곳으로 유명한데요,한폭의 풍경화처럼 멋진 안목해변은 항구와 해변을 끼고 들어선 멋진 카페들이  <br>
			있는 유명한 카페거리도 있어서 데이트코스나 나들이코스로 인기 있는 곳입니다 <br><br>

			위치: 강원 강릉시 창해로14번길 55-7 (견소동)
		</div>
		</div>
		</div>
</body>
