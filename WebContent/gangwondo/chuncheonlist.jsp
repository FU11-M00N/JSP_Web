...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">남이섬</font>
			</div>
			<div class="admin4">
				<font class="board2">국립 춘천박물관</font>
			</div>
			<div class="slideshow">
					<a href="namiseom.jsp" class="aaa"><img src=".\..\img\남이섬.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="chuncheonmuseum.jsp" class="aaa"><img src=".\..\img\국립춘천박물관.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>