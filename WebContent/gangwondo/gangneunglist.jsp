...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">강릉항</font>
			</div>
			<div class="admin4">
				<font class="board2">경포호</font>
			</div>
			<div class="slideshow">
					<a href="gangneungport.jsp" class="aaa"><img src=".\..\img\강릉항.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="gyeongpoholake.jsp" class="aaa"><img src=".\..\img\경포호.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>