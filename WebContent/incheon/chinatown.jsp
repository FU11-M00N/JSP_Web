...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.474864,126.618442); // 위치값 위도 경도
	var Y_point			= 37.474864;		// Y 좌표
	var X_point			= 126.618442;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "차이나타운";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>차이나타운</h2>'+
	'<p>인천 중구 차이나타운로 54-1</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">차이나타운</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\차이나타운.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			인천하면 차이나타운!<br><br>

			차이나타운은 1883년 인천항이 개항된 후 중국인들이 일대에 정착하여 그들만의 생활문화를 형성한 곳입니다.<br>
			현재 역사적 의미가 담긴 관광명소로 쇼핑, 예술의거리, 맛집, 특화점 등 먹거리는 물론 볼거리, 즐길 거리가 가득한 곳입니다.<br>
			근방에 둘러볼 곳이 많고, 제법 넓은 편이지만곳곳에 관광안내도가 배치되어 있어서 편하고, 알차게 둘러볼 수 있습니다.<br><br>
			
			위치: 인천 중구 차이나타운로 54-1<br>
