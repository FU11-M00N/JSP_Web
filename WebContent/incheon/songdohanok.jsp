...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(39.391195,126.638194); // 위치값 위도 경도
	var Y_point			= 37.391195;		// Y 좌표
	var X_point			= 126.638194;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "송도 한옥마을";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">송도 한옥마을</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\송도한옥마을.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			야경이 아름다운 송도한옥마을<br><br>

			송도 신도시 센트럴파크 호텔 맞은편에 위치해있는 한옥마을은 한옥의 멋스러움을 뽐내고 있으며, <br>
			화려한 야경으로 많은 사람들의 발길이 끊이질 않고 있습니다. 요즘 맛집을 한 곳에 모아놓은<br>
			 푸드타운이 각지에서 인기를 끌고 있는 가운데, 송도 신도시에 '한옥마을'을 조성한 종합외식공간이 바로 송도한옥마을입니다.<br><br>
