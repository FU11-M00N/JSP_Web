...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.508134,126.665412); // 위치값 위도 경도
	var Y_point			= 37.508134;		// Y 좌표
	var X_point			= 126.665412;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "신석 체육공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>신석 체육공원</h2>'+
	'<p>인천광역시 서구 석남동 222</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">신석 체육공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\신석체육공원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			벚꽃 구경하기 좋은 아름다운 공원<br><br>

			인천 서구 신석체육공원은 시민의 여가생활을 위해 조성된 공원으로 봄을 가장 먼저 알리는 벚꽃을 구경하며 <br>
			걷기 좋아 데이트 장소, 가족 나들이 장소로 안성맞춤인 곳입니다. 큰 규모는 아니지만 많은 사람들이 벚꽃 하면 <br>
			신석 체육공원을 생각할 정도로 아름다운 벚꽃을 만날 수 있는 곳입니다. 인천 서구 신석 체육공원은 포스코 에너지에서 조성한 공원입니다.<br><br>
			
			위치: 인천광역시 서구 석남동 222<br>
