...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.482369,126.628859); // 위치값 위도 경도
	var Y_point			= 37.482369;		// Y 좌표
	var X_point			= 126.628859;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "화도진공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>화도진공원</h2>'+
	'<p>인천광역시 동구 화수동 화도진로 114</p>' +
	...
	<div>
		...
		<thead>
		  <tr>
		    ...
		    <th class="top2"style="font-weight:bold"><a href=".\..\incheon\incheondonggulist.jsp" class="aaa">동구</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">화도진공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\화도진공원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			벚꽃이 전해주는 따뜻한 봄기운<br><br>

			구한말 수도 서울의 유일한 수로관문이었던 화도진공원은 봄이면 벚꽃과 함께 <br>
			고즈넉한 한옥의 모습이 장관을 이루는 곳으로 훌륭한 휴식공간이자 역사의 산교육장이 되어주고 있습니다.<br>
			화도진공원은 구한말에 서해안 방어를 위해 인천 앞바다에 설치한 진지입니다.<br>
			구한말 수도 서울의 유일한 수로관문이었던 화도진공원은 현재 인천광역시 기념물 제2호로 지정되었습니다.<br><br>
			
			위치: 인천광역시 동구 화수동 화도진로 114<br>
