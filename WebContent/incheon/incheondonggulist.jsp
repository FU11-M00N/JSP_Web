...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">늘솔길공원</font>
			</div>
			<div class="admin4">
				<font class="board2">화도진공원</font>
			</div>
			<div class="slideshow">
					<a href="alwaysbluepark.jsp" class="aaa"><img src=".\..\img\늘솔길공원.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="whadojinpark.jsp" class="aaa"><img src=".\..\img\화도진공원.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>