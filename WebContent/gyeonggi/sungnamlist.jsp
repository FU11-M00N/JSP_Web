...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">중앙공원 벚꽃</font>
			</div>
			<div class="admin4">
				<font class="board2">미누 현대미술관</font>
			</div>
			<div class="slideshow">
					<a href="cherryblossoms.jsp" class="aaa"><img src=".\..\img\중앙공원 벚꽃.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="artmuseum.jsp" class="aaa"><img src=".\..\img\미누현대미술관.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>