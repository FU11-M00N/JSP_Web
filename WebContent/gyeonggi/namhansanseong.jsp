...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.485042,127.175826); // 위치값 위도 경도
	var Y_point			= 37.485042;		// Y 좌표
	var X_point			= 127.175826;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "남한산성 서문";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>남한산성 서문</h2>'+
	'<p>광주시 남한산성면 남한산성로780번길 105</p>' +
...
<body>
	...
	<div>
		...
		<tbody>
		  <tr>
		    <td class="bottom"><a href=".\..\gyeonggi\ansanlist.jsp" class="aaa">안산</a></td>
		    <td class="bottom2" style="font-weight:bold"><a href=".\..\gyeonggi\gwangjulist.jsp" class="aaa">광주</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">남한산성 서문</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\남한산성 서문.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			도심의 아름다움을 한눈에 <br>
			경기도 광주시에 위치해있는 남한산성에서는 일몰 무렵부터 멋진 절경을 이루는 야경을 감상할 수 있으며, 주변의 다양한 볼거리, 먹거리 등으로 즐거운 시간을 보낼 수 있습니다 <br>
			남한산성은 신라 주장성의 옛 터로 조선 인조 때, 한양의 방어를 위해 개축한 것으로 알려져 있습니다. 국가의 유사시에 대비하여 모든 시설을 갖추었고, 순조 때까지 성내의 시설 확장이 계속 되었는데요, <br>
			일제강점기에 일본군에 의해 많은 문화유산이 소실되었지만, 남한산성 주변에 여전히 많은 문화유산이 남겨져 있고, 그 가치를 인정받아 유네스코 세계 문화유산에 등록되는 등 새롭게 주목을 받고 있습니다 <br><br>
			
			위치: 경기 광주시 남한산성면 남한산성로780번길 105
		</div>
		</div>	
</body>
</html>