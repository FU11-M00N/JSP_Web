...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">별빛마을 포토랜드</font>
			</div>
			<div class="admin4">
				<font class="board2">유리섬 박물관</font>
			</div>
			<div class="slideshow">
					<a href="star.jsp" class="aaa"><img src=".\..\img\별빛마을포토랜드.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="glass.jsp" class="aaa"><img src=".\..\img\유리섬박물관.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>