...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.484148,127.177131); // 위치값 위도 경도
	var Y_point			= 37.484148;		// Y 좌표
	var X_point			= 127.177131;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "국청사";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">국청사</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\국청사.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			사진과 등산을 즐기는곳! 국청사 <br>
			도심속 야경을 구경을 가고싶으면 남한산성에 위치해 있는 국청사를 추천합니다. 도심의 야경을 전망대에서 감상을 할 수 있으며, 이쁘고 의미있는 사진을 많이 찍을 수 있는 <br>
			국청사에서 추억을 남겨보는 것이 좋을 것 같습니다. 남한산성의 서문 밑에 위치하고 있으며 이 절은 조선 인조 3년인 1625년 각성대사에 의하여 창건이 되었습니다 <br><br>
			
			위치: 경기 광주시 중부면 산성리 802
		</div>
		</div>	
</body>
</html>