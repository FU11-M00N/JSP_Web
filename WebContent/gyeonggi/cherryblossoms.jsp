...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.377893,127.124676); // 위치값 위도 경도
	var Y_point			= 37.377893;		// Y 좌표
	var X_point			= 127.124676;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "중앙공원 벚꽃";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>중앙공원 벚꽃</h2>'+
	'<p>성남시 분당구 성남대로 550</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">중앙공원 벚꽃</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\중앙공원 벚꽃.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			성남의 대표적인 봄맞이 장소 <br>
			성남의 유명 벚꽃길 8경으로 손꼽히는 중앙공원은 분당호 수내정 주변으로 줄지어 만발해 아름다운 경관을 자랑하며 수양버들처럼 늘어져 있는 벚꽃나무와 <br>
			호수가 조화롭게 자리하여 데이트 장소로 사랑받는 장소입니다. 중앙공원 내 분당 천변 벚꽃길은 성남 벚꽃길 8경 중 제1경으로, 가족과 연인들이 데이트하기 좋은 곳입니다 <br><br>
			
			위치: 경기 성남시 분당구 성남대로 550
		</div>
		</div>	
</body>
</html>