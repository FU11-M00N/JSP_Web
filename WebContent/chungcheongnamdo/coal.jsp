...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.326448,126.653462); // 위치값 위도 경도
	var Y_point			= 36.326448;		// Y 좌표
	var X_point			= 126.653462;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "석탄 박물관";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>석탄 박물관</h2>'+
	'<p>충남 보령시 성주면 성주산로 508</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">석탄 박물관</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\석탄박물관.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			석탄의 역사성과 가치를 알 수 있는 곳 <br>
			보령지역에 유일한 공립박물관으로 우리의 주된 연료였던 석탄의 역사성과 그 가치를 알리기 위하여 개관된 곳입니다 <br>
			석탄 박물관은 7~80년대에 우리의 주 연료였던 석탄산업의 역사를 보존하고 있는 곳으로 석탄의 생성과정부터 탄광 발달과정, 작업환경, 장비 등 다양한 석탄에 관련된 자료를 보존하고 전시하고 있는 곳입니다 <br><br>
