...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">석탄 박물관</font>
			</div>
			<div class="admin4">
				<font class="board2">충청수영성</font>
			</div>
			<div class="slideshow">
					<a href="coal.jsp" class="aaa"><img src=".\..\img\석탄박물관.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="suyeongseong.jsp" class="aaa"><img src=".\..\img\오천수영성.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>