...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.188207,127.113198); // 위치값 위도 경도
	var Y_point			= 36.188207;		// Y 좌표
	var X_point			= 127.113198;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "관촉사";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">관촉사</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\관촉사.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			은진미륵의 미소가 아름다운 사찰 <br>
			고려 광종 때 혜명대사에 의해 창건된 유서 깊은 사찰로 은진미륵이 대표적인 사찰의 상징이며 <br>
			논산 8경 중 제1경으로 꼽히는 곳으로 많은 분들이 찾는 명소입니다. 대한 불교 조계종 제6교구 본사인 마곡사의 말사인 <br>
			관촉사는 968년(광종 19)에 혜명(慧明)이 짓기 시작하여 1006년에 완공된 사찰입니다.천왕문을 지나면 비로소 아늑하면서도 엄숙한 분위기의 관촉사를 마주할 수 있습니다 <br><br>
