...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.796987,127.209218); // 위치값 위도 경도
	var Y_point			= 36.796987;		// Y 좌표
	var X_point			= 127.209218;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "흑성산성";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>흑성산성</h2>'+
	'<p>천안시 동남구 목천읍 교촌리 산 32-1</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">흑성산성</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\흑성산성.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			가을이 아름다운 곳 '흑성산성' <br>
			충청남도 천안시 동남구에 위치해있는 흑성산성은 충청남도 문화재로 등록이 되어있으며, 천안의 유일한 산성으로 남아있는 곳입니다 <br>
			탁 트인 조망을 자랑하며, 일출과 낙조로도 유명한 곳입니다.충청남도 문화재자료 제364호로 지정된 흑성산성은 본래 이름은 검은성이지만 일제강점기 때, <br>
			흑성산성으로 바뀌어 지금까지 이어지고 있습니다. 천안의 옛 산성 중 기록이 남아있는 유일한 산성으로 역사적 가치가 있는 곳입니다 <br><br>

			위치: 충남 천안시 동남구 목천읍 교촌리 산 32-1
		</div>
		</div>
		</div>
</body>
