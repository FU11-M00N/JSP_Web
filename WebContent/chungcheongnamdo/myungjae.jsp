...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.282011,127.131513); // 위치값 위도 경도
	var Y_point			= 36.282011;		// Y 좌표
	var X_point			= 127.131513;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "명재고택";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>명재고택</h2>'+
	'<p>논산시 노성면 논성산성길 50</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">명재고택</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\명재고택.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			논산 여행지 추천! 명재고택 <br>
			명재는 윤증선생의 호로 과거에는 윤증선생고택으로 불리기도 하였습니다. 호서지방의 대표적인 기와집이라고 하는데, <br>
			조선시대 정형적인 상류층이라고 합니다. 명재고택은 호서지방의 대표적인 양반가옥의 형태를 보여주고 있습니다 <br>
			창 밖으로 보이는 아름다운 풍경, 한옥의 아름다움 속에 빠져보세요.가족, 친구, 연인과 함께 삼백년 선비의 집 명재고택을 둘러보는건 어떨까요 ? <br><br>

			위치: 충남 논산시 노성면 논성산성길 50
		</div>
		</div>
		</div>
</body>
