...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.439897,126.522775); // 위치값 위도 경도
	var Y_point			= 36.439897;		// Y 좌표
	var X_point			= 126.522775;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "충청수영성";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>충청수영성</h2>'+
	'<p>보령시 오천면 소성리 660-2</p>' +
	...
	<div>
		...
		<thead>
		  <tr>
		    ...
		    <th class="top2" style="font-weight:bold"><a href=".\..\chungcheongnamdo\boryeonglist.jsp" class="aaa">보령</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">충청수영성</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\오천수영성.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			멋진 바다 풍경과 함께 하는 역사 여행 <br>
			충청남도 보령시 오천면에 위치한 충청수영성은 성 안에서 성 밖을 볼 수 있고, 바다를 관측할 수 있는 곳으로, 오천항이 한눈에 내려다보이는 멋진 풍경과 함께 하는 역사적관광지입니다 <br>
			충청수영성은 조선 중종 15년에 설치된 성으로 임진왜란 당시 오천수영 수군이 이순신장군을 도와 꽤 많은 공을 세웠지만 비극적인 최후를 맞아 항전 진주대첩을 끝으로 폐허된 역사적 관광지입니다 <br><br>


			위치: 충남 보령시 오천면 소성리 660-2
		</div>
		</div>
		</div>
</body>
