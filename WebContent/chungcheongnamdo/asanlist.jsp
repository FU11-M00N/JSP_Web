...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">현충사</font>
			</div>
			<div class="admin4">
				<font class="board2">온양향교</font>
			</div>
			<div class="slideshow">
					<a href="hyeonchungsa.jsp" class="aaa"><img src=".\..\img\현충사.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="onyang.jsp" class="aaa"><img src=".\..\img\온양향교.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>