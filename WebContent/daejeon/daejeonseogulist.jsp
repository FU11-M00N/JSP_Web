...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">충효사</font>
			</div>
			<div class="admin4">
				<font class="board2">발명인의 전당</font>
			</div>
			<div class="slideshow">
					<a href="chunghyosa.jsp" class="aaa"><img src=".\..\img\충효사.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="developmuseum.jsp" class="aaa"><img src=".\..\img\발명인의전당.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>