...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.306383,127.419786); // 위치값 위도 경도
	var Y_point			= 36.306383;		// Y 좌표
	var X_point			= 127.419786;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "송학사";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>송학사</h2>'+
	'<p>대전광역시 중구 대사동 197-208</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">송학사</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\송학사.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			별빛이 곱게 내려 앉은<br><br>

			보문산에 위치한 송학사는 나무로 지어진 고전식 법당이다. 송학사는 보문산의 약수터로도 유명하며 <br>
			봄이되면 홍도화와 매화가 절정에 이르러 보문산을 찾는 시민들이 많다.  대전 중심부에 자리잡은 보문산을 <br>
			300미터 정도 오르면 송학사가 있습니다. 많은 사람들이 다니는 길목에 자리하고 있지만 조용하고 아름다운 풍경을 자랑하는 곳입니다.<br><br>


			
			위치: 대전광역시 중구 대사동 197-208<br>
		</div>
		</div>
		</div>
</body>
