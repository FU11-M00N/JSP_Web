...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">대전 중앙시장</font>
			</div>
			<div class="admin4">
				<font class="board2">우암사적공원</font>
			</div>
			<div class="slideshow">
					<a href="daejeonmarket.jsp" class="aaa"><img src=".\..\img\대전중앙시장.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="woampark.jsp" class="aaa"><img src=".\..\img\우암사적공원.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>