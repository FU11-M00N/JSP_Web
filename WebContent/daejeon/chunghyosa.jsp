...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.344494,127.396845); // 위치값 위도 경도
	var Y_point			= 36.344494;		// Y 좌표
	var X_point			= 127.396845;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "충효사";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>충효사</h2>'+
	'<p>대전광역시 서구 탄방동 1083</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">충효사</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\충효사.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			좋은 기운 받고 가세요<br><br>

			대전 탄방동 남선공원 아래에 충효사라는 고즈넉한 사찰이 있습니다.<br>
			계롱산 정봉이 보이는 충효사는 좌청용 우백호가 갖추어진 도심속의 명당 기도 도량입니다.<br>
			많은 사람들이 108배를 하며 소원성취를 위해 이곳을 찾기도 하며 <br>
			큰 큐모는 아니지만 사찰의 정취와 고즈넉한 분위기를 즐길 수 있는 곳입니다.<br><br>


			
			위치: 대전광역시 서구 탄방동 1083<br>
		</div>
		</div>
		</div>
</body>
