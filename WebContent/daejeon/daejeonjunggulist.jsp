...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">송학사</font>
			</div>
			<div class="admin4">
				<font class="board2">대전 근현대사 전시관</font>
			</div>
			<div class="slideshow">
					<a href="songhaksa.jsp" class="aaa"><img src=".\..\img\송학사.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="daejeonmuseum.jsp" class="aaa"><img src=".\..\img\대전근현대사전시관.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>