...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.363042,127.384903); // 위치값 위도 경도
	var Y_point			= 36.363042;		// Y 좌표
	var X_point			= 127.384903;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "발명인의 전당";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>발명인의 전당</h2>'+
	'<p>대전광역시 서구 둔산2동 920</p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" ><a href=".\..\daejeon\daejeondonggulist.jsp" class="aaa">동구</a></th>
		    <th class="top2"><a href=".\..\daejeon\daejeonjunggulist.jsp" class="aaa">중구</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		    <td class="bottom" style="font-weight:bold"><a href=".\..\daejeon\daejeonseogulist.jsp" class="aaa">서구</a></td>
		    <td class="bottom2"><a href=".\..\daejeon\daejeonysgulist.jsp" class="aaa">유성구</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">발명인의 전당</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\발명인의전당.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			위대한 발명가들의 창조정신을 알아보자<br><br>

			대전광역시 서구 정부대전청사 내에 위치한 발명인의 전당은 우리 선조들의 발명 역사를 살피고, <br>
			발명가들의 창조정신을 알아볼 수 있는 곳으로 발명에 대해 알아보는 문화공간이 되어주고 있습니다.<br>
			발명인의 전당은 인류와 우리 선조들의 발명 역사를 조명하고 선조들의 창조정신을 기려보는 <br>
			장소입니다. 총 5가지 코너로 알차게 짜인 이곳은 발명과 창조의 세계를 알아볼 수 있는 문화공간입니다.<br><br>


			
			위치: 대전광역시 서구 둔산2동 920<br>
		</div>
		</div>
		</div>
</body>
