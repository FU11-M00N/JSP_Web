...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.368645,127.296696); // 위치값 위도 경도
	var Y_point			= 36.368645;		// Y 좌표
	var X_point			= 127.296696;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "국립 대전 현충원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>국립 대전 현충원</h2>'+
	'<p>대전광역시 유성구 노은1동 현충원로 251</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">국립 대전 현충원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\국립대전현충원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			애국심을 일깨워주는 대전현충원<br><br>

			한국의 전통미와 현대감각의 조화, 자연경관의 최대보존, 기존 국립묘지의 미비점 보완, 전 묘역의 호국공원화를 <br>
			기본 방향으로 잡아 조성된 국립대전현충원이다. 나라를 위해 희생하신 분들의 나랑사랑정신을 기리고, <br>
			그분들의 애국심과 호국의지를 이어가기 위해 조성된 호국공원입니다.<br><br>


			
			위치: 대전광역시 유성구 노은1동 현충원로 251<br>
		</div>
		</div>
		</div>
</body>
