...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.329405,127.432006); // 위치값 위도 경도
	var Y_point			= 36.329405;		// Y 좌표
	var X_point			= 127.432006;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "대전 중앙시장";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>대전 중앙시장</h2>'+
	'<p>대전광역시 동구 중동 81-3</p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" style="font-weight:bold"><a href=".\..\daejeon\daejeondonggulist.jsp" class="aaa">동구</a></th>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">대전 중앙시장</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\대전중앙시장.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			중부권 최대의 재래시장<br><br>

			문화관광형의 시장으로서 이벤트광장과 생선골목, 한의약거리, 한복거리, 먹자골목 등 테마거리를 갖추었습니다. <br>
			중앙시장은 여러 개의 단위시장이 모여있는 종합시장으로서 중부권 최대의 재래시장입니다.<br>
			옛날의 지저분한 재래시장의 모습은 남아 있지 않고, 깔끔하게 정돈된 모습의 중앙시장은 쇼핑을 더욱 편하고 쉽게 할 수 있습니다.<br><br>

			
			위치: 대전광역시 동구 중동 81-3<br>
		</div>
		</div>
		</div>
</body>
