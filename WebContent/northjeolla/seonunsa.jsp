...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.497248,126.578641); // 위치값 위도 경도
	var Y_point			= 35.497248;		// Y 좌표
	var X_point			= 126.578641;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "선운사";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>선운사</h2>'+
	'<p>고창군 아산면 선운사로250(삼인리 500)</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">선운사</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\선운사.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			대한불교조계종 제24교구의 본사. 《선운사사적기(禪雲寺寺蹟記)》에 따르면 577년(백제 위덕왕 24)에 검단선사(黔丹禪師)가 창건하였으며, 그후 폐사가 되어 1기(基)의 석탑만 남아 있던 것을 <br>
			1354년(공민왕 3)에 효정선사(孝正禪師)가 중수하였다. 1472년(조선 성종 3) 부터 10여 년 간 극유(克乳)가 성종의 숙부 덕원군(德源君)의 후원으로 대대적인 중창을 하였는데 정유재란(丁酉再亂)으로 본당을 제외하고 모두 불타버렸다 <br>
 			창건 당시는 89개의 암자와 189채의 건물, 그리고 수도를 위한 24개소의 굴이 있던 대가람이라고 기록되어 있다. 1613년(광해군 5)에는 무장(茂長)현감 송석조(宋碩祚)가 일관(一寬)·원준(元俊) 등 승려와 함께 재건을 도모, <br>
 			3년에 걸쳐 대웅전·만세루(萬歲樓)·영산전(靈山殿)·명부전 등을 건립하였다 <br><br>

			위치: 전북 고창군 아산면 선운사로250(삼인리 500)
		</div>
		</div>
</body>
</html>