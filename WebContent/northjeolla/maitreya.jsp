...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.010819,127.030045); // 위치값 위도 경도
	var Y_point			= 36.010819;		// Y 좌표
	var X_point			= 127.030045;		// X 좌표
	var zoomLevel		= 15;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "미륵사지";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">미륵사지</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\미륵사지.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			미륵사지(彌勒寺址)는 전라북도 익산시 금마면 기양리에 위치하는 백제시대 최대의 사찰이다 <br>
			『삼국유사(三國遺事)』에 의하면 백제 무왕(600-641)이 왕비의 청을 받아들여 축조한 절이라고 전해지고 있다 <br>
			미륵사지에 대한 조사는 1974-75년도에 동탑지를 시작으로 하여, 본격적인 조사는 1980년도에 착수하고 1996년에 이르기까지 17여 년간 계속되었다 <br>
			발굴결과 미륵사지는 초창기의 사찰은 백제시대에 완성되었으나 현재의 가람배치는 통일신라시대에 완성된 것으로 판명되었다 <br><br>
			
			위치: 전북 익산시 금마면 기양리 97
		</div>
		</div>
		</div>
</body>
