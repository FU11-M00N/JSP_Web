...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.900688,127.775117); // 위치값 위도 경도
	var Y_point			= 35.900688;		// Y 좌표
	var X_point			= 127.775117;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "덕유산 국립공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>덕유산 국립공원</h2>'+
	'<p>무주군 설천면 구천동1로 159</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">덕유산 국립공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\덕유산국립공원.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			전북 무주군을 중심으로 경남 거창군 ·함양군, 전북 장수군에 걸쳐 면적 219km2이고, 1975년 2월 1일에 국립공원으로 지정되었다. 덕유산은 약 20km에 걸친 긴 능선을 포함하는 산이다 <br>
			즉 북동부의 북덕유산을 주봉으로 남동부의 남덕유산까지 이어지고, 그 사이에 무룡산(舞龍山:1,492m)·삿갓봉[笠峯:1,386m] 및 동엽령(冬葉嶺:1,328m) 등 산봉과 안부(鞍部)가 <br>
			이어진 소백산맥의 주맥이 웅대한 능선을 형성하면서 덕유산의 주능선을 이루고 있다. 이들 주봉군의 장엄한 산용은 예로부터 명산의 칭송을 받아 왔으며, 칠연(七連)폭포 ·용추(龍湫)폭포 등이 걸려 있는 <br>
			계곡미가 훌륭하고, 정상부의 주목군락과 고산식물 및 산체를 뒤덮은 대수해(大樹海)의 경관이 뛰어나다 <br><br>
