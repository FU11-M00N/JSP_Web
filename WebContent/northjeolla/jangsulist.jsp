...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">장안산</font>
			</div>
			<div class="admin4">
				<font class="board2">방화동 자연휴양림</font>
			</div>
			<div class="slideshow">
					<a href="jangansan.jsp" class="aaa"><img src=".\..\img\장안산.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="banghwa.jsp" class="aaa"><img src=".\..\img\방화동자연휴양림.jpg" width="550" height="250" align="left"/></a>
			</div>
			<table class="admin">
			</table>
			<div class="admin3">
				<font class="board2">논개생가</font>
			</div>
			<div class="slideshow">
					<a href="nongae.jsp" class="aaa"><img src=".\..\img\논개생가.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>