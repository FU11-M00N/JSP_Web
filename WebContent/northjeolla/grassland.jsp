...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.987824,126.708360); // 위치값 위도 경도
	var Y_point			= 35.987824;		// Y 좌표
	var X_point			= 126.708360;		// X 좌표
	var zoomLevel		= 15;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "초원 사진관";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">초원 사진관</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\초원사진관.jpg" width="500" height="250"/>		     
		</div>
		
		<div class="board2"><br>
			군산 초원사진관은 배우 한석규, 심은하 주연의 영화 '8월의 크리스마스'촬영지로 유명한 곳이다. 이 영화는 아버지를 모시며 시한부 인생을 사는 사진사 정원(한석규)과 어느 날 <br>
			그의 앞에 나타난 주차단속요원 다림(심은하)의 못다 한 사랑을 그려낸 작품이다. 영화의 대부분은 군산시 월명동 초원사진관에서촬영됐다. 영화 제작 당시 '8월의 크리스마스' <br>
			제작진은 세트 촬영을 하지 않기로 하고 전국 사진관을 찾았지만 마땅한 장소를 찾지 못했다. 그러던 중 잠시 쉬러들어간 카페 창밖으로 여름날의 나무 그림자가 드리워진 차고를 발견하고 주인 <br>
			에게 허락을 받아 사진관으로 개조했다. '초원사진관'이란 이름은 주연 배우인 한석규가 지은 것인데, 그가 어릴 적에 살던 동네 사진관의 이름이라고 한다. <br>
			촬영이 끝난 뒤 초원사진관은 주인과의 약속대로 철거됐다가 이후 군산시가 다시 복원해 군산을 방문하는 사람들을 위해 무료 개방을 하고 있다 <br>
			초원사진관에는 영화 속에 등장했던 사진기와 선풍기, 앨범 등이 고스란히 전시돼 있으며, 관리인들은 관광객들이 찍은 사진을 직접 이메일로 보내준다 <br><br>
