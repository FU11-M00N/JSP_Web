...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.592988,127.528596); // 위치값 위도 경도
	var Y_point			= 35.592988;		// Y 좌표
	var X_point			= 127.528596;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "방화동 자연휴양림";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>방화동 자연휴양림</h2>'+
	'<p>장수군 번암면 방화동로 778 (번암면)</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">방화동 자연휴양림</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\방화동자연휴양림.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			방화동자연휴양림·가족휴가촌 기본 정보 전국 8대 종산에 속하는 장안산(1,237m)의 방화동계곡에 조성된 방화동자연휴양림·가족휴가촌은 덕산용소에서 방화동계곡으로 연계되는 코스에 방화폭포, <br>
			산림욕장(치유의 숲, 만남의 광장) 시설이 갖추어져 있으며, 깨끗한 계곡을 따라 기암절벽, 다양한 수목 등의 수려한 자연경관으로 가족단위 주말 또는 단기체류형으로 최적의 조건을 갖춘 사계절 매력적인 휴양처다 <br><br>
	
			위치: 전라북도 장수군 번암면 방화동로 778 (번암면)
		</div>
		</div>
</body>
</html>