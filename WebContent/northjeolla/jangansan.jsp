...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.629928,127.595894); // 위치값 위도 경도
	var Y_point			= 35.629928;		// Y 좌표
	var X_point			= 127.595894;		// X 좌표
	var zoomLevel		= 13;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "장안산";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">장안산</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\장안산.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			높이 1,237m이다. 소백산맥의 서쪽 비탈면을 이루며, 동쪽에 백운산(1,279m), 서쪽에 팔공산(1,151m)이 솟아 있다. 동쪽 비탈면에서 흘러내린 계류는 섬진강의 상류인 백운천으로 흘러들고, <br>
			북쪽 비탈면에서 흘러내린 계류는 계남면의 벽남제(壁南堤)로 흘러든다. 동쪽은 소백산맥의 준령에 막혀 교통이 불편하지만, 북동쪽의 무령고개(1,076m)와 남쪽의 어치재를 통해 경상남도 함양군의 산록 계류지역과 연결된다 <br>
			서쪽 비탈면은 경사가 완만하며 장수읍의 낮은 분지로 이어진다. 남서쪽 비탈면에서 발원해 용림천으로 흘러드는 덕산계곡(德山溪谷)은 윗용소·아랫용소 등 2개의 용소와 크고 작은 10여 개의 소(沼), 20여 개의 기암괴석으로  <br>
			유명하다. 또 가을철 동쪽 능선을 타고 펼쳐지는 넓은 억새밭이 명물로 꼽힌다. 인근에 국민관광지인 방화동 가족휴양촌이 있다. 1986년 부근 일대와 함께 장안산 군립공원으로 지정되었다 <br><br>
