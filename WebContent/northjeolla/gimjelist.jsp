...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">금산사</font>
			</div>
			<div class="admin4">
				<font class="board2">벽골제</font>
			</div>
			<div class="slideshow">
					<a href="geumsansa.jsp" class="aaa"><img src=".\..\img\금산사.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="byeokgolje.jsp" class="aaa"><img src=".\..\img\벽골제.jpg" width="550" height="250" align="left"/></a>
			</div>
			<table class="admin">
			</table>
			<div class="admin3">
				<font class="board2">성산공원</font>
			</div>
			<div class="slideshow">
					<a href="seongsan.jsp" class="aaa"><img src=".\..\img\성산공원.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>