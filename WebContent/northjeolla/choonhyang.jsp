...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.401648,127.386735); // 위치값 위도 경도
	var Y_point			= 35.401648;		// Y 좌표
	var X_point			= 127.386735;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "춘향 테마파크";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>춘향 테마파크</h2>'+
	'<p>남원시 양림길 14-9(어현동 37-158번지)</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">춘향 테마파크</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\춘향테마파크.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			1999년 문화관광부(문화체육관광부)가 지원하는 '관광비전 21' 사업으로 채택되어 사업비 95억 원을 투여하여 조성하고, 2004년 5월 1일 개장하였다 <br>
 			광한루원(명승 제33호) 근처의 어현동 남원관광단지 내에 있다.'만남의 장'에는 종합안내소와 전통문화체험관·분수대·춘향마당·종합상품관, '맹약의 장'에는 옥지환과 돌탑·맹약단·언약판 등의 조형물이 있다 <br> 
			'사랑과 이별의 장'에는 영화 《춘향뎐》의 촬영세트장과 부용당·월매집·공방, '시련의 장'에는 동헌·옥사 등이 조성되어 있다. '축제의 장'은 관람객들의 편의를 위하여 조성한 휴식광장이다 <br>
			개장시간은 하절기(4~10월) 09:00~22:00, 동절기(11~3월) 09:00~21:00 <br><br>
			
			위치: 전라북도 남원시 양림길 14-9(어현동 37-158번지)
		</div>
		</div>
</body>
</html>