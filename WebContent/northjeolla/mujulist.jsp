...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">덕유산 국립공원</font>
			</div>
			<div class="admin4">
				<font class="board2">반디랜드</font>
			</div>
			<div class="slideshow">
					<a href="deokyusan.jsp" class="aaa"><img src=".\..\img\덕유산국립공원.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="bandiland.jsp" class="aaa"><img src=".\..\img\반디랜드.jpg" width="550" height="250" align="left"/></a>
			</div>
			<table class="admin">
			</table>
			<div class="admin3">
				<font class="board2">구천동</font>
			</div>
			<div class="slideshow">
					<a href="guchondong.jsp" class="aaa"><img src=".\..\img\구천동.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>