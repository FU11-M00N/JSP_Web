...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.754499,126.853392); // 위치값 위도 경도
	var Y_point			= 35.754499;		// Y 좌표
	var X_point			= 126.853392;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "벽골제";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>벽골제</h2>'+
	'<p>김제시 부량면 신용리 119-1</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">벽골제</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\벽골제.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			김제시 부량면 월승리에 위치한 벽골제(사적 111호)는 우리나라에서 가장 오래된 저수지 둑이다 <br>
			벽골제가 한국 최초의 저수지라는 실증적인 자료는 1415년의 중수비에 기록된 5개의 도랑의 존재를 들 수 있다. 그리고 당시 대규모의 저수지 축조가 될 수 있을 정도의 상당한 토목기술이 발달했다는 점은 <br>
			한국과학기술사에서 중요한 의미를 갖는다. 동국여지승람에 의하면, 벽골제의 길이는 60,843척이고 제내주회(堤內周回)가 77,406보이며 몽리면적이 약 9,840결이다 <br>
			그리고 저수지의 둘레는 7만 7천 4백 6보(약140㎞)이고, 여기에 물이 가득 찼을 때에는 그 면적이 5천 정보 정도이다. 또, 벽골제의 수문 중에서 수여거는 그 물줄기가 만경현의 남쪽에까지 뻗어 나갔고, <br>
			장생거는 만경현의 서쪽에, 중심거는 고부군의 북쪽과 부령현의 동쪽에, 경장거와 유통거는 인의현의 서쪽에까지 이르렀다 <br><br>
			
			위치: 전북 김제시 부량면 신용리  119-1
		</div>
		</div>
</body>
</html>