...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.670936,126.785204); // 위치값 위도 경도
	var Y_point			= 35.670936;		// Y 좌표
	var X_point			= 126.785204;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "송참봉 조선동네";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>송참봉 조선동네</h2>'+
	'<p>정읍시 이평면 영원로 1290-118</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">송참봉 조선동네</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\송참봉조선동네.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			백 년 전 조선시대 마을은 어떤 모습일까? 닭 울음소리에 눈을 뜨고 온기가 남아있는 구들장에서 몸을 일으켜 방문을 연다. 불어오는 바람은 신선하다. <br>
			조상들의 농경생활을 있는 그대로 보여주고, 함께 잠자고 같이 먹고 한데 어울려 놀다 갈수 있는 송참봉조선동네. 살아있는 민속마을에서 특별한 경험을 만나보자 <br><br>
			
			위치: 전북 정읍시 이평면 영원로 1290-118
		</div>
		</div>
</body>
</html>