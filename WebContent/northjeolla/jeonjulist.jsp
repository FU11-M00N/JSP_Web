...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">전주 한옥마을</font>
			</div>
			<div class="admin4">
				<font class="board2">전주 동물원</font>
			</div>
			<div class="slideshow">
					<a href="hanok.jsp" class="aaa"><img src=".\..\img\한옥마을.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="zoo.jsp" class="aaa"><img src=".\..\img\전주동물원.jpg" width="550" height="250" align="left"/></a>
			</div>
			<table class="admin">
			</table>
			<div class="admin3">
				<font class="board2">자만 벽화마을</font>
			</div>
			<div class="slideshow">
					<a href="jamanmural.jsp" class="aaa"><img src=".\..\img\자만벽화마을.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>