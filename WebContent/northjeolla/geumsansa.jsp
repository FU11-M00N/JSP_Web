...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.722927,127.053425); // 위치값 위도 경도
	var Y_point			= 35.722927;		// Y 좌표
	var X_point			= 127.053425;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "금산사";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">금산사</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\금산사.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			임진왜란 이전의 기록은 모두 소실되어 《삼국유사》나 《삼국사기》 등을 인용하여 사적기(事蹟記)가 만들어졌는데, 금산사의 창건은 599년(백제 법왕 1)에 왕의 자복(自福)사찰로 <br>
			세워진 것이라 하나 확실하지는 않다. 지금까지 전하는 바는 진표(眞表)가 762년(신라 경덕왕 21)부터 766년(신라 혜공왕 2)까지 4년에 걸쳐 중건(重建)하였으며,  <br>
			1069년(문종 23) 혜덕왕사(慧德王師)가 대가람(大伽藍)으로 재청하고, 그 남쪽에 광교원(廣敎院)이라는 대사구(大寺區)를 증설하여 창건 이래 가장 큰 규모의 대도량(大道場)이 되었다  <br> <br>
			
			위치: 전북 김제시 금산면 모악 15길 1
		</div>
		</div>
</body>
</html>