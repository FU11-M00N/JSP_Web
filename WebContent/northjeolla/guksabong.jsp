...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.641349,127.145863); // 위치값 위도 경도
	var Y_point			= 35.641349;		// Y 좌표
	var X_point			= 127.145863;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "국사봉전망대";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>국사봉전망대</h2>'+
	'<p>임실군 운암면 국사봉로 512</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">국사봉전망대</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\국사봉전망대.JPG" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			* 옥정호를 한 눈에 내려다볼 수 있는 국사봉전망대 * <br>
			임실군 운암면에 위치하고 있는 국사봉은 해발 475m의 작은 산이다. 하지만 주변에 높은 산이없어 산을 오리다보면 하늘과 가까운 느낌을 받을 수 있다 <br>
			이 산이 유명한 이유는 바로 옥정호를 한 눈에 바라볼 수 있기 때문이다. 또한 일교차가 심한 날 새벽에 산에 오르면 옥정호를 감싸고 있는 운해의 모습을 볼 수 있는데 이 모습이 장관을 이뤄 많은 사람들이 찾기도 한다 <br><br>
	
			위치: 전라북도 임실군 운암면 국사봉로 512
		</div>
		</div>
</body>
</html>