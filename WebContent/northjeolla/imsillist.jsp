...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">옥정호</font>
			</div>
			<div class="admin4">
				<font class="board2">국사봉전망대</font>
			</div>
			<div class="slideshow">
					<a href="okjeongholake.jsp" class="aaa"><img src=".\..\img\옥정호.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="guksabong.jsp" class="aaa"><img src=".\..\img\국사봉전망대.JPG" width="550" height="250" align="left"/></a>
			</div>
			<table class="admin">
			</table>
			<div class="admin3">
				<font class="board2">치즈마을</font>
			</div>
			<div class="slideshow">
					<a href="cheese.jsp" class="aaa"><img src=".\..\img\치즈마을.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>