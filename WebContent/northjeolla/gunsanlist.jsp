...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">선유도</font>
			</div>
			<div class="admin4">
				<font class="board2">철길 마을</font>
			</div>
			<div class="slideshow">
					<a href="sunyudo.jsp" class="aaa"><img src=".\..\img\선유도.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="railroad.jsp" class="aaa"><img src=".\..\img\철길마을.jpg" width="550" height="250" align="left"/></a>
			</div>
			<table class="admin">
			</table>
			<div class="admin3">
				<font class="board2">초원 사진관</font>
			</div>
			<div class="slideshow">
					<a href="grassland.jsp" class="aaa"><img src=".\..\img\초원사진관.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>