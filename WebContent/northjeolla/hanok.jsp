...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.815433,127.153459); // 위치값 위도 경도
	var Y_point			= 35.815433;		// Y 좌표
	var X_point			= 127.153459;		// X 좌표
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">전주 한옥마을</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\한옥마을.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			태조의 어진을 모신 경기전, 천주교의 성지 전동성당, 한류 영화와 드라마의 촬영지 전주향교 등에서 우리 문화의 면면을 만날 수 있어요! <br>
			한지 공예, 부채 만들기 등 다양한 전통 공예 체험도 가능하고, 근래 들어서는 '한복데이'가 생기며 한복 차림으로 한옥마을에 오가는 젊은 사람도 많고! <br>
			체험도 하고 ~ 잠시 쉬는 시간에는 ! 전통 공연을 볼 수 있어요 ~ 공연만 보는 게 아니라 식사나 체험 등도 가능하답니다 <br>	
			또한,한옥마을에는 전주의 꼿꼿한 정신이 담겨있는데, 시간은 1930년대로 거슬러 올라가면 <br>
			일제강점기 양곡을 수송하기 위해 전군가도가 개설됨에 따라 전주부성은 풍남문을 제외하고 자취를 잃었고, <br>
			그러면서 성 밖에머물던 일본인이 성안으로 진출해 상권을 확장했는데 이에 반발한 전주 사람들이 풍남동과 교동에 조성한 한옥촌이 지금의 한옥마을 !<br>
			오늘날 한옥 600여 채가 어깨를 맞대고 있어, 오목대에 올라 전경을 보면 실로 장관 펼쳐집니다<br><br>	
			
			위치: 전북 전주시 완산구 기린대로 99<br>
			지번: 남노송동 100-1
		</div>
		</div>
		</div>
