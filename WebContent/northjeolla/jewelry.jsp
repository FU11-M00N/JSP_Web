...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.990628,127.102649); // 위치값 위도 경도
	var Y_point			= 35.990628;		// Y 좌표
	var X_point			= 127.102649;		// X 좌표
	var zoomLevel		= 15;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "보석 박물관";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>보석 박물관</h2>'+
	'<p> 익산시 왕궁면 호반로 8번지(동용리 575-1)</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">보석 박물관</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\보석박물관.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			익산은 예부터 보석으로 유명했다. 원석이 풍부해서가 아니라 보석 세공술이 뛰어났기 때문이다. 마한과 백제를 거치며 철기문화가 번성했고,더불어 금 세공술이 발전하면서 다시 탁월한 보석 가공술로 이어졌다 <br>
			익산시 왕궁면에 자리한 보석박물관은 다양한 광물과 그 광물이 보석이 되기까지의 과정을 살펴보고, 각종 보석을 한자리에서 둘러볼 수 있는 국내 유일의 보석박물관이다 <br><br>
			
			위치: 전라북도 익산시 왕궁면 호반로 8번지(동용리 575-1)
		</div>
		</div>
		</div>
</body>
