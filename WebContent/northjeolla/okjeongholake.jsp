...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.589319,127.109719); // 위치값 위도 경도
	var Y_point			= 35.589319;		// Y 좌표
	var X_point			= 127.109719;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "옥정호";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">옥정호</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\옥정호.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			사진을 좋아하는 사람이라면 누구나 한번쯤 가본다는 옥정호. 전라북도 임실군 강진면과 정읍시 산내면에 걸쳐있는 호수다. 본래는 1925년 섬진강의 물을 호남평야의 <br>
			농사를 위해 끌어다 쓰기 위해 만든 저수지다. 1965년 이곳에 농업용수 공급과 전력생산을 위한 ‘섬진강 다목적댐’이 건설되면서 수위를 높였고 운암면의 가옥 300여 호와 경지면적 70%가 수몰돼 지금의 모습으로 자리 잡았다 <br><br>
