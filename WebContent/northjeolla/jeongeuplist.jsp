...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">내장산 국립공원</font>
			</div>
			<div class="admin4">
				<font class="board2">구절초 테마공원</font>
			</div>
			<div class="slideshow">
					<a href="naejangsan.jsp" class="aaa"><img src=".\..\img\내장산국립공원.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="gujeolcho.jsp" class="aaa"><img src=".\..\img\구절초테마공원.jpg" width="550" height="250" align="left"/></a>
			</div>
			<table class="admin">
			</table>
			<div class="admin3">
				<font class="board2">송참봉 조선동네</font>
			</div>
			<div class="slideshow">
					<a href="joseon.jsp" class="aaa"><img src=".\..\img\송참봉조선동네.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>