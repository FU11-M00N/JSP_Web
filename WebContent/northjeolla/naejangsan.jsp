...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.493395,126.927835); // 위치값 위도 경도
	var Y_point			= 35.493395;		// Y 좌표
	var X_point			= 126.927835;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "내장산 국립공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>내장산 국립공원</h2>'+
	'<p>정읍시 내장산로 1207 내장동 673-1</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">내장산 국립공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\내장산국립공원.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			주봉인 신선봉(神仙峰:763m)을 비롯한 서래봉(西來峰) ·불출봉(佛出峰) ·망해봉(望海峰) ·연자봉(燕子峰) ·까치봉·연지봉(蓮池峰) ·장군봉(將軍峰) ·월령봉(月迎峰) <br>
			으로 이루어진 내장9봉 외에 몇몇 산봉으로 구성된다. 내장산은 일찍이 대한 8경의 하나로 꼽혀 왔고, 산중의 내장사(內藏寺) 경내에 있는 정혜루기(定慧樓記) 에 의하면 남원의 지리산 등과 더불어 <br>
			호남의 5대명산의 하나로 기록되었다.폭포가 있고 계류가 흐르는 많은 계곡과 비자림(榧子林) ·굴거리나무군락 등 천연기념물을 포함한 수림의 아름다움이 뛰어나고, 특히 그 수림이 이루는 <br>
			단풍이 유명하여, 단풍철에는 정읍시에서 주최하는 다채로운 단풍제가 연례행사로 열린다 <br><br>
			
			위치: 전북 정읍시 내장산로 1207 내장동 673-1
		</div>
		</div>
</body>
</html>