...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.404317,127.049048); // 위치값 위도 경도
	var Y_point			= 35.404317;		// Y 좌표
	var X_point			= 127.049048;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "강천산 군립공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>강천산 군립공원</h2>'+
	'<p>순창군 팔덕면 청계리 산263-1</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">강천산 군립공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\강천산군립공원.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			봄이면 진달래·산벚꽃이 흐드러지고, 여름에는 많은 피서 인파가 계곡을 찾는다 <br>
			특히 11월 초순에 온 산을 붉게 물들이는 아기단풍 등 활엽수가 만들어 내는 단풍은 아름답기로 유명하다. 산 입구와 해발고도 300m 능선에 각각 호수가 있는데, 전자를 강천1호, 후자를 강천2호라고 부른다 <br><br>
	
			위치: 전북 순창군 팔덕면 청계리 산263-1
		</div>
		</div>
</body>
</html>