...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(34.780324,127.928436); // 위치값 위도 경도
	var Y_point			= 34.780324;		// Y 좌표
	var X_point			= 127.928436;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "미국마을";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>미국마을</h2>'+
	'<p>경상남도 남해군 이동면 용소리 947-1</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">미국마을</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\미국마을.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			경상남도 아메리칸 빌리지<br><br>

			경상남도 남해군에 위치해있는 미국마을은 모국에 들어와 한국에서 노후생활을 보내고자 하는 재미교포를 위해 만들어진 정착마을입니다. <br>
			미국 느낌의 건축양식으로 지어진 22개의 주택과 민박형 펜션으로 이루어진 곳입니다. 들어가는 입구에서는 미국을 상징하는 독수리와 자유의 여신상을 만날 수 있습니다.<br>
			남해바다를 한눈에 조망할 수 있는 미국마을의 멋진 풍경에 빠져보세요.<br><br>




			위치: 경상남도 남해군 이동면 용소리 947-1<br>
		</div>
		</div>
		</div>
</body>
