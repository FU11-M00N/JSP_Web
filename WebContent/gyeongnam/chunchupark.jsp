...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.346234,129.029168); // 위치값 위도 경도
	var Y_point			= 35.346234;		// Y 좌표
	var X_point			= 129.029168;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "춘추공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">춘추공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\춘추공원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			애국심을 느낄수 있는 공원 !<br><br>

			경남양산에 위치하고 있는 춘추공원은 산속에 있어 휴식을 즐길 수 있고 나라를 위해 희생한 호국영령들을 모신 공원입니다. <br>
			애국심을 느낄수있는 충렬사도 자리잡고 있어 같이 간다면 아이들의 역사공부에 도움이되는곳입니다.<br>
			 도시 지역권 근린공원인 이곳은 2003년부터 추진을 하여 2010에 완공이 된 공원으로<br>
			수 많은 양산의 인물과 호국 영령들을 모신 유서 깊은 곳이기도 합니다.<br><br>
