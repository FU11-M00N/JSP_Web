...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">장승포항</font>
			</div>
			<div class="admin4">
				<font class="board2">거가대교</font>
			</div>
			<div class="slideshow">
					<a href="jangseungpo.jsp" class="aaa"><img src=".\..\img\장승포항.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="geoga.jsp" class="aaa"><img src=".\..\img\거가대교.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>