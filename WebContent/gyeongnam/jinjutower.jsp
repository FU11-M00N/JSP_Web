...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.189074,128.078013); // 위치값 위도 경도
	var Y_point			= 35.189074;		// Y 좌표
	var X_point			= 128.078013;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "진주성";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>진주성</h2>'+
	'<p>경상남도 진주시 성지동 남강로 626</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">진주성</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\진주성.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			단풍이 아름다운 고성. 진주성!<br><br>

			고려 말 우왕 5년에 왜적의 침입을 막기 위해 쌓은 곳으로 이후 조선시대까지 왜구의 침범을 막아낸 역사적으로 중요한 성입니다. <br>
			특히 진주성은 가을에 아름다운 단풍이 인기가 높은 곳인데요,<br>
			형형색색의 단풍이 곱게 물든 모습은 진주성의 사계절 모습 중에서도 으뜸으로 손꼽힙니다.<br><br>
