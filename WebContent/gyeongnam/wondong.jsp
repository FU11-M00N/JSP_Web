...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.372913,128.913506); // 위치값 위도 경도
	var Y_point			= 35.372913;		// Y 좌표
	var X_point			= 128.913506;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "원동 매화축제";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>원동 매화축제</h2>'+
	'<p>경상남도 양산시 원동면 천태로 1477-40</p>' +
	...
	<div>
		...
		<thead>
		  <tr>
		    ...
		    <th class="top2"><a href=".\..\gyeongnam\geojaelist.jsp" class="aaa">거제시</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		    <td class="bottom" style="font-weight:bold"><a href=".\..\gyeongnam\yangsanlist.jsp" class="aaa">양산시</a></td>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">원동 매화축제</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\원동매화축제.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			봄내음과 매화향이 가득한 축제<br><br>

			양산 매화마을축제는 아름다운 매화꽃과 함께 낙동강과 기찻길이 함께 보이는 그림 같은 자연경관을 자랑하는 곳으로 <br>
			매년 홍매화와 청매화가 가득한 축제가 열려 전국적으로 많은 분들이 찾고 있습니다.낙동강변의 매화꽃이 만개되면서 <br>
			아름다운 장관을 이룰 때 개최되는 양산 원동매화마을축제는 환상적인 매화의 장관을 여럿의 사람들과 함께 즐기고 <br>
			유명한 원동 매실을 홍보하고자 하는 뜻이 모여져 2004년에 개최된 축제입니다.<br><br>

			


			
			위치: 경남 양산시 원동면 천태로 1477-40<br>
		</div>
		</div>
		</div>
</body>
