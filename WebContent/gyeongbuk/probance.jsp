...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.684288,128.718192); // 위치값 위도 경도
	var Y_point			= 35.684288;		// Y 좌표
	var X_point			= 128.718192;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "청도 프로방스";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>청도 프로방스</h2>'+
	'<p>경상북도 청도군 화양읍 삼신리 893-1</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">청도 프로방스</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\청도프로방스.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			데이트 장소로 필수인 곳!<br><br>

			경상북도 청도에 위치한 청도프로방스는 연인들의 데이트 코스로 유명한 곳입니다. 알록달록, 아기자기한 건물들이 옹기종기 모여있는 <br>
			프로방스 마을은 이국적인 느낌을 줄 뿐만이 아니라, 다양한 물건을 파는 매장과 음식점이 많아 관광객들의 발길이 끊이질 않고 있습니다. <br>
			매년 겨울마다 프로방스에서 열리는 별빛축제는 프로방스의 또 다른 볼거리를 제공합니다. <br><br>




			
			위치: 경상북도 청도군 화양읍 삼신리 893-1<br>
		</div>
		</div>
		</div>
</body>
