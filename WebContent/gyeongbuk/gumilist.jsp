...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">채미정</font>
			</div>
			<div class="admin4">
				<font class="board2">동락공원</font>
			</div>
			<div class="slideshow">
					<a href="chaemijeong.jsp" class="aaa"><img src=".\..\img\채미정.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="dongrakpark.jsp" class="aaa"><img src=".\..\img\동략공원.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>