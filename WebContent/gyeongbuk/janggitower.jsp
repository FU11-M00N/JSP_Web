...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.896251,129.488868); // 위치값 위도 경도
	var Y_point			= 35.896251;		// Y 좌표
	var X_point			= 129.488868;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "장기읍성";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>장기읍성</h2>'+
	'<p>경상북도 포항시 남구 장기면 읍내리 127-2</p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" style="font-weight:bold"><a href=".\..\gyeongbuk\pohanglist.jsp" class="aaa">포항시</a></th>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">장기읍성</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\장기읍성.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			포항 거닐기 좋은 숨은명소!<br><br>

			포항 장기읍성 주변으로 동해 바닷가와 거리가 가까워 여행명소로 유명한 양포항, 대진해수욕장과 함께 <br>
			여행 할 수 있어 볼거리와 놀거리가 걱정없다! 포항시 장기면에 위치한 장기읍성은  고려현종때  처음 쌓아진 읍성으로  <br>
			여진족의 해안침입을 방어하기위해 세워진 토성이었는데요이후 조선 세종때 여진족을 방어하고 왜구의 침입을 막기위해 석성으로 더욱 강건하게 쌓아졌습니다.<br>
			길이 약 1,400m의 성으로 동문이 주요출입문이고 서쪽과 북쪽엔 문터가 아직도 남아았습니다.<br><br>

			
			위치: 경상북도 포항시 남구 장기면 읍내리 127-2<br>
		</div>
		</div>
		</div>
</body>
