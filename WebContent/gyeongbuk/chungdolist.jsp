...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">청도 프로방스</font>
			</div>
			<div class="admin4">
				<font class="board2">청도 와인터널</font>
			</div>
			<div class="slideshow">
					<a href="probance.jsp" class="aaa"><img src=".\..\img\청도프로방스.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="wineternal.jsp" class="aaa"><img src=".\..\img\청도와인터널.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>