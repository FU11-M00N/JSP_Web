...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">호미곶 해국자생지</font>
			</div>
			<div class="admin4">
				<font class="board2">장기읍성</font>
			</div>
			<div class="slideshow">
					<a href="homigoat.jsp" class="aaa"><img src=".\..\img\호미곶해국자생지.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="janggitower.jsp" class="aaa"><img src=".\..\img\장기읍성.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>