...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.112559,128.312907); // 위치값 위도 경도
	var Y_point			= 36.112559;		// Y 좌표
	var X_point			= 128.312907;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "채미정";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>채미정</h2>'+
	'<p>경상북도 구미시 남통동 249</p>' +
...
<body>
	...
	<div>
		...
		<tbody>
		  <tr>
		    <td class="bottom" style="font-weight:bold"><a href=".\..\gyeongbuk\gumilist.jsp" class="aaa">구미시</a></td>
		    <td class="bottom2"><a href=".\..\gyeongbuk\chungdolist.jsp" class="aaa">청도군</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">채미정</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\채미정.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			충절과 학덕을 기리는 채미정<br><br>

			충절과 학문을 추모하기 위하여 창건된 채미정은 조선 후기의 정자이자 경상북도 기념물 제 55호이다. <br>
			채미정 뒤에는 숙종의 어필 오언절구가 보존되어 있는 경모각과 유허비각이 자리하고있다. 구미의 금오산 기슭에 위치한 명승 제 52호 채미정은 <br>
			야은길재의 충절과 학문을 추모하기 위하여 조선 영조 44년에 건립한 정자입니다 야은길재는 고려시대에 문과에 급제하고 성균관 박사를 거쳐 <br>
			문하주서에 오른뒤 고려가 망하고 조선왕조가 들어서면서 두 왕조를 섬길수 없다며 벼슬을 사양하고 선산에 은거하며 절의를 지키신 분이랍니다.<br><br>



			
			위치: 경상북도 구미시 남통동 249<br>
		</div>
		</div>
		</div>
</body>
