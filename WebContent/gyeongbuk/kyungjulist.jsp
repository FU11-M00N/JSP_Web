...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">안압지</font>
			</div>
			<div class="admin4">
				<font class="board2">송대말등대 일출</font>
			</div>
			<div class="slideshow">
					<a href="anapji.jsp" class="aaa"><img src=".\..\img\안압지.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="songdaemal.jsp" class="aaa"><img src=".\..\img\송대말등대일출.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>