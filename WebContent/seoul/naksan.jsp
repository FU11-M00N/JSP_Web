...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.560693,127.007475); // 위치값 위도 경도
	var Y_point			= 37.560693;		// Y 좌표
	var X_point			= 127.007475;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "낙산공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>낙산공원</h2>'+
	'<p>서울특별시 종로구 이화동 낙산길 41</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">낙산공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\낙산공원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			도심의 수많은 불빛을 감상할 수 있는 공원<br><br>

			낙산의 자연환경과 역사적 문화환경을 복원함으로써<br>
			시민들에게 쾌적한 공원을 제공하기 위해 조성된 낙산공원에서는밤이면 불빛들로 화려하게 물든 도심의 아름다운 경관을 감상할 수 있습니다. <br>
		       고즈넉한 정취를 느낄 수 있는 낙산공원 성곽길은 어두워지면 가로등에 불이 켜져 더욱 아름다운 경관을 자랑하며,야경 속 연인들이 함께 거닐면서 <br>
		       오손도손 이야기를 나눌 수 있는 운치있는 장소로 사랑받고 있는 곳입니다.<br><br>
