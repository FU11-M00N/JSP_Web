...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">낙산공원</font>
			</div>
			<div class="admin4">
				<font class="board2">북촌 한옥마을</font>
			</div>
			<div class="slideshow">
					<a href="naksan.jsp" class="aaa"><img src=".\..\img\낙산공원.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="bukchonhanok.jsp" class="aaa"><img src=".\..\img\북촌한옥마을.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>