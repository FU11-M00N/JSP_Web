...
<%
 ...
 String id = um3.id_search(name, email);//비밀번호를 디비에서 가져옴..실패시 널
 if (id != null) {//비밀번호 찾기 성공시
	...
	<div> 
	  <form name="idfind" method="post">
  	  <table class="box" align="center">
		  <tr>
		    <th class="css2">회원님의 아이디는 </th>
			<td><p type="text" name="name" size="23" maxlength="16" class="css2"><%=id %> 입니다</p></td>
		  </tr>
	  </table>
	  </form>
	</div>
