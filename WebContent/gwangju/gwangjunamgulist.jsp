...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">지산재</font>
			</div>
			<div class="admin4">
				<font class="board2">펭귄마을</font>
			</div>
			<div class="slideshow">
					<a href="jisanjae.jsp" class="aaa"><img src=".\..\img\지산재.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="penguintown.jsp" class="aaa"><img src=".\..\img\펭귄마을.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>