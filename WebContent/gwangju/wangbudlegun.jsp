...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.178930,127.003013); // 위치값 위도 경도
	var Y_point			= 35.178930;		// Y 좌표
	var X_point			= 127.003013;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "충효동 왕버들군";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>충효동 왕버들군</h2>'+
	'<p>광주광역시 북구 충효동 1021</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">충효동 왕버들군</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\충효동왕버들군.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			웅장함이 느껴지는 곳<br><br>

			광주광역시 북구 충효동에서는 천연기념물인 왕버들 군을 만날 수 있으며, 그 옆에서는 조선시대의 비각인 정려비각을 볼 수 있습니다. <br>
			웅장함을 품고 있는 왕버들 나무와 충장공 김덕룡 장군 일가를 기린 정려비각을 보며 지나간 세월의 흔적을 느껴보시길 바랍니다<br><br>
			
			위치: 광주광역시 북구 충효동 1021<br>
