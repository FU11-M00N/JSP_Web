...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.081848,126.873674); // 위치값 위도 경도
	var Y_point			= 35.081848;		// Y 좌표
	var X_point			= 126.873674;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "펭귄마을";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>펭귄마을</h2>'+
	'<p>광주광역시 남구 양림동 201-64</p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" ><a href=".\..\gwangju\gwangjudonggulist.jsp" class="aaa">동구</a></th>
		    <th class="top2"><a href=".\..\gwangju\gwangjuseogulist.jsp" class="aaa">서구</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		    <td class="bottom" style="font-weight:bold"><a href=".\..\gwangju\gwangjunamgulist.jsp" class="aaa">남구</a></td>
		    <td class="bottom2"><a href=".\..\gwangju\gwangjubukgulist.jsp" class="aaa">북구</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">펭귄마을</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\펭귄마을.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			예술마을로 거듭난 골동품들의 변신<br>

			펭귄마을은 쓰레기로 뒤덮였던 공간이 예술마을로 재탄생한 곳으로 옛 물건, 버려진 물건들로 담벼락을 채운 이색풍경을 만날 수 있으며, <br>
			마을 전체가 조화롭게 어우러져 하나의 예술공간으로 자리매김하였습니다. 펭귄마을에서는 집집마다 누군가 쓰던 옛 물건들, 버려진 물건들로 <br>
			담벼락을 빼곡히 메우고 있는 이색풍경을 만날 수 있습니다. 나름 조화롭게 어우러져 예술작품으로 거듭난 골동품들의 변신은 <br>
			마을사람들의 노력과 정성으로 빚어낸 결과입니다.<br><br>


			
			위치: 광주광역시 남구 양림동 201-64<br>
		</div>
		</div>
		</div>
</body>
