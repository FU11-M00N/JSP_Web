...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.140672,126.865127); // 위치값 위도 경도
	var Y_point			= 35.140672;		// Y 좌표
	var X_point			= 126.865127;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "광주 학생 독립운동기념관";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>광주 학생 독립운동기념관</h2>'+
	'<p>광주광역시 서구 화정4동 학생독립로 30</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">광주 학생 독립운동기념관</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\광주학생독립운동기념관.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			숭고한 역사가 담겨있는 공간<br>

			광주 서구에 위치한 광주학생독립운동기념관은 나라와 민족을 위해 희생했던 학생들의 숭고한 정신을 기리고자 건립된 곳으로 <br>
			반드시 기억해야 할 우리의 아픈 역사를 살펴볼 수 있는 뜻깊은 시간을 가질 수 있습니다. <br>
			광주학생독립운동기념관은 3.1운동 이후 가장 큰 규모의 학생들의 시위운동으로 나라와 민족을 위해 희생했던 학생들의 <br>
			숭고한 정신을 기리고자 건립된 기념관입니다.<br><br>
			
			위치: 광주광역시 서구 화정4동 학생독립로 30<br>
		</div>
		</div>
		</div>
</body>
