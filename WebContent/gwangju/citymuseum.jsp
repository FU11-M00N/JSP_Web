...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.155026,126.888442); // 위치값 위도 경도
	var Y_point			= 35.155026;		// Y 좌표
	var X_point			= 126.888442;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "시립미술관";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>시립미술관</h2>'+
	'<p>광주광역시 서구 농성동 상무대로 1165</p>' +
	...
	<div>
		...
		<thead>
		  <tr>
		    ...
		    <th class="top2"style="font-weight:bold"><a href=".\..\gwangju\gwangjuseogulist.jsp" class="aaa">서구</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		    <td class="bottom" ><a href=".\..\gwangju\gwangjunamgulist.jsp" class="aaa">남구</a></td>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">시립 미술관</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\시립미술관.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			다양한 시각 예술품을 만날 수 있는 곳<br><br>

			다양한 시각의 예술품 전시와 문화행사, 교육프로그램을 제공하는 광주시립미술관 상록전시관은 시민들을 위한<br>
			맞춤공간으로 조성되었으며, 폭넓은 문화를 접할 수 있는 기회를 제공하고 있습니다.<br>
			상록전시관은 1982년 전남지사공관으로 세워져 대통령, 도지사들의 숙소로 사용되곤 했으며, 현재는 시민들을 위한 <br>
			전시공간을 갖춘 전시관으로 봄을 맞이하여 많은 이들의 발길이 끊이지 않고 있습니다.<br><br>
			
			위치: 광주광역시 서구 농성동 상무대로 1165<br>
		</div>
		</div>
		</div>
</body>
