...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.220463,126.902415); // 위치값 위도 경도
	var Y_point			= 35.220463;		// Y 좌표
	var X_point			= 126.902415;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "광주 패밀리랜드";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	...
	<div>
		...
		<tbody>
		  <tr>
		    ...
		    <td class="bottom2"style="font-weight:bold"><a href=".\..\gwangju\gwangjubukgulist.jsp" class="aaa">북구</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">광주 패밀리랜드</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\광주패밀리랜드.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			사랑하는 사람들과의 나들이 장소<br><br>


			광주광역시 북구 우치로에 위치해있는 광주패밀리랜드에서는 500만 개의 아름다운 조명이 비치는 빛 축제가 열리고 있습니다. <br>
			가족, 친구, 연인과 걷기 좋은 길로, 다양한 포토존이 마련되어 있어 멋진 추억을 만들 수 있는 곳입니다. <br>
			500만 개의 화려한 조명과 멋진 조형물이 눈길을 끄는 곳이며, 즐거운 탄성이 절로 나오는 광주 패밀리랜드 빛의 향연! <br>
			이색적인 즐거움을 선사하는 곳입니다.<br><br>
