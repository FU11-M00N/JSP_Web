...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">슬도</font>
			</div>
			<div class="admin4">
				<font class="board2">성바오로 성당</font>
			</div>
			<div class="slideshow">
					<a href="sledo.jsp" class="aaa"><img src=".\..\img\슬도.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="sungbaoro.jsp" class="aaa"><img src=".\..\img\성바오로성당.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>