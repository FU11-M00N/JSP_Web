...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.505792,129.381273); // 위치값 위도 경도
	var Y_point			= 35.505792;		// Y 좌표
	var X_point			= 129.381273;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "장성포 옛마을";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>장성포 옛마을</h2>'+
	'<p>울산광역시 남구 매암동 209-1</p>' +
	...
	<div>
		...
		<thead>
		  <tr>
		    ...
		    <th class="top2"style="font-weight:bold"><a href=".\..\ulsan\ulsannamgulist.jsp" class="aaa">남구</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">장성포 옛마을</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\장성포옛마을.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			장성포의 옛 모습을 추억할 수 있는 곳<br><br>

			울산 남구 장성포동에 위치해있는 장성포옛마을은 고래문화마을 내에 조성된 곳으로 <br>
			우리나라 70년대 장성포 일대를 그대로 재현해 놓은 마을입니다. 다양한 볼거리로 옛 기억을 떠올릴 수 있는 곳! <br>
			방문해보셔서 장성포에서의 옛 추억을 느껴보시길 바랍니다. <br><br>


			
			위치: 울산광역시 남구 매암동 209-1<br>
		</div>
		</div>
		</div>
</body>
