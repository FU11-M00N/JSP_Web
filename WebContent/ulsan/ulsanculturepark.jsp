...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.544250,129.328246); // 위치값 위도 경도
	var Y_point			= 35.544250;		// Y 좌표
	var X_point			= 129.328246;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "울산 문화공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>울산 문화공원</h2>'+
	'<p>울산광역시 남구 달동 416-1</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">울산 문화공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\울산문화공원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			다양한 문화의 공간 '울산문화공원'<br>

			울산 남구 달동에 위치한 울산문화공원은 시민들에게 쉼터이자 축제의 장이 되어주는 곳입니다. <br>
			체육공간뿐만 아니라 다양한 볼거리, 즐길 거리가 가득한 곳! 울산문화공원에서 가족, 친구, 연인과 즐거운 시간 가져보시길 바랍니다. <br><br>


			
			위치: 울산광역시 남구 달동 416-1<br>
		</div>
		</div>
		</div>
</body>
