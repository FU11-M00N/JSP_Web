...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">울산 중앙시장</font>
			</div>
			<div class="admin4">
				<font class="board2">태화강 대공원</font>
			</div>
			<div class="slideshow">
					<a href="ulsanmarket.jsp" class="aaa"><img src=".\..\img\울산중앙시장.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="taewhapark.jsp" class="aaa"><img src=".\..\img\태화강대공원.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>