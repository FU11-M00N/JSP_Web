...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.478103,129.431210); // 위치값 위도 경도
	var Y_point			= 35.478103;		// Y 좌표
	var X_point			= 129.431210;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "슬도";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">슬도</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\슬도.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			아름다운 자연과 하나 되는 드라마 '메이퀸' 촬영지<br><br>

			슬도는 파도가 밀려올 때 바위에서 나는 소리가 거문고소리 같다고 하여 유래한 지명입니다. <br>
			슬도는 시루를 엎어놓은 듯하여 시루섬이라 하기도 하고, 거북이 모양 같기도 해서 구룡도라 불리기도 합니다.<br>
			울산 방어진항 근처에 위치한 섬 슬도는 방어진항으로 들어오는 파도를 막아주는 바위섬으로 갯바위에 파도가 부딪치며 <br>
			거문고 소리가 난다고 하여 슬도라고 불리게 되었습니다.<br><br>
