...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">장성포 옛마을</font>
			</div>
			<div class="admin4">
				<font class="board2">울산 문화공원</font>
			</div>
			<div class="slideshow">
					<a href="jangsungpotown.jsp" class="aaa"><img src=".\..\img\장성포옛마을.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="ulsanculturepark.jsp" class="aaa"><img src=".\..\img\울산문화공원.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>