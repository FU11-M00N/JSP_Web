...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(33.290358,126.352035); // 위치값 위도 경도
	var Y_point			= 33.290358;		// Y 좌표
	var X_point			= 126.352035;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "헬로키티 아일랜드";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>헬로키티 아일랜드</h2>'+
	'<p>서귀포시 안덕면 한창로 340 헬로키티 아일랜드</p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top"><a href=".\..\jeju\jejulist.jsp" class="aaa">제주</a></th>
		    <th class="top2" style="font-weight:bold"><a href=".\..\jeju\seogwipolist.jsp" class="aaa">서귀포</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">헬로키티 아일랜드</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\헬로키티아일랜드.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			동심의 세계로 빠져드는 공간 <br>
			전 세계적으로 가장 사랑받는 캐릭터 중 하나인 헬로키티에 관한 모든 것이 이루어져 있는 곳으로 아기자기한 소품이 가득한 공간입니다 <br>
			헬로키티의 역사부터 음악과 공연 교육, 전시, 3D 영상관과 체험활동, 기획 작품 갤러리 등 다채로운 문화체험이 가능합니다. 다양한 종류의 키티 상품을 만날 수 있는 <br>
			브랜드샵과 향기롭고 따뜻한 커피와 디저트를 함께 할 수 있는 카페까지 모든 편의시설을 갖추고 있어 함께 공감하고 소통하며 행복한 하루를 즐기기 좋은 남녀노소 누구나 좋아하고 즐겨 찾는 곳입니다 <br><br>

			위치: 제주 서귀포시 안덕면 한창로 340 헬로키티 아일랜드
		</div>
		</div>
		</div>
</body>
