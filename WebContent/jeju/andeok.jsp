...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(33.257365,126.352886); // 위치값 위도 경도
	var Y_point			= 33.257365;		// Y 좌표
	var X_point			= 126.352886;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "안덕계곡";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>안덕계곡</h2>'+
	'<p>서귀포시 안덕면 일주서로 1524</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">안덕계곡</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\안덕계곡.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			MBC 드라마 '구가의 서' 속 신비로운 장소 <br>
			감산천, 창고청, 창천계곡이라고도 하는 안덕계곡은 천연기념물 제182-6호로 지정된 곳으로 안덕면의 창고천 하류에 생성된 계곡입니다 <br>
			천혜의 자연환경을 가지고 있는 이곳에는 안덕계곡을 비롯해 바위그늘 집자리, 숯거북 암거북 바위,보살상,그리고 산방산에서 중문까지 즐길 수 있는 전망대 등의 주요 관광명소가 있는 곳입니다 <br><br>

			위치: 제주 서귀포시 안덕면 일주서로 1524
		</div>
		</div>
		</div>
</body>
