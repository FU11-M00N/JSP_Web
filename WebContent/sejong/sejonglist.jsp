...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">세종호수공원</font>
			</div>
			<div class="admin4">
				<font class="board2">영평사</font>
			</div>
			<div class="slideshow">
					<a href="lakepark.jsp" class="aaa"><img src=".\..\img\세종호수공원.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="yeongpyeongsa.jsp" class="aaa"><img src=".\..\img\영평사.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>