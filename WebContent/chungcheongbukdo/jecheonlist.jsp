...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">의림지</font>
			</div>
			<div class="admin4">
				<font class="board2">배론성지</font>
			</div>
			<div class="slideshow">
					<a href="uirimji.jsp" class="aaa"><img src=".\..\img\의림지.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="baeron.jsp" class="aaa"><img src=".\..\img\배론성지.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>