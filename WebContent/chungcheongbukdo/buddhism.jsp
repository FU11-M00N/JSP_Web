...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.641217,127.496283); // 위치값 위도 경도
	var Y_point			= 36.641217;		// Y 좌표
	var X_point			= 127.496283;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "대한 불교수도원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">대한 불교수도원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\대한불교수도원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			옛 사찰의 흔적을 느낄 수 있는 곳 <br>
			충청북도 청주시 상당구 우암산에 위치해있는 대한불교수도원은 여러 점의 불상이 파손된 옛 사찰의 자리에 창건된 절이며, <br>
			오랜 역사를 자랑하는 곳입니다. 우암산 등산로를 따라 시민들이 많이 찾는 곳으로 자연과 잘 어우러지는 곳이기도 합니다 <br><br>


			위치: 충북 청주시 상당구 수동 67-1
		</div>
		</div>
		</div>
</body>
