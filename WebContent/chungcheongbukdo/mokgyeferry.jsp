...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.074759,127.888583); // 위치값 위도 경도
	var Y_point			= 37.074759;		// Y 좌표
	var X_point			= 127.888583;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "목계나루";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>목계나루</h2>'+
	'<p>충주시 엄정면 동계길 29-1</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">목계나루</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\목계나루.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			우리나라의 대표적인 전통나루 <br>
			산책과 자전거라이딩 하기 좋은 수운의 중심 목계나루는 우리나라 대표적인 전통나루이며, 넓은 남한강변과 함께 힐링을 즐길 수 있고, <br>
			봄이면 유채꽃, 가을이면 메밀꽃이 주는 자연의 아름다움도 만끽할 수 있습니다. 목계나루는 1930년대 서울과 충주 사이에 철도가 놓이기 전까지 <br>
			남한강 수운 물류교역의 최대 중심지였습니다. 따라서 이 수운을 통해 동과 서, 남과 북의 문물이 모두 집산되던 곳입니다.넓은 평지와 잔잔히 흐르는 강물이 만드는 최고의 경치를 감상해보세요 <br><br>


			위치: 충북 충주시 엄정면 동계길 29-1
		</div>
		</div>
		</div>
</body>
