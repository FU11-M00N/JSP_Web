...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">술 박물관 리쿼리움</font>
			</div>
			<div class="admin4">
				<font class="board2">목계나루</font>
			</div>
			<div class="slideshow">
					<a href="alcohol.jsp" class="aaa"><img src=".\..\img\술박물관리쿼리움.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="mokgyeferry.jsp" class="aaa"><img src=".\..\img\목계나루.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>