...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">적성산성</font>
			</div>
			<div class="admin4">
				<font class="board2">단양 신라 적성비</font>
			</div>
			<div class="slideshow">
					<a href="aptitude.jsp" class="aaa"><img src=".\..\img\적성산성.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="jeokseong.jsp" class="aaa"><img src=".\..\img\단양신라적성비.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>