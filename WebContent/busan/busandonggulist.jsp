...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">초량 이바구길</font>
			</div>
			<div class="admin4">
				<font class="board2">자유 도매시장 꽃시장</font>
			</div>
			<div class="slideshow">
					<a href="ebaguload.jsp" class="aaa"><img src=".\..\img\초량이바구길.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="flowermarket.jsp" class="aaa"><img src=".\..\img\자유도매시장꽃시장.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>