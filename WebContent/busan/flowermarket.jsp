...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.140921 ,129.061091); // 위치값 위도 경도
	var Y_point			= 35.140921;		// Y 좌표
	var X_point			= 129.061091;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "자유 도매시장 꽃시장";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>자유 도매시장 꽃시장</h2>'+
	'<p>부산광역시 동구 범일2동 조방로 48</p>' +
	...
	<div>
		...
		<thead>
		  <tr>
		    ...
		    <th class="top2" style="font-weight:bold"><a href=".\..\busan\busandonggulist.jsp" class="aaa">동구</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">자유 도매시장 꽃시장</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\자유도매시장꽃시장.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			꽃 향기 솔~솔~<br><br>
			
			부산을 대표하는 자유도매시장은 지하부터 지상 5층까지 다양한 상품을 팔고 있어 많은 시민들로 붐비고 있으며,<br> 
			그 안에 위치한 꽃시장은 형형색색의 아름다운 꽃들이 끝없이 줄지어 있어 향기로 가득하고, 입구에 들어서면 <br>
			다양한 꽃향기가 코를 자극한답니다. 또, 다양한 생화를 만날수 있지만, 생화 외에도 조화, 그리고 자재를 한곳에서<br> 
			다 구입을 할수 있다는 장점도 있습니다.<br><br>

			
			위치: 부산광역시 동구 범일2동 조방로 48<br>
