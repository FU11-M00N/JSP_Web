...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.116774 ,129.036561); // 위치값 위도 경도
	var Y_point			= 35.116774;		// Y 좌표
	var X_point			= 129.036561;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "초량 이바구길";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>초량 이바구길</h2>'+
	'<p>부산광역시 동구 초량동 초량상로 49</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">초량 이바구길</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\초량이바구길.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			부산 전경을 한눈에 볼 수 있는 길<br><br>

			부산의 지붕이라고 불리는 산복도로에 위치한 초량이바구길은 피난민들이 부산 초량의 산을 깍아 만든 마을로 이어지는 곳입니다.<br>
			부산의 전경을 한 눈에 볼 수 있는 멋진 초량이바구길은 유치환우체통, 김민부전망대등 볼거리가 다양합니다.<br><br>

			
			위치: 부산광역시 동구 초량동 초량상로 49<br>
