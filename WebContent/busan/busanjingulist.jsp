...
<body>
	...
	<div>
		...
		<tbody>
		  <tr>
		    <td class="bottom" style="font-weight:bold"><a href=".\..\busan\busanjumgulist.jsp" class="aaa">진구</a></td>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">서면 1번가</font>
			</div>
			<div class="admin4">
				<font class="board2">서면시장</font>
			</div>
			<div class="slideshow">
					<a href="seomeon1st.jsp" class="aaa"><img src=".\..\img\서면1번가.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="seomeonmarket.jsp" class="aaa"><img src=".\..\img\서면시장.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>