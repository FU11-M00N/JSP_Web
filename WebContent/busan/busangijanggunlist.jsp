...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">신세계 프리미엄 아울렛</font>
			</div>
			<div class="admin4">
				<font class="board2">죽성성당</font>
			</div>
			<div class="slideshow">
					<a href="newworldmarket.jsp" class="aaa"><img src=".\..\img\신세계프리미엄아울렛.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="juksungsungdang.jsp" class="aaa"><img src=".\..\img\죽성성당.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>