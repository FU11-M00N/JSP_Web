...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.323890 ,129.236209); // 위치값 위도 경도
	var Y_point			= 35.323890;		// Y 좌표
	var X_point			= 129.236209;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "신세계 프리미엄 아울렛";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>신세계 프리미엄 아울렛</h2>'+
	'<p>부산광역시 기장군 장안읍 정관로 1133</p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" ><a href=".\..\busan\busanjunggulist.jsp" class="aaa">중구</a></th>
		...
		<tbody>
		  <tr>
		    ...
		    <td class="bottom2" style="font-weight:bold"><a href=".\..\busan\busangijanggunlist.jsp" class="aaa">기장군</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">신세계 프리미엄 아울렛</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\신세계프리미엄아울렛.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			부산의 아름다운 쇼핑지<br><br>
			
			부산에 위치한 신세계프리미엄 아울렛은 외관이 서양건축 형식으로 멋있게 만들어져있어 쇼핑의 기분을 업시켜주며, <br>
			내부 편의시설과, 음식점, 자연조경 등이 모두 잘갖추어져있어 쇼핑뿐만아니라 휴식도 함께 할수있습니다.<br>
			분수나 쉬는공간의 테라스 및 계단과 조형물들이 전체적으로 이국적인 분위기로 멋스럽게 꾸며져 마치 다른나라의 쇼핑로드를 옮겨놓은듯 한 기분을 느낄 수 있습니다. <br><br>


			
			위치: 부산광역시 기장군 장안읍 정관로 1133<br>
