...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">보수동 책방골목</font>
			</div>
			<div class="admin4">
				<font class="board2">국제시장</font>
			</div>
			<div class="slideshow">
					<a href="bookload.jsp" class="aaa"><img src=".\..\img\보수동책방골목.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="intmarket.jsp" class="aaa"><img src=".\..\img\국제시장.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>