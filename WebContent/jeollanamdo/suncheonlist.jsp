...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">순천 드라마 촬영장</font>
			</div>
			<div class="admin4">
				<font class="board2">순천만 자연 생태공원</font>
			</div>
			<div class="slideshow">
					<a href="drama.jsp" class="aaa"><img src=".\..\img\순천드라마세트장.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="ecologicalpark.jsp" class="aaa"><img src=".\..\img\순천만자연생태공원.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>