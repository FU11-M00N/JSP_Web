...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.326670,126.985392); // 위치값 위도 경도
	var Y_point			= 35.326670;		// Y 좌표
	var X_point			= 126.985392;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "죽녹원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>죽녹원</h2>'+
	'<p>담양군 담양읍 죽녹원로 119</p>' +
...
<body>
	...
	<div>
		...
		<tbody>
		  <tr>
		    <td class="bottom" style="font-weight:bold"><a href=".\..\jeollanamdo\damyanglist.jsp" class="aaa">담양</a></td>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">죽녹원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\죽녹원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			대나무향 가득한 곳에서 힐링을 <br>
			전라남도 담양 성인산 일대에 위치해있는 울창한 대나무 숲인 담양 죽녹원에는 8가지의 테마로 조성된 산책로가 있으며, 전망대는 메타세콰이아 가로수길이 한눈에 내려다보이는 장관을 이루고 있습니다 <br>
			2003년에 조성된 죽녹원은 울창한 대나무 숲으로 죽림욕을 즐기며 걸을 수 있는 산책로가 2.4km나 되는 곳입니다. 쭉 뻗은 대나무가 빽빽하게 들어서 있는 죽녹원 길은 힐링의 장소입니다 <br><br>
