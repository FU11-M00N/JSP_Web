...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(34.550827,126.622249); // 위치값 위도 경도
	var Y_point			= 34.550827;		// Y 좌표
	var X_point			= 126.622249;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "고산 윤선도 유적지";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top"><a href=".\..\jeollanamdo\yeosulist.jsp" class="aaa">여수</a></th>
		...
		<tbody>
		  <tr>
		    ...
		    <td class="bottom2" style="font-weight:bold"><a href=".\..\jeollanamdo\haenamlist.jsp" class="aaa">해남</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">고산 윤선도 유적지</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\고산윤선도유적지.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			영화 '불꽃처럼 나비처럼'으로 유명한 촬영지 <br>
			고산윤선도유적지는 고산 윤선도가 살았던 집으로 윤선도의 조부인 효정이 연동에 터를 정하면서 지은 15세기 중엽의 건물로, 녹우단을 상징하는 은행나무와 500여년 된 비자나무숲이 우거져 있습니다 <br>
			윤선도선생의 유적지는 600년 전통의 해남윤씨 어초은파의 종가 고택 녹우당, 은행나무 비자림, 추원당 등의 조선시대 양반가 중 가장 많은 유물을 보관해온 집으로 잘 알려져 있습니다 <br><br>

 
			위치: 전남 해남군 해남읍 연동리 82
		</div>
		</div>
		</div>
</body>
