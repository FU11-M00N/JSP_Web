...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(34.886054,127.509014); // 위치값 위도 경도
	var Y_point			= 34.886054;		// Y 좌표
	var X_point			= 127.509014;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "순천만 자연 생태공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">순천만 자연 생태공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\순천만자연생태공원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			인간과 자연이 공존하는 최고의 습지 <br>
			전라남도 순천시에 위치해있는 순천만자연생태공원에는 다양한 생물들이 살고 있으며, 갯벌에 펼쳐진 갈대밭은 자연과 하나 되어 멋진 경관을 자랑합니다 <br>
			순천만 자연생태공원은 오전 8시부터 일몰시까지 관람이 가능한데요, 일몰시간에 따라 매표(입장) 시간이 다릅니다 <br>
			11월 ~ 2월은 오후 5시까지, 3/4월과 9/10월은 오후 6시까지, 그리고 5월 ~ 8월은 오후 6시까지  입장이 가능합니다 <br><br>
