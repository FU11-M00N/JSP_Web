...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.331643,126.987404); // 위치값 위도 경도
	var Y_point			= 35.331643;		// Y 좌표
	var X_point			= 126.987404;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "추성창의 기념관";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">추성창의 기념관</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\추성창의기념관.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			나라를 지킨 의병의 기개가 느껴지는 곳 <br>
			전남 담양은 조선시대 최대 국난이었던 임진왜란 당시 호남지역 의병의 주요 발원지로 수많은 의병들이 나라를 위해 싸우다 전사하였으며, <br>
			이를 기리고 후세에게 우국충정의 정신을 전하기 위해 건립되었으며 죽녹원 내에 위치해 있다 보니 주변 경관 또한 훌륭한 곳입니다 <br><br>

 
			위치: 전남 담양군 담양읍 운교리 101
		</div>
		</div>
		</div>
</body>
