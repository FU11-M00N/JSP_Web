...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(34.574817,126.602063); // 위치값 위도 경도
	var Y_point			= 34.574817;		// Y 좌표
	var X_point			= 126.602063;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "해남향교";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">해남향교</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\해남향교.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			땅끝마을 해남에 위치한 향교 <br>
			해남향교는 우리나라에서 가장 오래된 향교로 추정되는 역사적 가치가 있는 곳으로 한적하고 아늑한 분위기 속 <br>
			가벼운 산보를 즐겨볼 수 있습니다. 해남향교는 고려 충렬왕 때 안향(安珦)이접반사(接伴使)주)1로 중국사신을 해남 백포만에서 맞이하게 되어 <br>
			중국사신을 영접하기 위해 이곳에 문묘(文廟)주)2를 세운데서 기원한 우리나라에서 가장 오래된 향교로 추정되는 역사적 가치가 있는 장소입니다 <br><br>
 
			위치: 전남 해남군 해남읍 수성리 105
		</div>
		</div>
		</div>
</body>
