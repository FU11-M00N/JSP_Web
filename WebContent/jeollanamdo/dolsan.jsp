...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(34.730468,127.739947); // 위치값 위도 경도
	var Y_point			= 34.730468;		// Y 좌표
	var X_point			= 127.739947;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "돌산공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">돌산공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\돌산공원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			화려한 조명과 어우러진 여수 밤바다 <br>
			돌산대교 근처 야경명소인 돌산공원은 여수시에서 돌산도를 향해 돌산대교를 건너면 왼편에 있는 공원으로 <br>
			화려한 조명빛이 어우러져 아름다운 야경을 즐길 수 있습니다.여수시에서 돌산도를 향해 돌산대교를 건너면 왼편으로 있는 아름다운 돌산공원은 <br>
			1876년부터 조성되었으며, 동백나무를 비롯한 다양한 수목, 꽃과 함께 산책로와 쉼터 등 다양한 시설이 잘 갖춰진 공원으로 많은 관광객들이 발걸음하고 있습니다 <br><br>
