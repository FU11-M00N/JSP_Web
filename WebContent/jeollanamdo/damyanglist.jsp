...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">죽녹원</font>
			</div>
			<div class="admin4">
				<font class="board2">추성창의 기념관</font>
			</div>
			<div class="slideshow">
					<a href="jungnogwon.jsp" class="aaa"><img src=".\..\img\죽녹원.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="chushengchang.jsp" class="aaa"><img src=".\..\img\추성창의기념관.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>