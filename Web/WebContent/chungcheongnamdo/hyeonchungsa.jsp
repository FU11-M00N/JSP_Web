...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.806742,127.032442); // 위치값 위도 경도
	var Y_point			= 36.806742;		// Y 좌표
	var X_point			= 127.032442;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "현충사";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>현충사</h2>'+
	'<p>아산시 염치읍 백암리 298-1</p>' +
...
<body>
	...
	<div>
		...
		<tbody>
		  <tr>
		    <td class="bottom" style="font-weight:bold"><a href=".\..\chungcheongnamdo\asanlist.jsp" class="aaa">아산</a></td>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">현충사</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\현충사.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			충무공 이순신의 호국정신을 기리는곳 <br>
			현충사는 백암리 방화산 기슭에 자리하고 있는 아산의 사찰이다. 이곳은 충무공 이순신 장군의 정신과 위업을 선양했던 곳이며, <br>
			이순신 장군이 혼인 후 무예를 연마하며 구국의 역량을 길렀던 장소라고합니다. 2011년 전시관과 교육관을 갖춘 충무공이순신 기념관이 건립되었고, <br>
			전시관에는 이순신 장군과 임진왜란에 관한 각종 유물이 전시되어 있으며, 교육관에는 이순신 장군 정신과 위업선양을 위한 강의와 세미나가 열리고 있습니다 <br><br>
