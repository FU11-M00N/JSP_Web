...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">흑성산성</font>
			</div>
			<div class="admin4">
				<font class="board2">독립기념관</font>
			</div>
			<div class="slideshow">
					<a href="heukseong.jsp" class="aaa"><img src=".\..\img\흑성산성.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="independence.jsp" class="aaa"><img src=".\..\img\독립기념관.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>