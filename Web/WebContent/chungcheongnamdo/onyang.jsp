...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.762777,127.015788); // 위치값 위도 경도
	var Y_point			= 36.762777;		// Y 좌표
	var X_point			= 127.015788;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "온양향교";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">온양향교</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\온양향교.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			조선시대의 향교 <br>
			충남 문화재자료 제115호로 지정된 온양향교는 지방민의 교육과 교화를 위해 창건 되었으며, <br>
			향교는 내삼문, 외삼문, 명륜당, 대성전 등으로 구성되어 있다. 본래 아산시 버배곡동에 있던 향교는 임진왜란때 불타 없어졌다가 지금의 자리로 옮겨 세웠다 <br>
			향교란 중국과 우리나라 유현의 위패를 모시고 제향을 받들며, 유학을 교육하는 교육기관으로 이곳 온양향교는 조선시대의 향교의 전통적인 공간 배치를 보존하고 있는 곳이기도 합니다 <br><br>
