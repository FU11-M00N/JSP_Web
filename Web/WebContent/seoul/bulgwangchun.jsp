...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.587597,126.912436); // 위치값 위도 경도
	var Y_point			= 37.587597;		// Y 좌표
	var X_point			= 126.912436;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "불광천 춤추는 노래분수대";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>불광천 춤추는 노래분수대</h2>'+
	'<p>서울특별시 은평구 증산로 476</p>' +
	...
	<div>
		...
		<tbody>
		  <tr>
		    ...
		    <td class="bottom2" style="font-weight:bold"><a href=".\..\seoul\eunpyeonglist.jsp" class="aaa">은평</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">불광천 춤추는 노래분수대</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\춤추는노래분수대.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			시원하게 뿜어져 나오는 분수를 만날 수 있는 곳<br><br>

			서울 은평구 불광천에서 만나볼 수 있는 춤추는 노래분수대는 국내 최초 칼라레이저를 적용한 음악분수로 <br>
			클래식, 댄스 등 음악과 함께 시원하게 뿜어져나오는 물줄기를 즐길 수 있으며, 해질 무렵부터 가동되는데요,<br>
			클래식, 신나는 음악 등의 노래들로 구성되어 다양한 재미를 누릴 수 있습니다.<br><br>



			
			위치: 서울특별시 은평구 증산로 476<br>
