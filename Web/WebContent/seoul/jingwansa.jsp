...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.638298,126.946630); // 위치값 위도 경도
	var Y_point			= 37.638298;		// Y 좌표
	var X_point			= 126.946630;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "진관사";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>진관사</h2>'+
	'<p>서울특별시 은평구 진관동 354</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">진관사</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\진관사.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			서울 근교 4대사찰<br><br>

			북한산 기슭에 위치한 진관사는 조선때 한양 근교의 4대사찰이었습니다.<br>
			주변이 북한산국립공원으로 지정된만큼 자연조경도 잘 가꿔져있어 산책하기에도 조용하고 평화로워 지는곳이며,<br>
			아름다운 북한산의 풍광과 어우러져 한폭의 그림같은 모습을 하고있습니다.<br>
			여승들의 손길이 깃든 아름다운곳으로 사시사철 볼수록 아름다운 꽃과 나무들이 가득한 곳이기도합니다.<br><br>


			
			위치: 서울특별시 은평구 진관동 354<br>
