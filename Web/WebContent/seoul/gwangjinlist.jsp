...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">청담대교</font>
			</div>
			<div class="admin4">
				<font class="board2">뚝섬 한강공원</font>
			</div>
			<div class="slideshow">
					<a href="chungdamdaegyo.jsp" class="aaa"><img src=".\..\img\청담대교.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="thuksumriver.jsp" class="aaa"><img src=".\..\img\뚝섬 한강공원.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>