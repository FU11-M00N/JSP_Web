...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.582433,126.983653); // 위치값 위도 경도
	var Y_point			= 37.582433;		// Y 좌표
	var X_point			= 126.983653;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "북촌 한옥마을";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>북촌 한옥마을</h2>'+
	'<p>서울특별시 종로구 가회동 계동길 37</p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" style="font-weight:bold"><a href=".\..\seoul\jongnolist.jsp" class="aaa">종로</a></th>
		    <th class="top2"><a href=".\..\seoul\gwangjinlist.jsp" class="aaa">광진</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		    <td class="bottom"><a href=".\..\seoul\gangbuklist.jsp" class="aaa">강북</a></td>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">북촌 한옥마을</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\북촌한옥마을.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			한옥의 고즈넉한 북촌8경 중(5-6경)<br><br>

			경복궁과 창덕궁 사이의 한옥마을인 북촌 5경과 6경은 8경 중 <br>
			가장 인기 있는 포토존으로, 웅장한 한옥과 너머로 보이는 시내를 한번에 감상할 수 있습니다. 멋스러운 풍경들을 감상하며 걷다 보면<br> 
			5경 포토존인 가회동 내림 골목길을 만나게 되는데, 한옥이 빼곡하게 들어선 멋진 골목의 풍경을 한눈에 감상하기 좋은 곳입니다.<br>
			6경인 가회동 골목은 오름모습은 또다른 매력을 풍기고 있습니다.<br><br>
			
			위치: 서울특별시 종로구 가회동 계동길 37<br>
