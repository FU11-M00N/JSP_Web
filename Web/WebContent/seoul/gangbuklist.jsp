...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">북서울 꿈의 숲</font>
			</div>
			<div class="admin4">
				<font class="board2">국립 4.19 민주묘지</font>
			</div>
			<div class="slideshow">
					<a href="dreamforest.jsp" class="aaa"><img src=".\..\img\북서울꿈의숲.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="minjumyo.jsp" class="aaa"><img src=".\..\img\419민주묘지.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>