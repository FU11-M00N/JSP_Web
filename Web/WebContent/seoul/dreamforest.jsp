...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.621083,127.041027); // 위치값 위도 경도
	var Y_point			= 37.621083;		// Y 좌표
	var X_point			= 127.041027;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "북서울 꿈의 숲";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">북서울 꿈의 숲</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\북서울꿈의숲.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			서울의 대표 공원<br><br>

			서울 도심에서 자연을 느낄 수 있는 북서울 꿈의 숲은, 다양한 공원문화재와, 호수가 있어서 볼거리가 많은 공원이며,<br>
			서울특별시 강북구에 위치한 북서울꿈의숲은 본래 드림랜드라는 놀이공원 자리였으나 놀이공원이 쇠락해지면서 강북구의 녹지공원을 <br>
			형성하기위해 주위의 부지까지 넓게 확장하여 조성한곳으로 서울에서는 4번째로 큰 공원입니다<br><br>


			
			위치: 서울특별시 강북구 번동 월계로 173<br>
