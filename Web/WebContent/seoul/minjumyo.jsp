...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.648739,127.007848); // 위치값 위도 경도
	var Y_point			= 37.648739;		// Y 좌표
	var X_point			= 127.007848;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "국립 4.19 민주묘지";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>국립 4.19 민주묘지</h2>'+
	'<p>서울특별시 강북구 수유동 580-1</p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" ><a href=".\..\seoul\jongnolist.jsp" class="aaa">종로</a></th>
		    <th class="top2" ><a href=".\..\seoul\gwangjinlist.jsp" class="aaa">광진</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		    <td class="bottom" style="font-weight:bold"><a href=".\..\seoul\gangbuklist.jsp" class="aaa">강북</a></td>
		    <td class="bottom2"><a href=".\..\seoul\eunpyeonglist.jsp" class="aaa">은평</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">국립 4.19 민주묘지</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
				<td align="left">Admin &nbsp&nbsp │ 2020.06.15</td>
			</tr>
		</table>
		</table>
		<div id="map_ma">
		...
		<div class="slideshow">
		     <img src=".\..\img\419민주묘지.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			4.19 혁명의 희생자들이 묻힌 곳.<br><br>

			우리나라 민주 역사에 한 획을 그은 4.19혁명의 희생자들이 묻혀있는 곳으로 그분들을 추모하고 기리는 신성한 장소로 자유, 민주, 정의가 살아 숨 쉬는 묘역입니다.<br>
			정문으로 들어오면 다목적 광장과 연못들이 있는 휴게공간이 있습니다. 산책로가 예쁘게 조성되어 있고, 경관이 매우 좋기 때문에 <br>
			사계절의 변화를 느끼며 나들이를 즐기는 연인 및 가족단위로 찾는 사람이 많습니다.특히 국립 4.19 민주묘지는 노을이 지는 저녁 풍경이 아름답기로 유명합니다.<br><br>


			
			위치: 서울특별시 강북구 수유동 580-1<br>
