...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">진관사</font>
			</div>
			<div class="admin4">
				<font class="board2">불광천 춤추는 노래분수대</font>
			</div>
			<div class="slideshow">
					<a href="jingwansa.jsp" class="aaa"><img src=".\..\img\진관사.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="bulgwangchun.jsp" class="aaa"><img src=".\..\img\춤추는노래분수대.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>