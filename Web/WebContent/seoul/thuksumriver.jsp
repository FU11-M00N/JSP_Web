...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.529528,127.071239); // 위치값 위도 경도
	var Y_point			= 37.529528;		// Y 좌표
	var X_point			= 127.071239;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "뚝섬 한강공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>뚝섬 한강공원</h2>'+
	'<p>서울특별시 광진구 자양동 704-1</p>' +
	...
	<div>
		...
		<thead>
		  <tr>
		    ...
		    <th class="top2" style="font-weight:bold"><a href=".\..\seoul\gwangjinlist.jsp" class="aaa">광진</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">뚝섬 한강공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\뚝섬 한강공원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			낭만과 젊음이 있는 한강공원<br><br>

			한강공원이 생기기 전부터 강병유원지로 유명했던 뚝섬 한강공원입니다. <br>
			넓은 한강에서 바람을 맞으며 수상레저를 즐길수 있는 뚝섬 한강공원으로 놀러오세요!<br>  
			예로부터 풍광이 아름다웠던 뚝섬은 왕들의 섬이라 불리웠던 곳이고 한강공원으로새단장을 하기전 강변유원지라 불리던 시절부터<br> 
			많은 시민들에게 도심속 쉼터를 제공해주고있습니다.<br><br>


			
			위치: 서울특별시 광진구 자양동 704-1<br>
