...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.498679,127.273410); // 위치값 위도 경도
	var Y_point			= 36.498679;		// Y 좌표
	var X_point			= 127.273410;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "세종호수공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">세종호수공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\세종호수공원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			세종시의 대표 공원 <br>
			세종특별시에 위치하고 있는 세종호수공원은 다양한 테마의 섬들이 있어 호수공원을 찾는 시민들에게 볼거리를 선사하는 공원이다 <br>
			세종시 연기면에 위치한 호수공원은 드라이브를 하거나 산책하시기에 적당한 곳으로 특히 무인시스템으로 운영되는 자전거를 빌려서 라이딩을 하시면 너무 좋은 곳입니다.세종시 호수공원에서 제일 인기는 바로 수상무대섬입니다 <br>
			5개 주제의 섬으로 이루어져 있으며 각각 축제섬, 습지섬, 물꽃섬, 무대섬, 물놀이섬으로 불립니다. 수심 50cm의 물놀이 시설과 반짝이는 모래가 마련되어 있는 모래해변이 있는 물놀이섬은 인기 만점입니다 <br><br>
			
			위치: 세종 연기면 세종리 114-380
