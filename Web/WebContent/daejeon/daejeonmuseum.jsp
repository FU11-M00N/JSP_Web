...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.326786,127.420945); // 위치값 위도 경도
	var Y_point			= 36.326786;		// Y 좌표
	var X_point			= 127.420945;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "대전 근현대사 전시관";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	...
	<div>
		...
		<thead>
		  <tr>
		    ...
		    <th class="top2"style="font-weight:bold"><a href=".\..\daejeon\daejeonjunggulist.jsp" class="aaa">중구</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">대전 근현대사 전시관</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\대전근현대사전시관.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			대전의 근현대사를 알 수 있는 전시관<br><br>

			충남의 중심 도시인 대전에 있는 곳으로 구 충청남도 도청사를 이용해 개관하였으며 <br>
			대전 및 충청도 지역의 올바른 근현대사를 알리기 위해 건립된 곳입니다. <br>
			대전광역시 중구 선화동에 위치한 대전 근현대사 전시관은 등록문화제 제18호로 지정되어 있는 <br>
			과거 충청남도 도청사 본관을 활용하여 대전의 근현대사를 알아보기 좋도록 전시하고 꾸며둔 전시관입니다.<br><br>
