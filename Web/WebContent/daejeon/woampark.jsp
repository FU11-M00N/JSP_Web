...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.348016,127.456791); // 위치값 위도 경도
	var Y_point			= 36.348016;		// Y 좌표
	var X_point			= 127.456791;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "우암사적공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">우암사적공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\우암사적공원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			도심 속 안식처<br><br>

			송시열 선생이 학문을 공부하던 곳으로 중요한 남간정사, 기국정, 송자대전판 등 역사가 담겨있는 문화재 중 하나이다. <br>
			조선시대의 서원을 재현하여 우암사적공원으로 잘 가꿔져 있어 도심 속 시민들의 안식처이다. <br>
			우암 송시열 선생의 발자취를 느끼며 산책을 하기 좋고, 등산로와도 연결되어 있어서 대전시민의 사랑을 많이 받는 곳이랍니다.<br><br>


			
			위치: 대전광역시 동구 가양동 65<br>
		</div>
		</div>
		</div>
</body>
