...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.306232,127.293065); // 위치값 위도 경도
	var Y_point			= 36.306232;		// Y 좌표
	var X_point			= 127.293065;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "천명각";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>천명각</h2>'+
	'<p>대전광역시 유성구 진잠동 368</p>' +
...
<body>
	...
	<div>
		...
		<tbody>
		  <tr>
		    <td class="bottom" ><a href=".\..\daejeon\daejeonseogulist.jsp" class="aaa">서구</a></td>
		    <td class="bottom2"style="font-weight:bold"><a href=".\..\daejeon\daejeonysgulist.jsp" class="aaa">유성구</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">천명각</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\천명각.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			하늘의 별과 맡닿는 장소<br><br>

			대전 유성구에 위치한 천명각은 문화재적으로 가치가 높아 인근 지역개발에도 외따섬의 공원처럼 보전되고 있다고 합니다.<br>
			도시개발이 한창인 가운데 나혼자 시대를 거슬러 그시간 그자리를 지키는 곳이 있습니다.<br>
			지역 주민들조차도 생소한 분들이 많다고하는 그곳 천명각 문화재적인 가치가 아주 높은곳이라 <br>
			주변의 도시화 산업화에도 아랑곳하지 않고 범상치 않은 조형물들이 이곳을 소리없이 지키고 위용을 뽐내고 있습니다.<br><br>


			
			위치: 대전광역시 유성구 진잠동 368<br>
		</div>
		</div>
		</div>
</body>
