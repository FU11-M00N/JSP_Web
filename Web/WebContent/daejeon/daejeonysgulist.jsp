...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">국립 대전 현충원</font>
			</div>
			<div class="admin4">
				<font class="board2">천명각</font>
			</div>
			<div class="slideshow">
					<a href="inthyunchungwon.jsp" class="aaa"><img src=".\..\img\국립대전현충원.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="chunmyeonggak.jsp" class="aaa"><img src=".\..\img\천명각.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>