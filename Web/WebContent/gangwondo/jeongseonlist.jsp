...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">화암동굴</font>
			</div>
			<div class="admin4">
				<font class="board2">정암사</font>
			</div>
			<div class="slideshow">
					<a href="hwaam.jsp" class="aaa"><img src=".\..\img\화암동굴.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="jeongamsa.jsp" class="aaa"><img src=".\..\img\정암사.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>