...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(33.332859,126.325851); // 위치값 위도 경도
	var Y_point			= 33.332859;		// Y 좌표
	var X_point			= 126.325851;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "남이섬";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" style="font-weight:bold"><a href=".\..\gangwondo\chuncheonlist.jsp" class="aaa">춘천</a></th>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">남이섬</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\남이섬.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			드라마 '겨울연가' 속 주인공의 첫키스 장소 <br>
			강원도 춘천시에 위치해있는 관광명소 남이섬! 남이섬은 나미나라공화국이라는 이름 아래 매년 수많은 국내외 관광객들이 모여들고 있습니다 <br>
			연인들의 데이트 코스, 가족 나들이 코스로 유명한 가평 남이섬은 1944년 청평댐이 만들어지면서 생겨난 섬으로, 북한강 위에 반달 모양으로 떠 있는 섬입니다 <br>
			배를 타고 들어가야 하는 곳으로 드라마 촬영지로 잘 알려진 곳입니다 <br><br>
