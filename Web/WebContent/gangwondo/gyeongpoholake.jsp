...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.797424,128.902104); // 위치값 위도 경도
	var Y_point			= 37.797424;		// Y 좌표
	var X_point			= 128.902104;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "경포호";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<div class="board2"><br>
			아름다운 야경을 경포호에서 <br>
			강원도 강릉시에 위치해있는 경포호는 관동 8경의 중심지로, 아름다운 호수에 비친 동해의 일몰은 말이 필요 없는 절경 중 하나로 손꼽히고 있습니다. 경포호는 경호라고도 불리는데요, <br>
			시의 중심가에서 북쪽으로 약 6km 지점에 있고, 서쪽으로는 유천등의 작은 하천들이 흘러들고 있습니다. 호반 서쪽의 작은 언덕 위에 세워진 경포대는 예로부터 경포호를 배경으로 한 관동 8경 중 하나로 유명한 곳입니다 <br><br>
