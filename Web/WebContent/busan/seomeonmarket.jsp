...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.155745 ,129.058165); // 위치값 위도 경도
	var Y_point			= 35.155745;		// Y 좌표
	var X_point			= 129.058165;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "서면 시장";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>서면 시장</h2>'+
	'<p>부산광역시 부산진구 부전2동 서면로 56</p>' +
...
<body>
	...
	<div>
		...
		<tbody>
		  <tr>
		    <td class="bottom" style="font-weight:bold"><a href=".\..\busan\busanjingulist.jsp" class="aaa">진구</a></td>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">서면 시장</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\서면시장.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			여기가 먹거리천국!<br><br>

			부산의 먹거리천국으로 유명한 서면시장! 싱싱한 횟집부터 없는게 없는 먹자골목거리로 유명하지만 <br>
			그 외에도 생필품, 꽃, 볼거리도 다양하게 있어 부산에 가면 꼭 들려야 할 관광지로도 꼽히는 장소입니다.<br>
			서면시장에서는 부산의 후한 인심과 정을 느낄수 있고, 특히 부산에서 유명한 호떡, 돼지국밥 등을만날수 있는 먹거리천국입니다.<br><br>

			
			위치: 부산광역시 부산진구 부전2동 서면로 56<br>
