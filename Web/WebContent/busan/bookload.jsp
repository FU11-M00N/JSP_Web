...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.103160 ,129.027450); // 위치값 위도 경도
	var Y_point			= 35.103160;		// Y 좌표
	var X_point			= 129.027450;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "보수동 책방골목";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">보수동 책방골목</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\보수동책방골목.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			부산의 명물 보수동 책방골목<br><br>

			부산역사의 맥이라고 할 수 있는 보수동 책방골목은<br> 
			대청로 네거리에서 보수동 가로에 이르기까지 길게 이어지고 있는 책방거리로 중고서적과 저렴한 책을 구입할 수 있으며<br>
			새책도 저렴하게 구입이 가능 한 곳입니다. 국내에 얼마 남아있지 않은 헌책방골목으로 모든 종류의 책을 취급합니다.<br>
			헌책은 40~70%까지,새책도 10~20% 싸게 구입할 수 있습니다.<br><br>
			
			위치: 부산광역시 중구 보수동1가<br>
