...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.154711 ,129.057871); // 위치값 위도 경도
	var Y_point			= 35.154711;		// Y 좌표
	var X_point			= 129.057871;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "서면 1번가";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">서면 1번가</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\서면1번가.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			부산 핫플레이스 서면일번가!<br><br>

			부산의 명동거리라 할 수 있는 핫플레이스 서면일번가! 항상 부산 시민들과 관광객으로 붐벼 북적북적 거립니다.<br>
			쇼핑지와 먹거리, 볼거리 모두 갖춰져 있어 남녀노소 할 것 없이 모두 즐겨 찾는 장소입니다.<br>
			부산의 번화가 서면일번가는 낮부터 늦은 저녁까지  젊음의 거리로 많은 사람들이 북적이며,다양한 먹거리, 볼거리로<br>
			즐거움을 주는 핫플레이스랍니다.<br><br>
