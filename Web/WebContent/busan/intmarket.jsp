...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.101736 ,129.028385); // 위치값 위도 경도
	var Y_point			= 35.101736;		// Y 좌표
	var X_point			= 129.028385;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "국제시장";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>국제시장</h2>'+
	'<p>부산광역시 중구 광복동 국제시장2길 25</p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" style="font-weight:bold"><a href=".\..\busan\busanjunggulist.jsp" class="aaa">중구</a></th>
		    <th class="top2"><a href=".\..\busan\busandonggulist.jsp" class="aaa">동구</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		    <td class="bottom"><a href=".\..\busan\busanjingulist.jsp" class="aaa">진구</a></td>
		    <td class="bottom2"><a href=".\..\busan\busangijanggunlist.jsp" class="aaa">기장군</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">국제시장</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\국제시장.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			천만 관객 돌파한 영화 '국제시장' 촬영지<br><br>

			부산광역시 중구에 위치해있는 국제시장은 광복 이후 장터가 생기며 발전한 곳으로, <br>
			영화 국제시장의 배경이 되면서 더욱 유명세를 타기 시작한 부산의 대표적인 관광명소입니다.<br> 
			한때 부산은 우리나라에서 거래 규모가 가장 큰 상업도시였는데요, 그때 한창 상업도시로써 크게 성장을 한 국제시장은<br>
			1945년 우리나라의 광복과 함께 서서히 지금의 국제시장의 모습을 갖추게 되면서 부산에서는 상징적인 존재가 되었습니다.<br><br>

			
			위치: 부산광역시 중구 광복동 국제시장2길 25<br>
