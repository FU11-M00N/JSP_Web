...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.900438,128.559077); // 위치값 위도 경도
	var Y_point			= 35.900438;		// Y 좌표
	var X_point			= 128.559077;		// X 좌표
	var zoomLevel		= 15;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "하중도";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>하중도</h2>'+
	'<p>대구광역시 북구 노곡동 681-1</p>' +
	...
	<div>
		...
		<thead>
		  <tr>
		    ...
		    <th class="top2"style="font-weight:bold"><a href=".\..\daegu\daegubukgulist.jsp" class="aaa">북구</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">하중도</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\하중도.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			아름다운 꽃밭을 감상할 수 있는 곳<br><br>

			하중도는 곡류 하천이 유로가 바뀌면서 하천 가운데 생긴 퇴적지형으로 금호강이 흐르면서 오랜 시간동안 <br>
			퇴적되어 형성된 22만 제곱미터 정도의 큰 섬이랍니다. 하중도는 원래 비닐하우스가 잔뜩 들어서 있던 곳이었으나 <br>
			정비작업을 거쳐 2012년부터 지금까지 계속 재정비를 통해 꽃단지로 거듭난 아름다운 자연을 느낄 수 있는 곳입니다.<br><br>
			
			위치: 대구광역시 북구 노곡동 681-1<br>
