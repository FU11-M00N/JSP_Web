...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.865260,128.591157); // 위치값 위도 경도
	var Y_point			= 35.865260;		// Y 좌표
	var X_point			= 128.591157;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "관덕정 순교 기념관";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>관덕정 순교 기념관</h2>'+
	'<p>대구광역시 중구 남산동 관덕정길 11 </p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" style="font-weight:bold"><a href=".\..\daegu\daegujunggulist.jsp" class="aaa">중구</a></th>
		    <th class="top2"><a href=".\..\daegu\daegubukgulist.jsp" class="aaa">북구</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		    <td class="bottom"><a href=".\..\daegu\daegususunggulist.jsp" class="aaa">수성구</a></td>
		    <td class="bottom2"><a href=".\..\daegu\daegudalseogulist.jsp" class="aaa">달서구</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">관덕정 순교 기념관</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
				<td align="left">Admin &nbsp&nbsp │ 2020.06.17</td>
			</tr>
		</table>
		</table>
		<div id="map_ma">
		...
		<div class="slideshow">
		     <img src=".\..\img\관덕정순교기념관.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			종교의 자유를 위해 순교하신 곳.<br><br>

			대구지역 천주교인 25명이 박해를 받아 순교하신 곳으로 이를 기념하고 추모하기 위한 장소입니다.<br> 
			관덕정은 옛 대구지역의 무과시험을 보던 곳으로 을해박해, 정해박해, 기해박해와 병인박해 때 수많은 천주교인들을 처형한 장소라고 합니다.<br>
			1985년부터 1990년까지 뜻있는 분들이 순교자 기념관을 건립하여 현재는 많은 분들이 찾는 명소입니다.<br><br>
			
			위치: 대구광역시 중구 남산동 관덕정길 11<br>
