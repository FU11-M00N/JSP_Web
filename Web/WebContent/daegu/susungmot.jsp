...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.827729,128.617754); // 위치값 위도 경도
	var Y_point			= 35.827729;		// Y 좌표
	var X_point			= 128.617754;		// X 좌표
	var zoomLevel		= 15;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "수성못";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">수성못</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\수성못.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			대구가면 가봐야할 수성못<br><br>

			다양한 행사와 볼거리, 즐길 거리가 있는 대구 수성못입니다. <br>
			넓은 호수를 둘러싸고 자연도 감상하며 연인과 나들이하기 좋은 장소입니다. 대구의 강남과 같은 수성구 수성못에서 데이트 어떠신가요?<br>
			아름다운 호수를 보며 산책하기 좋은 수성못에서 사랑하는 사람과 산책을 하며 오손도손 이야기도 하며 즐거운 시간을 보내기에 좋습니다.<br>
