...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.874169,128.578110); // 위치값 위도 경도
	var Y_point			= 35.874169;		// Y 좌표
	var X_point			= 128.578110;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "달성공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>달성공원</h2>'+
	'<p>대구광역시 중구 달성공원로 35 </p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">달성공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\달성공원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			알록달록하게 물든 가을 풍경<br><br>

			달성공원은 신라시대 달불성에서 유래된 달성의 이름에서 유래된 대구의 대표공원입니다.<br>
			달성공원은 대구의 중심부에 위치하여 사적지와 동물원이 있어 어린이들과 청소년들의 교육장으로 이용이 되며<br> 
			다양한 식물을 보유하고 있는 공원입니다.  특히 달성공원은 가을의 단풍이 예쁘게 들어 가을나들이에 안성맞춤인 곳입니다.<br><br>
			
			위치: 대구광역시 중구 달성공원로 35<br>
