...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.852628,128.479919); // 위치값 위도 경도
	var Y_point			= 35.852628;		// Y 좌표
	var X_point			= 128.479919;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "호산공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>호산공원</h2>'+
	'<p>대구광역시 달서구 호산동 333-3</p>' +
	...
	<div>
		...
		<tbody>
		  <tr>
		    ...
		    <td class="bottom2"style="font-weight:bold"><a href=".\..\daegu\daegudalseogulist.jsp" class="aaa">달서구</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">호산공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\호산공원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			메타세콰이어길이 있는 호산공원!<br><br>

			주말에 데이트코스와 가족나들이로 많이 찾는공원 대구에 있는 호산공원 입니다. <br>
			대구에 2개밖에 없는 메타세콰이어길중 하나가 호산공원에 조성되어 있어 많은 방문객들이 찾는 곳입니다. <br>
			2011 대구의 아름다운거리이기도 했던 메타세콰이아 숲길은 1995~1996년에 조성이되었으며 <br>
			약 1km 길이를 자랑하며 250여 그루가 긴 터널로 조성이 되어진 공간입니다.<br><br>

			
			위치: 대구광역시 달서구 호산동 333-3<br>
