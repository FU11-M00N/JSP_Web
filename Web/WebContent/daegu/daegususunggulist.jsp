...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">수성못</font>
			</div>
			<div class="admin4">
				<font class="board2">노변동사직단</font>
			</div>
			<div class="slideshow">
					<a href="susungmot.jsp" class="aaa"><img src=".\..\img\수성못.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="nobyeunsajic.jsp" class="aaa"><img src=".\..\img\노변동사직단.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>