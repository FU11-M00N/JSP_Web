...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">간절곶</font>
			</div>
			<div class="admin4">
				<font class="board2">울산옹기 박물관</font>
			</div>
			<div class="slideshow">
					<a href="ganjeolgoat.jsp" class="aaa"><img src=".\..\img\간절곶.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="onggimuseum.jsp" class="aaa"><img src=".\..\img\울산옹기박물관.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>