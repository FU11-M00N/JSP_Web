...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.521417,129.429104); // 위치값 위도 경도
	var Y_point			= 35.521417;		// Y 좌표
	var X_point			= 129.429104;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "성바오로 성당";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>성바오로 성당</h2>'+
	'<p>울산광역시 동구 남목2동 명덕로 11-14</p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" ><a href=".\..\ulsan\ulsanjunggulist.jsp" class="aaa">중구</a></th>
		    <th class="top2"><a href=".\..\ulsan\ulsannamgulist.jsp" class="aaa">남구</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		    <td class="bottom" style="font-weight:bold"><a href=".\..\ulsan\ulsandonggulist.jsp" class="aaa">동구</a></td>
		    <td class="bottom2"><a href=".\..\ulsan\ulsanuljugunlist.jsp" class="aaa">울주군</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">성바오로 성당</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\성바오로성당.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			고풍스러운 성당에서 힐링을.<br><br>

			성인 바오로를 주보로 삼은 천주교 성당으로 고풍스러운 성당 건물과 고즈넉한 정원을 통해 힐링할 수 있는 장소입니다.<br>
			울산 동구에 위치한 성 바오로 성당은 1986년 설립되어 이 지역 신자들뿐만 아니라 시민들의 오랜 사랑을 받아온 곳입니다. <br>
			원래는 울산대학교 병원의 업무를 담당하고 있던 수녀님들의 선교와 사회봉사 활동을 하기 위해 삶의 터를 잡은 곳으로 <br>
			타 지역 주민들의 신자 수가 크게 늘어 지금의 성 바오로 성당이 설립되기에 이르렀습니다.<br><br>



			
			위치: 울산광역시 동구 남목2동 명덕로 11-14<br>
		</div>
		</div>
		</div>
</body>
