...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.547793,129.296209); // 위치값 위도 경도
	var Y_point			= 35.547793;		// Y 좌표
	var X_point			= 129.296209;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "태화강 대공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>태화강 대공원</h2>'+
	'<p>울산광역시 중구 태화동 신기길</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">태화강 대공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\태화강대공원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			전국 최대규모의 수변공원<br><br>

			태화강대공원은 울산뿐만이 아니라 전국에서 최대의 규모를 자랑하는 도심 친수공간으로써<br>
			오산못, 대나무생태원, 느티나무길, 대숲산책로, 청보리단지등 <br>
			다양한 테마의 자연공원이 조성되어 울산시민들에게 아름다운 자연환경을 제공해주고 있다. <br><br>


			
			위치: 울산광역시 중구 태화동 신기길<br>
		</div>
		</div>
		</div>
</body>
