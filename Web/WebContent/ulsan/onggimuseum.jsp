...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.435066,129.279555); // 위치값 위도 경도
	var Y_point			= 35.435066;		// Y 좌표
	var X_point			= 129.279555;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "울산 옹기박물관";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>울산 옹기박물관</h2>'+
	'<p>울산광역시 울주군 온양읍 외고산3길 36</p>' +
...
<body>
	...
	<div>
		...
		<tbody>
		  <tr>
		    <td class="bottom" ><a href=".\..\ulsan\ulsandonggulist.jsp" class="aaa">동구</a></td>
		    <td class="bottom2"style="font-weight:bold"><a href=".\..\ulsan\ulsanuljugunlist.jsp" class="aaa">울주군</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">울산 옹기박물관</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\울산옹기박물관.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			울산 옹기에 대해 알아보자<br><br>

			울산광역시 울주군에 위치해있는 울산옹기박물관은 울산 옹기의 역사와 현재, 미래에 대해 알 수 있는 곳으로, <br>
			다양한 옹기가 전시되어 있고, 옹기 체험 프로그램이 진행되고 있어서 유익한 시간을 보낼 수 있습니다. <br>
			조상의 지혜와 슬기를 지금까지 이어오고 있는 곳으로 전통과 문화의 산실인 전국 최대의 민속 옹기마을인데요,<br>
			옹기아카데미관, 교육가마, 전시가마, 옹기문화공원, 생태연못, 금천토기, 일성토기, 옹기골도예, 가야신라토기 등으로 구성되어 있는 마을입니다.<br><br>



			
			위치: 울산광역시 울주군 온양읍 외고산3길 36<br>
		</div>
		</div>
		</div>
</body>
