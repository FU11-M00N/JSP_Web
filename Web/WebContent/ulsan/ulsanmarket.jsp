...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.554925,129.323548); // 위치값 위도 경도
	var Y_point			= 35.554925;		// Y 좌표
	var X_point			= 129.323548;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "울산 중앙시장";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>울산 중앙시장</h2>'+
	'<p>울산광역시 중구 옥교동 125-2</p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" style="font-weight:bold"><a href=".\..\ulsan\ulsanjunggulist.jsp" class="aaa">중구</a></th>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">울산 중앙시장</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\울산중앙시장.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			테마가있는 시장골목<br><br>

			울산의 전통이 담긴 시장으로 시장길 골목골목마다 다양한 테마로드를 만들어 조형물들을 설치해 <br>
			색다른 느낌을 주는 시장이다.전통적 요소보다 현대적으로 깔끔하게 정리되어 쇼핑하기에도 편리합니다.<br>
			울산광역시 중앙동쪽에 위치한 중앙시장은 골목골목 사람사는 이야기가 담겨있는 전통과 추억이 있는 <br>
			시장으로 옛모습을 많이 갖추고있지만 좀더 쾌적하고 편리한 쇼핑을 위해 많이 개선된 모습을 하고 있는 곳입니다<br><br>


			
			위치: 울산광역시 중구 옥교동 125-2<br>
		</div>
		</div>
		</div>
</body>
