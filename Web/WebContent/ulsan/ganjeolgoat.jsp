...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.359838,129.355285); // 위치값 위도 경도
	var Y_point			= 35.359838;		// Y 좌표
	var X_point			= 129.355285;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "간절곶";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">간절곶</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\간절곶.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			MBC 드라마 '메이퀸'의 촬영 배경이 된 장소<br><br>

			간절곶은 대한민국에서 해가 가장 먼저 뜨는 곳으로, 새 천년 밀레니엄 첫 해돋이로 유명한 곳입니다. <br>
			매년 새해맞이 축제가 진행되며, 새 천년 기념비와 조각공원 등이 조성되어 있어 많은 사람들의 발길이 끊이질 않고 있습니다. <br>
			정동진보다 5분, 호미곶보다는 1분 먼저 해가 뜨는 곳으로 동해안에서도 가장 먼저 해가 뜨는 곳으로 유명한 곳입니다.<br><br>
