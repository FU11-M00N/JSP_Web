...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(34.800950,128.037800); // 위치값 위도 경도
	var Y_point			= 34.800950;		// Y 좌표
	var X_point			= 128.037800;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "독일마을";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>독일마을</h2>'+
	'<p>경상남도 남해군 삼동면 물건리 1074-2</p>' +
	...
	<div>
		...
		<tbody>
		  <tr>
		    ...
		    <td class="bottom2"style="font-weight:bold"><a href=".\..\gyeongnam\namhaelist.jsp" class="aaa">남해군</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">독일마을</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\독일마을.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			드라마 '환상의 커플'의 철수네 집이 있는 곳<br><br>

			경상남도 남해군에 위치해있는 남해 독일마을은 1960년도에 가난을 극복하기 위해 독일로 떠나야했던 파독광부와 간호사들이 <br>
			은퇴 후 귀국하여 살고 있는 마을입니다. 독일의 문화와 한국 전통문화예술촌이 있어서 많은 관광객들의 발길이 끊이질 않는 <br>
			남해의 명소 중 하나인 곳으로, 2001년 남해군에서 3만여 평의 부지를 마련해 분양하였고, <br>
			독일 교포들이 독일에서 재료를 수입하여 독일식 전통 주택으로 조성하였습니다.<br><br>



			위치: 경상남도 남해군 삼동면 물건리 1074-2<br>
		</div>
		</div>
		</div>
</body>
