...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.017341,128.720979); // 위치값 위도 경도
	var Y_point			= 35.017341;		// Y 좌표
	var X_point			= 128.720979;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "거가대교";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>거가대교</h2>'+
	'<p>경상남도 거제시 장목면 유호리</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">거가대교</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\거가대교.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			국내 최초의 해저터널 거가대교 야경<br><br>

			경상남도 거제시 장목면에 위치해있는 거가대교는 거제도의 바다 풍경을 한눈에 볼 수 있는 낮 보다 밤에 더욱더 화려한 자태를 뽐내고 있습니다. <br>
			거가대교는 거제와 부산을 잇는 다리로, 국내 최초 해저터널로 유명한 다리입니다.거가대교의 개통으로 부산에서 거제까지의 통행거리와 <br>
			시간이 단축되어 많은 물류비용이 크게 절감되었고, 부산, 통영, 거제, 남해, 여수, 완도, 목포 등을 연결하는 남해 관광의 인프라를 <br>
			구축시킬 수 있을 것으로 기대되고 있습니다.<br><br>
			


			
			위치: 경상남도 거제시 장목면 유호리<br>
		</div>
		</div>
		</div>
</body>
