...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">독일마을</font>
			</div>
			<div class="admin4">
				<font class="board2">미국마을</font>
			</div>
			<div class="slideshow">
					<a href="germanytown.jsp" class="aaa"><img src=".\..\img\독일마을.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="usatown.jsp" class="aaa"><img src=".\..\img\미국마을.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>