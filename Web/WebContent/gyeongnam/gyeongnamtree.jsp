...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.159813,128.294234); // 위치값 위도 경도
	var Y_point			= 35.159813;		// Y 좌표
	var X_point			= 128.294234;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "경상남도 수목원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>경상남도 수목원</h2>'+
	'<p>경상남도 진주시 이반성면 대천리 482-1</p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" style="font-weight:bold"><a href=".\..\gyeongnam\jinjulist.jsp" class="aaa">진주시</a></th>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">경상남도 수목원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\경상남도수목원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			울긋불긋 단풍이 아름다운 수목원!<br><br>

			경상남도 진주시에 위치한 도립 수목원으로 다양한 종의 수목들이 아름답게 조성되어 있어 많은 사람들이 찾는 명소입니다. <br>
			국내외 식물 3,100여 종을 수집하여 보존하고 있으며 다양한 테마시설은 물론 가족단위 체험시설과 경관 숲,물 순환시설, 대나무숲 <br>
			관찰원 등을 조성하여 더욱 풍성한 즐길 거리가 있는 곳이기도 합니다.<br><br>
