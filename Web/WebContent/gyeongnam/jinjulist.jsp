...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">진주성</font>
			</div>
			<div class="admin4">
				<font class="board2">경상남도 수목원</font>
			</div>
			<div class="slideshow">
					<a href="jinjutower.jsp" class="aaa"><img src=".\..\img\진주성.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="gyeongnamtree.jsp" class="aaa"><img src=".\..\img\경상남도수목원.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>