...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">원동 매화축제</font>
			</div>
			<div class="admin4">
				<font class="board2">춘추공원</font>
			</div>
			<div class="slideshow">
					<a href="wondong.jsp" class="aaa"><img src=".\..\img\원동매화축제.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="chunchupark.jsp" class="aaa"><img src=".\..\img\춘추공원.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>