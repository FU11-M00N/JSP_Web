...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.445113,127.149537); // 위치값 위도 경도
	var Y_point			= 37.445113;		// Y 좌표
	var X_point			= 127.149537;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "미누 현대미술관";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>미누 현대미술관</h2>'+
	'<p>성남시 수정구 공원로 360 두산아파트</p>' +
	...
	<div>
		...
		<thead>
		  <tr>
		    ...
		    <th class="top2" style="font-weight:bold"><a href=".\..\gyeonggi\sungnamlist.jsp" class="aaa">성남</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">미누 현대미술관</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\미누현대미술관.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			명화를 디지털 작품으로 만나보자 <br>
			세계적인 명화와 현존하는 미술작품들을 현대의 IT 기술로 디지털화 재탄생시켜 누구나 쉽게 감상할 수 있도록 개관한 미디어아트 전용 미술관입니다 <br>
			한국 최초의 미디어 아트 미술관인 미누현대미술관은 세계적인 명화를 디지털 작품으로 감상할 수 있는 곳으로 현대미술에 대해 알리고 창의력 향상과 힐링의 공간으로 자리매김하고자 노력하고 있습니다 <br><br>
			
			위치: 경기 성남시 수정구 공원로 360 두산아파트
		</div>
		</div>	
</body>
</html>