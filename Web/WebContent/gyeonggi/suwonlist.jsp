...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">서장대</font>
			</div>
			<div class="admin4">
				<font class="board2">장안문</font>
			</div>
			<div class="slideshow">
					<a href="seojangdae.jsp" class="aaa"><img src=".\..\img\서장대.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="jangan.jsp" class="aaa"><img src=".\..\img\장안문,화서문.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>