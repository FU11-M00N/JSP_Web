...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.288836,127.014207); // 위치값 위도 경도
	var Y_point			= 37.288836;		// Y 좌표
	var X_point			= 127.014207;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "장안문";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">장안문</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="board2"><br>
			아름다움이 살아있는 장안문, 화서문 <br>
			어둠으로 둘러싸인 화성에 조명이 더해져 절경을 이루는 장안문과 화서문은 도심 한가운데 위치해있어서 많은 관광객들이 야경 명소로 찾는 곳입니다 <br>
			장안문은 1794년 2월 28일에 공사를 시작하여 9월 5일 마쳤는데요, 장안이라는 말은 수도를 상징하는 말이자 백성들의 안녕을 의미합니다 <br><br>
