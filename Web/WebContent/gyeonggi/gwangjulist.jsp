...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">국청사</font>
			</div>
			<div class="admin4">
				<font class="board2">남한산성 서문</font>
			</div>
			<div class="slideshow">
					<a href="gukcheongsa.jsp" class="aaa"><img src=".\..\img\국청사.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="namhansanseong.jsp" class="aaa"><img src=".\..\img\남한산성 서문.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>