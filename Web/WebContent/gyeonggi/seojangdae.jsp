...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.280702,127.010220); // 위치값 위도 경도
	var Y_point			= 37.280702;		// Y 좌표
	var X_point			= 127.010220;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "서장대";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>서장대</h2>'+
	'<p>수원시 팔달구 남창동 55-23</p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" style="font-weight:bold"><a href=".\..\gyeonggi\suwonlist.jsp" class="aaa">수원</a></th>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">서장대</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\서장대.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			수원의 대표 문화재 '서장대'의 야경 <br>
			경기도 수원시 팔달산 정상에 위치해있는 조선시대의 장대 서장대는 수원을 대표하는 문화재이며, 야경이 멋진 곳으로 유명합니다 <br>
			수원화성 내에는 야경이 아름다워 유명해진 곳 '서장대'가 있습니다.'장대'란 성곽 전체를 한눈에 바라보면서 화성에 주둔한 군사를 지휘하는 지휘소 역할을 하는 곳입니다 <br><br>
			
			위치: 경기 수원시 팔달구 남창동 55-23
		</div>
		</div>	
</body>
</html>