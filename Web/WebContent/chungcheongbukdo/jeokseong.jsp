...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.944994,128.321685); // 위치값 위도 경도
	var Y_point			= 36.944994;		// Y 좌표
	var X_point			= 128.321685;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "단양 신라 적성비";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>단양 신라 적성비</h2>'+
	'<p>단양군 단성면 하방리 산3-1</p>' +
	...
	<div>
		...
		<tbody>
		  <tr>
		    ...
		    <td class="bottom2" style="font-weight:bold"><a href=".\..\chungcheongbukdo\danyanglist.jsp" class="aaa">단양</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">단양 신라 적성비</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\단양신라적성비.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			신라 진흥왕 때 세워진 비석 <br>
			신라 진흥왕 때 세워진 신라 적성비는 국보 제198호로 지정되어 있으며, 기존의 문헌자료에 보이지 않는 내용이 많이 담겨있어 신라사를 이해하는데 큰 도움을 주고 있습니다 <br>
			단양 신라적성비는 신라 진흥왕 때 충청북도 단양군 단성면 하방리의 적성에 세워진 비석으로 1979년 5월 22일 국보 제198호로 지정되었습니다 <br><br>

			위치: 충북 단양군 단성면 하방리 산3-1
		</div>
		</div>
		</div>
</body>
