...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">대한 불교수도원</font>
			</div>
			<div class="admin4">
				<font class="board2">대머리공원</font>
			</div>
			<div class="slideshow">
					<a href="buddhism.jsp" class="aaa"><img src=".\..\img\대한불교수도원.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="baldhead.jsp" class="aaa"><img src=".\..\img\대머리공원.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>