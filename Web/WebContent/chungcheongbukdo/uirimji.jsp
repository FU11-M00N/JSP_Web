...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.173217,128.210579); // 위치값 위도 경도
	var Y_point			= 37.173217;		// Y 좌표
	var X_point			= 128.210579;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "의림지";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">의림지</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\의림지.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			호수와 폭포의 자연경관 <br>
			호서지방이라고도 불리는 호수가 바로 의림지이다.넓은 호수와 함께 정자,공원장,오리배,분수대,카페등 시민들의 휴식과 건강을 위한 편의시설과 자연조경이 갖추고 있는 <br>
			이곳은 폭포도 함께 있어 관광객들의발길이 잦다.제천의림지는 삼한시대에 만들어진 인공저수지로 국가명승 제20호로 지정이 되어있습니다. 제천의 지역명도 의림지의 제방에서 유래되었다고 합니다 <br><br>
