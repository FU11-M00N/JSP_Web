...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.605694,127.502369); // 위치값 위도 경도
	var Y_point			= 36.605694;		// Y 좌표
	var X_point			= 127.502369;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "대머리공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" style="font-weight:bold"><a href=".\..\chungcheongbukdo\cheongjulist.jsp" class="aaa">청주</a></th>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">대머리공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\대머리공원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			청주 한씨의 흔적이 남아 있는 공원 <br>
			옛날 지방의 호족이었던 청주 한씨의 흔적이 남아있는 공원으로 청주시민들의 휴식처가 돼주는 공원입니다. 용암동 일대가 대머리 지역으로 실제 대머리마을도 있다고 하는데요 <br>
			이 '대머리'라는 이름은 우리가 보통 생각하는 뜻이 아닌 청주 한씨의 본거지였던 큰 마을의 이름인 대촌이 자연스럽게 변한 것이라고 합니다. 한번 들으면 절대 잊을 수 없는 이름이네요 <br><br>
