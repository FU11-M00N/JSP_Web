...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.944174,128.322312); // 위치값 위도 경도
	var Y_point			= 36.944174;		// Y 좌표
	var X_point			= 128.322312;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "적성산성";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">적성산성</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\적성산성.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			역사적으로 매우 의미있는 산성 <br>
			적성이라 불리는 적성산성은 사적 제265호로 지정되어 있는 신라 진흥왕 545~551년경에 축조된 산성으로 국보 신라적성비와 함께 있어 역사적으로 큰 의미가 담겨있습니다 <br>
			단양 적성산성은 적성이라고도 불리며 사적 제265호로 지정되어 있고, 신라 진흥왕 545~551년경에 축조된 산성입니다 둘레가 약 923m인데, 현재 성벽 대부분이 무너졌고, <br>
			북동쪽 끝에 높이 3m가량의 성벽이 비교적 잘 남아있습니다 <br><br>
