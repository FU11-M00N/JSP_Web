...
$(function(){
    ...
    setInterval(function(){
      $('.slideshow3 :first-child').fadeOut(1000)
         .next('img').fadeIn(1000)
...
$(function(){
    ...
    setInterval(function(){
      $('.slideshow4 :first-child').fadeOut(1000)
         .next('img').fadeIn(1000)
...
$(function(){
    ...
    setInterval(function(){
      $('.slideshow5 :first-child').fadeOut(1000)
         .next('img').fadeIn(1000)
         .end().appendTo('.slideshow5');}, 
      3000);
});
// 대전
$(function(){
    ...
    setInterval(function(){
      $('.slideshow6 :first-child').fadeOut(1000)
         .next('img').fadeIn(1000)
         .end().appendTo('.slideshow6');}, 
      3000);
});
// 울산
$(function(){
    ...
    setInterval(function(){
      $('.slideshow7 :first-child').fadeOut(1000)
         .next('img').fadeIn(1000)
         .end().appendTo('.slideshow7');}, 
      3000);
});
// 경기도
$(function(){
    ...
    setInterval(function(){
      $('.slideshow8 :first-child').fadeOut(1000)
         .next('img').fadeIn(1000)
         .end().appendTo('.slideshow8');}, 
      3000);
});
// 강원도
$(function(){
    $('.slideshow9 img:gt(0)').hide();
    setInterval(function(){
      $('.slideshow9 :first-child').fadeOut(1000)
         .next('img').fadeIn(1000)
         .end().appendTo('.slideshow9');}, 
      3000);
});
// 충청북도
$(function(){
    $('.slideshow10 img:gt(0)').hide();
    setInterval(function(){
      $('.slideshow10 :first-child').fadeOut(1000)
         .next('img').fadeIn(1000)
         .end().appendTo('.slideshow10');}, 
      3000);
});
// 충청남도
$(function(){
    $('.slideshow11 img:gt(0)').hide();
    setInterval(function(){
      $('.slideshow11 :first-child').fadeOut(1000)
         .next('img').fadeIn(1000)
         .end().appendTo('.slideshow11');}, 
      3000);
});
// 전라북도
$(function(){
    $('.slideshow12 img:gt(0)').hide();
    setInterval(function(){
      $('.slideshow12 :first-child').fadeOut(1000)
         .next('img').fadeIn(1000)
         .end().appendTo('.slideshow12');}, 
      3000);
});
// 전라남도
$(function(){
    $('.slideshow13 img:gt(0)').hide();
    setInterval(function(){
      $('.slideshow13 :first-child').fadeOut(1000)
         .next('img').fadeIn(1000)
         .end().appendTo('.slideshow13');}, 
      3000);
});
// 경상북도
$(function(){
    $('.slideshow14 img:gt(0)').hide();
    setInterval(function(){
      $('.slideshow14 :first-child').fadeOut(1000)
         .next('img').fadeIn(1000)
         .end().appendTo('.slideshow14');}, 
      3000);
});
// 경상남도
$(function(){
    $('.slideshow15 img:gt(0)').hide();
    setInterval(function(){
      $('.slideshow15 :first-child').fadeOut(1000)
         .next('img').fadeIn(1000)
         .end().appendTo('.slideshow15');}, 
      3000);
});
// 제주도
$(function(){
    $('.slideshow16 img:gt(0)').hide();
    setInterval(function(){
      $('.slideshow16 :first-child').fadeOut(1000)
         .next('img').fadeIn(1000)
         .end().appendTo('.slideshow16');}, 
      3000);
});
// 세종
$(function(){
    $('.slideshow17 img:gt(0)').hide();
    setInterval(function(){
      $('.slideshow17 :first-child').fadeOut(1000)
         .next('img').fadeIn(1000)
         .end().appendTo('.slideshow17');}, 
      3000);
});
</script>
<style type="text/css">
...
<body>
	<script src="jquery-sakura.js"></script>
	<script>
	...
	<div>
		...
		<div class="full">
		<svg viewBox="-100 150 750 650" xmlns="http://www.w3.org/2000/svg" xmlns:amcharts="http://amcharts.com/ammap" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
		<defs>
		...
		<div id="seoul" align="center">
			...
			<tr>
				<td class="slideshow">
				 <img src=".\img\서울특별시1.jpg" width="435" height="235" />
				 <img src=".\img\서울특별시2.jpg" width="435" height="235" />
				 <img src=".\img\서울특별시3.jpg" width="435" height="235" />
				 </td>
			</tr>
			<tr>
				<td class="board2">
			 		<br><br>
			 		과거와 현재가 공존하며 하루가 다르게 변하는 서울 <br><br>
			 		도시 한복판에서 600년의 역사를 그대로 안고 있는 아름다운 고궁<br><br>
			 		예술과 문화의 크고 작은 동네들을 둘러볼 수 있는 서울<br><br>
			 		서울은 도시 여행에 최적화된 장소다
		 		</td>
			</tr>
			</table>
		</div>	
		<div id="busan" align="center">
			<table onmouseout="javascript:hideLayer('busan');" onmouseover="javascript:showLayer('busan');">
			<tr>
				<td class="font">부산</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="slideshow2">
				 <img src=".\img\부산광역시 해운대.jpg" width="435" height="235" />
				 <img src=".\img\부산광역시 감천문화마을.jpg" width="435" height="235" />
				 <img src=".\img\부산광역시 국제시장.jpg" width="435" height="235" />
				</td>
			</tr>
			<tr>
				<td class="board2">
			 		<br><br>
			 		우리나라 제2의 수도 부산광역시. 부산의 대표 관광지<br><br>
					밤에는 마린시티의 야경이 더해져 더욱 화려한 해변<br><br> 
					사진 찍기에 좋은 감천문화마을, 매해 가을에 열리는 국제영화제<br><br>
					전통시장 투어가 있을 만큼 먹거리가 가득한 부산
		 		</td>
			</tr>
			</table>
		</div>
		<div id="daegu" align="center">
			<table onmouseout="javascript:hideLayer('daegu');" onmouseover="javascript:showLayer('daegu');">
			<tr>
				<td class="font">대구</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="slideshow3">
				 <img src=".\img\대구 수목원.jpg" width="435" height="235" />
				 <img src=".\img\대구 이월드.jpg" width="435" height="235" />
				 <img src=".\img\대구 팔공산 케이블카.jpg" width="435" height="235" />
				</td>
			</tr>
			<tr>
				<td class="board2">
			 		<br><br>
			 		우리나라에서 가장 더운 지역 대구 <br><br>
					매년 여름 열리는 치맥 페스티벌과 함께라면 더위도 문제없다<br><br>
					가족과 함께 나들이 하기 좋은 놀이동산 이월드<br><br>
					산책하기 좋은 두류공원, 음악분수쇼로 유명한 수성못<br><br>
					우리나라 3대 시장인 서문시장 야시장도 대구의 대표 핫플레이스
		 		</td>
			</tr>
			</table>
		</div>
		<div id="incheon" align="center">
			<table onmouseout="javascript:hideLayer('incheon');" onmouseover="javascript:showLayer('incheon');">
			<tr>
				<td class="font">인천</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="slideshow4">
				 <img src=".\img\인천광역시 월미도.jpg" width="435" height="235" />
				 <img src=".\img\인천 센트럴파크.jpg" width="435" height="235" />
				 <img src=".\img\인천광역시 차이나타운.jpg" width="435" height="235" />
				</td>
			</tr>
			<tr>
				<td class="board2">
			 		<br><br>
			 		살짝 비릿한 바다향이 매력적인 인천광역시 <br><br>
					내륙과 해안 지역의 관광이 두루 발달한 도시.<br><br>
					을왕리 해수욕장을 비롯해 문화의 거리가 갖춰진 월미도<br><br> 
					한국 속 작은 중국이라 불리는 차이나타운 등<br><br>
					인천 각처에 오랜 역사 유물들이 산재해 있어<br><br>
					역사를 테마로 여행 코스를 잡아보는 것도 좋다
		 		</td>
			</tr>
			</table>
		</div>
		<div id="gwangju" align="center">
			<table onmouseout="javascript:hideLayer('gwangju');" onmouseover="javascript:showLayer('gwangju');">
			<tr>
				<td class="font">광주</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="slideshow5">
				 <img src=".\img\광주 펭귄마을.jpg" width="435" height="235" />
				 <img src=".\img\광주 송산유원지.JPG" width="435" height="235" />
				 <img src=".\img\광주 사직공원.JPG" width="435" height="235" />
				</td>
			</tr>
			<tr>
				<td class="board2">
			 		<br><br>
			 		문화예술의 중심지라 불리는 광주광역시<br><br>
					예향의 본고장답게 '맛'과 '멋'이 조화를 이루며<br><br> 
					남도의 문화를 이끌어온 도시 광주, 광주비엔날레를 중심으로 <br><br>
					광주김치대축제, 광주국제영화제 등의 5대 축제와<br><br>
					문화예술시장으로 재탄생한 대인시장의 야시장 밤여행
		 		</td>
			</tr>
			</table>
		</div>
		<div id="daejeon" align="center">
			<table onmouseout="javascript:hideLayer('daejeon');" onmouseover="javascript:showLayer('daejeon');">
			<tr>
				<td class="font">대전</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="slideshow6">
				 <img src=".\img\대전 우암사적공원.JPG" width="435" height="235" />
				 <img src=".\img\대전 장태산 자연휴양림.jpg" width="435" height="235" />
				 <img src=".\img\대전시립미술관.jpg" width="435" height="235" />
				</td>
			</tr>
			<tr>
				<td class="board2">
			 		<br><br>
			 		다양한 테마 여행이 가능한 대전광역시 <br><br>
					자연을 느끼며 맨발로 걸을 수 있는 계족산 황톳길<br><br>
					대전 근현대 전시관과 남간정사 등 역사 문화공간 <br><br>
					동물원이 있는 오월드와 가볍게 산책하기 좋은 유림공원<br><br>
					주말 가족 나들이 코스로 손색이 없다
		 		</td>
			</tr>
			</table>
		</div>
		<div id="ulsan" align="center">
			<table onmouseout="javascript:hideLayer('ulsan');" onmouseover="javascript:showLayer('ulsan');">
			<tr>
				<td class="font">울산</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="slideshow7">
				 <img src=".\img\울산 태화강 국가정원.jpg" width="435" height="235" />
				 <img src=".\img\울산 간절곶.jpg" width="435" height="235" />
				 <img src=".\img\울산 반구대암각화.jpg" width="435" height="235" />
				</td>
			</tr>
			<tr>
				<td class="board2">
			 		<br><br>
			 		5월 태화강 봄꽃 대향연과 고래축제가 있는 울산시<br><br>
					일출이 가장 빨리 시작되는 간절곶 <br><br>
					해안을 따라 산책하기 좋은 대왕암 공원<br><br>
					아름다운 생태공원으로 재탄생한 태화강을 따라 <br><br>
					대나무가 시원하게 뻗어있는 십리대숲길 산책
		 		</td>
			</tr>
			</table>
		</div>
		<div id="gyeonggi" align="center">
			<table onmouseout="javascript:hideLayer('gyeonggi');" onmouseover="javascript:showLayer('gyeonggi');">
			<tr>
				<td class="font">경기도</td>
			</tr>
			<tr>
				<td><br></td>
			</tr>
			<tr>
				<td class="slideshow8">
				 <img src=".\img\경기도 쁘띠프랑스.jpg" width="435" height="235" />
				 <img src=".\img\경기도 남이섬.jpg" width="435" height="235" />
				 <img src=".\img\경기도 헤이리예술마을.jpg" width="435" height="235" />
				</td>
			</tr>
			<tr>
				<td class="board2">
			 		<br><br>
			 		문화· 예술· 레저 등 모든 걸 아우르는 경기도 <br><br>
					서울 근교에 위치해 접근성이 좋고 다양한 문화생활이 있어<br><br>
					주말을 이용한 나들이에 제격<br><br>
					파주와 여주는 문화 복합 도시로 풍부한 볼거리를 제공하며<br><br>
					양평이나 가평은 자연과 함께 여유로운 하루를 보낼수있다
		 		</td>
			</tr>
			</table>
		</div>
		<div id="gangwon" align="center">
			<table onmouseout="javascript:hideLayer('gangwon');" onmouseover="javascript:showLayer('gangwon');">
			<tr>
				<td class="font">강원도</td>
			</tr>
			<tr>
				<td><br></td>
			</tr>
			<tr>
				<td class="slideshow9">
				 <img src=".\img\강원도 경포해변.jpg" width="435" height="235" />
				 <img src=".\img\강원도 속삭이는 자작나무숲.jpg" width="435" height="235" />
				 <img src=".\img\강원도 오죽헌.jpg" width="435" height="235" />
				</td>
			</tr>
			<tr>
				<td class="board2">
			 		<br><br>
			 		빼어난 자연경관으로 유명한 강원도 <br><br>
					계절마다 자연과 함께하는 각종 레저스포츠<br><br>
					연말연시가 되면 해가 가장 먼저 떠오르는 정동진<br><br>
					데이트 코스로 좋은 메타세콰이어 길이 있는 남이섬 <br><br>
					호수를 둘러싼 자전거 길을 따라 춘천을 둘러보는 여행
		 		</td>
			</tr>
			</table>
		</div>
		<div id="northchungcheong" align="center">
			<table onmouseout="javascript:hideLayer('northchungcheong');" onmouseover="javascript:showLayer('northchungcheong');">
			<tr>
				<td class="font">충청북도</td>
			</tr>
			<tr>
				<td><br></td>
			</tr>
			<tr>
				<td class="slideshow10">
				 <img src=".\img\충북 만천하 스카이워크.jpg" width="435" height="235" />
				 <img src=".\img\충청북도 법주사.jpg" width="435" height="235" />
				 <img src=".\img\충청북도 수암골.jpg" width="435" height="235" />
				</td>
			</tr>
			<tr>
				<td class="board2">
			 		<br><br>
			 		자연을 만끽할 수 있는 충청북도<br><br>
					충북 대표 여행지 단양,충주호에서의 패러글라이딩<br><br>  
					해 질 녘 풍경이 아름다운 도담삼봉<br><br>
					가장 오래된 저수지 의림지가 있는 출사지로 알려진 제천<br><br>
					전국 최고의 둘레길이 있는 괴산군의 산막이 옛길 산책
		 		</td>
			</tr>
			</table>
		</div>
		<div id="southchungcheong" align="center">
			<table onmouseout="javascript:hideLayer('southchungcheong');" onmouseover="javascript:showLayer('southchungcheong');">
			<tr>
				<td class="font">충청남도</td>
			</tr>
			<tr>
				<td><br></td>
			</tr>
			<tr>
				<td class="slideshow11">
				 <img src=".\img\충청남도 대천해수욕장.jpg" width="435" height="235" />
				 <img src=".\img\충청남도 공산성.jpg" width="435" height="235" />
				 <img src=".\img\충청남도 아산 지중해마을.jpg" width="435" height="235" />
				</td>
			</tr>
			<tr>
				<td class="board2">
			 		<br><br>
			 		백제의 발자취를 고스란히 안고 있는 충청남도<br><br>
					백제의 수도였던 공주와 부여의 역사적인 사찰과 문화재<br><br>
					당진 왜목마을에서의 서해 일출<br><br>
					세계 각지에서 온 여행객들과 온몸에 진흙을 묻히며<br><br> 
					마음껏 놀 수 있는 보령에서의 머드축제
		 		</td>
			</tr>
			</table>
		</div>
		<div id="northjeolla" align="center">
			<table onmouseout="javascript:hideLayer('northjeolla');" onmouseover="javascript:showLayer('northjeolla');">
			<tr>
				<td class="font">전라북도</td>
			</tr>
			<tr>
				<td><br></td>
			</tr>
			<tr>
				<td class="slideshow12">
				 <img src=".\img\전주 한옥마을.jpg" width="435" height="235" />
				 <img src=".\img\전라북도 경암동 철길마을.jpg" width="435" height="235" />
				 <img src=".\img\전라북도 광한루원.jpg" width="435" height="235" />
				</td>
			</tr>
			<tr>
				<td class="board2">
			 		<br><br>
			 		한국 문화의 원형이 가장 잘 보존되어 있는 전라북도<br><br>
					전북의 대표관광지, 도심 중심에 한옥마을을 품고 있는 전주<br><br>
					춘향과 몽룡의 사랑이 시작된 광한루가 있는 남원<br><br>
					일제 시대의 근대 건축 기행이 가능한 군산과 익산 여행
		 		</td>
			</tr>
			</table>
		</div>
		<div id="southjeolla" align="center">
			<table onmouseout="javascript:hideLayer('southjeolla');" onmouseover="javascript:showLayer('southjeolla');">
			<tr>
				<td class="font">전라남도</td>
			</tr>
			<tr>
				<td><br></td>
			</tr>
			<tr>
				<td class="slideshow13">
				 <img src=".\img\전라남도 순천만 습지.jpg" width="435" height="235" />
				 <img src=".\img\전라남도 섬진강 기차마을.jpg" width="435" height="235" />
				 <img src=".\img\전라남도 죽녹원.jpg" width="435" height="235" />
				</td>
			</tr>
			<tr>
				<td class="board2">
			 		<br><br>
			 		기개 높은 대나무숲을 가진 담양, 여수의 밤바다<br><br>
					각 지역의 전통과 고유색이 잘 살아있는 전라남도<br><br>
					순천만의 지평선 끝까지 황금빛으로 물든 갈대밭<br><br>
					해상관광부터 산악관광까지 두루 갖춘 전라남도

		 		</td>
			</tr>
			</table>
		</div>
		<div id="northgyeongsang" align="center">
			<table onmouseout="javascript:hideLayer('northgyeongsang');" onmouseover="javascript:showLayer('northgyeongsang');">
			<tr>
				<td class="font">경상북도</td>
			</tr>
			<tr>
				<td><br></td>
			</tr>
			<tr>
				<td class="slideshow14">
				 <img src=".\img\경상북도 동궁과 월지.jpg" width="435" height="235" />
				 <img src=".\img\경상북도 안동 하회마을.jpg" width="435" height="235" />
				 <img src=".\img\경상북도 첨성대.jpg" width="435" height="235" />
				</td>
			</tr>
			<tr>
				<td class="board2">
			 		<br><br>
			 		민족문화 창달의 대표 경상북도<br><br>
					신라 천년 고도의 숨결을 간직한 경주<br><br>
					유네스코 세계문화유산에 등재된 안동하회마을<br><br>
					기상이변으로 방문 자체가 쉽지 않은 울릉도와 독도<br><br>
					우리나라의 오랜 전통과 역사의 때가 묻은 경상북도
		 		</td>
			</tr>
			</table>
		</div>
		<div id="southgyeongsang" align="center">
			<table onmouseout="javascript:hideLayer('southgyeongsang');" onmouseover="javascript:showLayer('southgyeongsang');">
			<tr>
				<td class="font">경상남도</td>
			</tr>
			<tr>
				<td><br></td>
			</tr>
			<tr>
				<td class="slideshow15">
				 <img src=".\img\경상남도 고성 상족암군립공원.jpg" width="435" height="235" />
				 <img src=".\img\경상남도 남해 독일마을.jpg" width="435" height="235" />
				 <img src=".\img\경상남도 진주성.jpg" width="435" height="235" />
				</td>
			</tr>
			<tr>
				<td class="board2">
			 		<br><br>
			 		산악과 해상관광을 함께 누릴 수 있는 경상남도<br><br>
					경남의 대표여행지 통영과 남해를 중심으로 위치한 해상공원<br><br>
					봄에는 하얀 눈꽃이 흩날리는 하동벚꽃축제와 순매원 매화축제<br><br>
					겨울에는 거제도를 빨갛게 물들이는 동백축제가 열린다

		 		</td>
			</tr>
			</table>
		</div>
		<div id="jeju" align="center">
			<table onmouseout="javascript:hideLayer('jeju');" onmouseover="javascript:showLayer('jeju');">
			<tr>
				<td class="font">제주도</td>
			</tr>
			<tr>
				<td><br></td>
			</tr>
			<tr>
				<td class="slideshow16">
				 <img src=".\img\제주 협재해수욕장.jpg" width="435" height="235" />
				 <img src=".\img\제주 천지연폭포.JPG" width="435" height="235" />
				 <img src=".\img\제주 성산일출봉.jpg" width="435" height="235" />
				</td>
			</tr>
			<tr>
				<td class="board2">
			 		<br><br>
			 		섬 전체가 하나의 거대한 관광자원인 제주도 <br><br>
					대표 여행지인 에메랄드빛 물빛이 인상적인 협재 해수욕장<br><br>
					파도가 넘보는 주상절리와 바다 위 산책로인 용머리 해안<br><br>
					꾸준한 사랑을 받는 드라마 촬영지로 알려진 섭지코스<br><br>
					제주도를 대표하는 음식인 한라봉과 흑돼지, 은갈치
		 		</td>
			</tr>
			</table>
		</div>
		<div id="sejong" align="center">
			<table onmouseout="javascript:hideLayer('sejong');" onmouseover="javascript:showLayer('sejong');">
			<tr>
				<td class="font">세종</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="slideshow17">
				 <img src=".\img\세종 호수공원.jpg" width="435" height="235" />
				 <img src=".\img\세종 뒤웅박고을.jpg" width="435" height="235" />
				 <img src=".\img\세종 금강자연휴양림.jpg" width="435" height="235" />
				</td>
			</tr>
			<tr>
				<td class="board2">
			 		<br><br>
			 		주말 여행지로 좋은 세종특별자치시 <br><br>
					다양한 식물을 보유하여 교육으로 좋은 금강수목원 <br><br>
					딸기체험이 가능한 농장에서의 주말 가족 나들이 <br><br>
					여유로운 산책과 데이트 코스로 좋은 세종 호수공원
		 		</td>
			</tr>
			</table>
		</div>
