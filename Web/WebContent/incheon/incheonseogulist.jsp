...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">국립 생물자원관</font>
			</div>
			<div class="admin4">
				<font class="board2">신석체육공원</font>
			</div>
			<div class="slideshow">
					<a href="intbiomuseum.jsp" class="aaa"><img src=".\..\img\국립생물자원관.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="sinseokpark.jsp" class="aaa"><img src=".\..\img\신석체육공원.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>