...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.392398,126.639198); // 위치값 위도 경도
	var Y_point			= 37.392398;		// Y 좌표
	var X_point			= 126.639198;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "송도 센트럴파크";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>송도 센트럴파크</h2>'+
	'<p>인천광역시 연수구 송도2동 테크노파크로 196</p>' +
...
<body>
	...
	<div>
		...
		<tbody>
		  <tr>
		    <td class="bottom" style="font-weight:bold"><a href=".\..\incheon\incheonysgulist.jsp" class="aaa">연수구</a></td>
		    <td class="bottom2"><a href=".\..\incheon\incheonseogulist.jsp" class="aaa">서구</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">송도 센트럴파크</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\송도센트럴파크.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			멋진 야경을 자랑하는 곳<br><br>

			우리나라에서 최대 면적을 자랑하고 있는 해수공원인 송도의 센트럴파크는 어린이들을 위한 다양한 학습과 문화체험이 가능한 곳이며,<br>
			뿐만 아니라 송도 센트럴파크의 야경은 관광객들의 눈을 사로잡는 매력이 있는 곳입니다. <br>
			뉴욕 센트럴파크를 모티브로 만들어진 만큼 이국적인 분위기를 자랑하는 송도 센트럴파크공원은 바닷물을 끌어들여 조성한 해수로가 있는 
			우리나라 최초의 해수공원입니다.<br><br>
			
			위치: 인천광역시 연수구 송도2동 테크노파크로 196<br>
