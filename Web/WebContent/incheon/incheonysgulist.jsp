...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">송도센트럴파크</font>
			</div>
			<div class="admin4">
				<font class="board2">송도한옥마을</font>
			</div>
			<div class="slideshow">
					<a href="centralpark.jsp" class="aaa"><img src=".\..\img\송도센트럴파크.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="songdohanok.jsp" class="aaa"><img src=".\..\img\송도한옥마을.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>