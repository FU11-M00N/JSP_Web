...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">차이나타운</font>
			</div>
			<div class="admin4">
				<font class="board2">월미도</font>
			</div>
			<div class="slideshow">
					<a href="chinatown.jsp" class="aaa"><img src=".\..\img\차이나타운.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="wolmido.jsp" class="aaa"><img src=".\..\img\월미도.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>