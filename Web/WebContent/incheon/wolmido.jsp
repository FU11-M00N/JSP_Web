...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.475409,126.597800); // 위치값 위도 경도
	var Y_point			= 37.475409;		// Y 좌표
	var X_point			= 126.597800;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "월미도";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>월미도</h2>'+
	'<p>인천광역시 중구 북성동 월미문화로 36</p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" style="font-weight:bold"><a href=".\..\incheon\incheonjunggulist.jsp" class="aaa">중구</a></th>
		    <th class="top2"><a href=".\..\incheon\incheondonggulist.jsp" class="aaa">북구</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		    <td class="bottom" ><a href=".\..\incheon\incheonysgulist.jsp" class="aaa">수성구</a></td>
		    <td class="bottom2"><a href=".\..\incheon\incheonseogulist.jsp" class="aaa">달서구</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">월미도</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\월미도.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			낮보다 밤이 훨씬 아름다운 월미도<br><br>

			인천광역시 중구에 위치해있는 월미도는 원래 섬이었으나 1920년대 초에 돌축대를 쌓아 대륙과 연결하면서<br>
			지금의 월미도로 탄생하였습니다. 특히 월미도는 낮보다 밤이 아름다운 곳으로, 야경 명소로 자리잡고 있습니다. <br>
			볼거리, 즐길 거리, 먹거리 다양한 월미도에서 가족, 친구, 연인과 함께 좋은 추억을 만들어 보세요.<br><br>
			
			위치: 인천광역시 중구 북성동 월미문화로 36<br>
