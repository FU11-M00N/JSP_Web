...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(37.566033,126.638199); // 위치값 위도 경도
	var Y_point			= 37.566033;		// Y 좌표
	var X_point			= 126.638199;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "국립 생물자원관";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>국립 생물자원관</h2>'+
	'<p>인천광역시 서구 경서동 환경로 42</p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" ><a href=".\..\incheon\incheonjunggulist.jsp" class="aaa">중구</a></th>
		    <th class="top2"><a href=".\..\incheon\incheondonggulist.jsp" class="aaa">동구</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		    <td class="bottom" ><a href=".\..\incheon\incheonysgulist.jsp" class="aaa">연수구</a></td>
		    <td class="bottom2"style="font-weight:bold"><a href=".\..\incheon\incheonseogulist.jsp" class="aaa">서구</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">국립 생물자원관</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\국립생물자원관.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			우리나라 최대규모 생물자원 전시관<br><br>

			우리나라 최대 규모를 가진 국립생물자원관은 세계적인 생물자원의 목표와 연구도 전시와 함께 <br>
			이뤄지고 있는 의미 있는 기관으로 다양한 생물들을 전시하고 자연을 재현하여 직접 보고 느낄 수 있는 체험을 제공하는 곳입니다. <br>
			국립생물자원관은 소중한 국가적 자산인 자생생물자원의 총제적인 관리와 생물주권 확립의 기반마련을 위해서 2007년 설립이 된 곳입니다.<br><br>
			
			위치: 인천광역시 서구 경서동 환경로 42<br>
