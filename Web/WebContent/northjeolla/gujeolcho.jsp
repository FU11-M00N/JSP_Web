...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.553408,127.017964); // 위치값 위도 경도
	var Y_point			= 35.553408;		// Y 좌표
	var X_point			= 127.017964;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "구절초 테마공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>구절초 테마공원</h2>'+
	'<p>정읍시 산내면 청정로 926-79</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">구절초 테마공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\구절초테마공원.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			옥정호(玉井湖, 갈담저수지) 상류에 있는 정읍시 산내면 망경대 부근의 야산에 조성한 공원으로, 가을이 되면 소나무가 듬성듬성 심어진 솔숲 전체가 하얀 구절초 천지가 된다 <br>
			2003년 원래 망경대체육공원으로 조성되었다가 2006년부터 구절초를 심기 시작하여 구절초 테마공원으로 변경되었고, 공원에는 구절초식재지 및 산책로를 비롯하여 <br>
			다목적운동장·자생들꽃전시장·쉼터·광장·지압보도·농산물재래장터·펜션·주차장 등의 시설이 갖추어져 있다 <br><br>
			
			위치: 전라북도 정읍시 산내면 청정로 926-79
		</div>
		</div>
</body>
</html>