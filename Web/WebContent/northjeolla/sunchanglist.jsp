...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">강천산 군립공원</font>
			</div>
			<div class="admin4">
				<font class="board2">강천사</font>
			</div>
			<div class="slideshow">
					<a href="gangcheon.jsp" class="aaa"><img src=".\..\img\강천산군립공원.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="gangcheonsa.jsp" class="aaa"><img src=".\..\img\강천사.jpg" width="550" height="250" align="left"/></a>
			</div>
			<table class="admin">
			</table>
			<div class="admin3">
				<font class="board2">전통고추장 민속마을</font>
			</div>
			<div class="slideshow">
					<a href="gochujang.jsp" class="aaa"><img src=".\..\img\전통고추장민속마을.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>