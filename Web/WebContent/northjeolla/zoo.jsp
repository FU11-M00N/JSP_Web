...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.855537,127.144661); // 위치값 위도 경도
	var Y_point			= 35.855537;		// Y 좌표
	var X_point			= 127.144661;		// X 좌표
	var zoomLevel		= 15;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "전주 동물원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">전주 동물원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\전주동물원.jpg" width="500" height="250"/>		     
		</div>
		
		<div class="board2"><br>
			지방동물원 중 가장 오래된 동물원으로 과천 서울대공원 동물원, 용인 에버랜드 동물원에 이어 세 번째 규모이고, 호랑이·사자·곰·하마·기린·들소·큰뿔소·아시아코끼리·낙타·왕비단뱀 등 대형 동물이 많은 편이다 <br>
			2009년 현재 희귀동물인 반달가슴곰·얼룩말·재규어를 포함하여 포유류 47종 231마리, 파충류 3종 6마리, 조류 46종 280마리, 어류 10종 193마리 등 총 106종 710마리의 동물을 사육하고 있다 <br>
			이밖에 동물원 한가운데 있는 넓은 잔디밭을 개방하여 가족단위의 휴식공간을 마련하였고, 청룡열차·바이킹·전자전투기·범퍼카·공중자전거·귀신의집·대관람차·미니패드·회전목마·회전오리 <br>
			회전그네 등의 놀이기구를 갖추고 있다. 개장 시간은 오전 9시부터 오후 7시까지(11~2월은 오후 6시까지)이다.인근에 덕진공원과 축구장·배구장 등 운동시설을 갖춘 체련공원이 있으며 <br>
			주변에 한국소리문화의전당을 비롯하여 조경단·전주	향교·경기전·전동성당·한벽루 등의 관광명소가 있다  <br><br>
			위치: 전북 전주시 덕진구 소리로 68 전주동물원 <br>
			지번: 덕진동1가 73-48 전주동물원
		</div>
		</div>
		</div>
</body>
