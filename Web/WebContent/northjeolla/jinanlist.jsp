...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">마이산</font>
			</div>
			<div class="admin4">
				<font class="board2">운일암 반일암 계곡</font>
			</div>
			<div class="slideshow">
					<a href="maishan.jsp" class="aaa"><img src=".\..\img\마이산.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="unilam.jsp" class="aaa"><img src=".\..\img\운일암반일암계곡.jpg" width="550" height="250" align="left"/></a>
			</div>
			<table class="admin">
			</table>
			<div class="admin3">
				<font class="board2">용담호</font>
			</div>
			<div class="slideshow">
					<a href="yongdamho.jsp" class="aaa"><img src=".\..\img\용담호.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>