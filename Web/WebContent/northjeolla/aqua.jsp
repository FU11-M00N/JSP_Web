...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.632253,126.469948); // 위치값 위도 경도
	var Y_point			= 35.632253;		// Y 좌표
	var X_point			= 126.469948;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "변산 아쿠아 월드";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>변산 아쿠아 월드</h2>'+
	'<p>부안군 변산면 변산해변로 51</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">변산 아쿠아 월드</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\아쿠아월드.jpg" width="500" height="250"/>		     
		</div>
		
		<div class="board2"><br>
			변산반도 격포해수욕장 바로 옆에 위치한 지상 8층, 지하 3층 규모의 소노벨 변산은 프랑스 북부의 노르망디 해안을 모티브 삼아 탄생한 유럽풍의 리조트이다 <br>
			바다를 바로보며 노천욕과 물놀이를 즐길 수 있게 마련한 아쿠아월드는 지하1층, 지상 2층에 야외 파도풀과 슬라이드는 물론 아쿠아풀, 노천탕, 남녀 사우나 등 쾌적시설을 갖추고 있다 <br><br>
			
			위치: 전라북도 부안군 변산면 변산해변로 51
		</div>
		</div>
		</div>
</body>
