	...
	<div>
		...
		<tbody>
		  <tr>
		    ...
		    <td class="bottom" style="font-weight:bold"><a href=".\..\northjeolla\gochanglist.jsp" class="aaa">부안</a></td>
		  </tr>
		</tbody>
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">변산 아쿠아 월드</font>
			</div>
			<div class="admin4">
				<font class="board2">변산 해수욕장</font>
			</div>
			<div class="slideshow">
					<a href="aqua.jsp" class="aaa"><img src=".\..\img\아쿠아월드.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="beach.jsp" class="aaa"><img src=".\..\img\해수욕장.jpg" width="550" height="250" align="left"/></a>
			</div>
			<table class="admin">
			</table>
			<div class="admin3">
				<font class="board2">채석강</font>
			</div>
			<div class="slideshow">
					<a href="chaeseokgang.jsp" class="aaa"><img src=".\..\img\채석강.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>