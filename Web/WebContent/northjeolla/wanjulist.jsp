...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">고산 자연휴양림</font>
			</div>
			<div class="admin4">
				<font class="board2">대둔산 도립공원</font>
			</div>
			<div class="slideshow">
					<a href="natural.jsp" class="aaa"><img src=".\..\img\고산자연휴양림.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="daedunsan.jsp" class="aaa"><img src=".\..\img\대둔산.JPG" width="550" height="250" align="left"/></a>
			</div>
			<table class="admin">
			</table>
			<div class="admin3">
				<font class="board2">대아 수목원</font>
			</div>
			<div class="slideshow">
					<a href="arboretum.jsp" class="aaa"><img src=".\..\img\대아수목원.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>