...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">미륵사지</font>
			</div>
			<div class="admin4">
				<font class="board2">교도소 세트장</font>
			</div>
			<div class="slideshow">
					<a href="maitreya.jsp" class="aaa"><img src=".\..\img\미륵사지.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="prison.jsp" class="aaa"><img src=".\..\img\교도소세트장.jpg" width="550" height="250" align="left"/></a>
			</div>
			<table class="admin">
			</table>
			<div class="admin3">
				<font class="board2">보석 박물관</font>
			</div>
			<div class="slideshow">
					<a href="jewelry.jsp" class="aaa"><img src=".\..\img\보석박물관.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>