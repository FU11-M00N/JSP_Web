...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">고창읍성</font>
			</div>
			<div class="admin4">
				<font class="board2">보리나라 학원농장</font>
			</div>
			<div class="slideshow">
					<a href="eupseong.jsp" class="aaa"><img src=".\..\img\고창읍성.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="barley.jsp" class="aaa"><img src=".\..\img\보리나라학원농장.jpg" width="550" height="250" align="left"/></a>
			</div>
			<table class="admin">
			</table>
			<div class="admin3">
				<font class="board2">선운사</font>
			</div>
			<div class="slideshow">
					<a href="seonunsa.jsp" class="aaa"><img src=".\..\img\선운사.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>