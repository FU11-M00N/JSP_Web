...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.878626,127.480141); // 위치값 위도 경도
	var Y_point			= 35.878626;		// Y 좌표
	var X_point			= 127.480141;		// X 좌표
	var zoomLevel		= 15;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "용담호";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">용담호</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\용담호.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			용담호에는 용담댐이 있지만 이곳에서는 전기를 생산하지 않는다. 금강 최상류에 건설된 대형 댐이라 홍수 조절 기능도 있겠으나 <br>
			기본적으로 전라북도와 충청남도의 고질적인 물 부족 문제를 해결하기 위해 만든 댐이다용담댐은 1990년에 착공해 2001년에 완공했으며, <br>
			댐에는 홍수 조절을 위해 5개의 여수로가 갖추어져 있다. 이곳 물은 직경 3.2m, 길이 21.9㎞의 도수터널을 통해 전라북도 완주군의 고산정수장으로 <br>
			보내지면서 금강의 물이 만경강으로 유역을 바꾼다. 도수터널 끝에 있는 수력발전소에서 연간 1억 9800만㎾의 전력을 생산한다  <br><br>
	
			위치: 전북 진안군 용담면 월계리 용담호
		</div>
		</div>
</body>
</html>