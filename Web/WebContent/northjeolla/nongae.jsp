...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.678336,127.620389); // 위치값 위도 경도
	var Y_point			= 35.678336;		// Y 좌표
	var X_point			= 127.620389;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "논개생가";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>논개생가</h2>'+
	'<p>장수군 장계면 대곡리 1013</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">논개생가</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\논개생가.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			임진왜란 때 왜장을 끌어안고 남강에 뛰어들어 함께 죽은 논개(論介 ?~1593)를 기리기 위해 조성한 곳이다. 논개의 성은 주씨(朱氏)이고, 전라북도 장수군 장계면 대곡리 주촌마을에서 태어났다 <br>
			1986년 대곡저수지(오동제)를 만들면서 논개가 태어난 마을 전체가 수몰되자 저수지 근처에 생가만 복원해두었다가 1996년부터 2000년에 걸쳐 조성한 현재의 위치에 새로 복원하였다 <br><br>
	
			위치: 전라북도 장수군 장계면 대곡리 1013
		</div>
		</div>
</body>
</html>