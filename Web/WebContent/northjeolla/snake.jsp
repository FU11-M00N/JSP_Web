...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.365517,127.583024); // 위치값 위도 경도
	var Y_point			= 35.365517;		// Y 좌표
	var X_point			= 127.583024;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "뱀사골 계곡";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>뱀사골 계곡</h2>'+
	'<p>남원시 산내면 부운리 산 93-4</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">뱀사골 계곡</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\뱀사골.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			지리산 북쪽 기슭에 위치한 뱀사골계곡은 토끼봉과 삼도봉 사이의 화개재에서 남원시 산내면 반선리 집단시설지구까지 12km, 장장 39여리의 물줄기의 웅장한 계곡이다 <br>
			반야봉과 토끼봉에서 남원시 산내면으로 뻗어내린 골짜기의 가을단풍은 아름답기가 피아골의 단풍과 우열을 가르기 힘들다. 옛날 송림사라는 절의 전설 때문에 뱀사골이라고 불리워졌다 한다 <br>
			계곡은 언제 찾아도 수량이 풍부하고, 수림이 울창하여 대표적인 여름피서지로도 유명하다. 가을철에 이곳을 찾으면, 불붙는 단풍과 암반 위로 흐르는 계류, 그 아래로 형성된 담소들이 <br>
 			한데 어우러져 일대 장관을 이루어 발길을 붙잡는다. 선인대, 석실, 요룡대, 탁용소, 병소, 병풍소, 제승대, 간장소 등과 같은 명승지가 도처에 있다 <br><br>
			
			위치: 전라북도 남원시 산내면 부운리 산 93-4
		</div>
		</div>
</body>
</html>