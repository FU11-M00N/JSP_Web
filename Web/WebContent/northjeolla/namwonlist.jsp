...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">광한루원</font>
			</div>
			<div class="admin4">
				<font class="board2">뱀사골 계곡</font>
			</div>
			<div class="slideshow">
					<a href="gwanghalluwon.jsp" class="aaa"><img src=".\..\img\광한루원.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="snake.jsp" class="aaa"><img src=".\..\img\뱀사골.jpg" width="550" height="250" align="left"/></a>
			</div>
			<table class="admin">
			</table>
			<div class="admin3">
				<font class="board2">춘향 테마파크</font>
			</div>
			<div class="slideshow">
					<a href="choonhyang.jsp" class="aaa"><img src=".\..\img\춘향테마파크.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>