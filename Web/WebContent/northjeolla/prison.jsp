...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.069396,126.931538); // 위치값 위도 경도
	var Y_point			= 36.069396;		// Y 좌표
	var X_point			= 126.931538;		// X 좌표
	var zoomLevel		= 14;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "교도소 세트장";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">교도소 세트장</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\교도소세트장.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			누구도 넘지 못할 높은 담, 차가운 철문과 쇠창살, 세상과 철저히 격리된 시간과 공간…. 교도소 하면 가장 먼저 떠오르는 잔상이다. 교도소는 죄를 짓지 않는 이상 들어가려야 갈 수 없는 곳이다 <br>
			하지만 전북 익산에는 교도소의 모습을 그대로 본떠 만든 교도소세트장이 있다. 한 번도 본 적 없는 교도소 내부를 둘러보는 느낌은 어떨까? 을씨년스럽고 독특한 풍경을 선사하는 교도소세트장을 찾아가보자 <br><br>
			
			위치: 전라북도 익산시 성당면 함낭로 207
		</div>
		</div>
</body>
</html>