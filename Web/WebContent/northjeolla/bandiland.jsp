...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.012439,127.759343); // 위치값 위도 경도
	var Y_point			= 36.012439;		// Y 좌표
	var X_point			= 127.759343;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "반디랜드";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>반디랜드</h2>'+
	'<p>무주군 설천면 무설로 1398-49</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">반디랜드</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\반디랜드.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			설천면에 있는 반디랜드는 단순히 반딧불이만을 테마로 한 곳은 아니다 <br>
			곤충박물관과 천문과학관, 청소년수련원과 야영장, 환경테마공원 등이 모여 있는 생태문화체험명소다주차장에 내리면 수생식물들로 어우러진 자그마한 연못을 건너게 된다 <br>
			목제 다리 양옆에 놓인 반딧불이 캐릭터를 비롯하여 만화영화 속에서 만났던 친숙한 주인공들, 그리고 아기자기한 조경시설들이 관람객들의 마음을 편하게 해준다. 특히, 어린이들이 좋아한다 <br><br>
	
			위치: 전북 무주군 설천면 무설로 1398-49
		</div>
		</div>
</body>
</html>