...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.431186,126.703631); // 위치값 위도 경도
	var Y_point			= 35.431186;		// Y 좌표
	var X_point			= 126.703631;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "고창읍성";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">고창읍성</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\고창읍성.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			조선 시대 읍성들은 평야 지대에 양면을 돌로 쌓아 만들었고, 성문 위에는 누각을 지어 적을 감시하고 전투를 지휘했으며, 성안에서는 관민이 함께 생활하였다 <br>
			그런데 고창읍성은 나지막한 야산을 이용하여 바깥쪽만 성을 쌓고 해자(垓字)를 팠으며, 성안에서는 관아만 만들고 주민들은 성 밖에서 생활하다가 유사시에 성안으로 들어와 함께 싸우며 살 수 있도록 네 개의 우물과 두 개의 연목을 만들어놓았다 <br>
			성벽을 쌓은 자연석은 거칠게 다듬어 굄돌을 넣는 방식으로 쌓았으나, 그 가운데는 초석(礎石), 당간지주(幢竿支柱) 같은 것을 깨뜨려 쓴 것도 있다. 그러나 미석[성의 맨 아래에 성벽 바깥으로 내밀게 깐 얇은 돌] 이하의 성갈퀴는 별로 남아 있지 않다 <br>
			게다가 북문인 공북루의 주춧돌 높이는 제각각이라 1m쯤 되는 것이 있는가 하면 아예 땅에 깔려 기둥이 바닥까지 내려온 것도 있어 이채롭다. 특히 성벽에 전라도 도민들이 총동원하여 축성함으로써 안보총화의 예지와 <br>
 			외침을 대비한 유비무환의 풍토를 조성했던 산 증거들이 각자되어 있다. 고창읍성은 1965년 4월 1일 사적 제145호로 지정되었다 <br><br>
