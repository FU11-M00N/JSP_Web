...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.403428,127.379404); // 위치값 위도 경도
	var Y_point			= 35.403428;		// Y 좌표
	var X_point			= 127.379404;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "광한루원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">광한루원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\광한루원.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			적 우리 조상들은 자연에 순응하고 자연을 거슬려서는 안된다는 생각으로 조성에 세심한 배려를 하여 신선이 사는 이상향을 이 땅에 건립하고자 하였으며 이러한 생각은 <br>
			분합문을 달아 열어놓고 지내어 건물이 탁 트이게 처리하였다. 또한 누원앞에 호수는 은하를 상징하도록 하여 하늘의 옥황상제가 사는 곳처럼 꾸며서 월궁의 광한청허부와 <br>
 			같다고 한 광한루라는 이름을 얻게 되었다. 정원은 인공적인 멋을 가리지 않고 토양 구릉을 자연 그대로 살렸으며 드믄드믄 자연석 고인돌을 구릉에 그대로 놓아 작은 언덕 <br>
 			공간처럼 하고 정원수도전지를 하지 않고 자연 그대로 자라도록 하여 흡사 숲속에 있는 착각이 들게 한다.이러한 연유로 건축기술과 사회상 생활 이상향 등 <br>
 			당시의 문화를 이해하는 중요한 사적지로 높이 평가되고 있다 <br><br>
