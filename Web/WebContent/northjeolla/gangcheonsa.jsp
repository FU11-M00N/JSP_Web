...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.398647,127.055544); // 위치값 위도 경도
	var Y_point			= 35.398647;		// Y 좌표
	var X_point			= 127.055544;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "강천사";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>강천사</h2>'+
	'<p>순창군 팔덕면 강천산길 270 강천사</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">강천사</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\강천사.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			현재 이곳에는 대웅전과 보광전, 관음전, 요사채 등의 건물이 들어서 있다 <br>
			현존하는 문화재로는 대웅전 앞에 있는 전라북도 유형문화재 제92호인 삼층석탑과 금강문(金剛門),삼인대(三印臺:전라북도 유형문화재 27) 등이 있다 <br>
			또한, 삼층석탑 북쪽 약 1m 지점에는 중대석과 보주만이 남아 있는 석등이 있다. 자연암석으로 된 사각문인 금강문은 1316년 덕현이 절 주위의 경치가 금강산과 비슷하다 하여 붙인 이름이라고 한다 <br>
			삼인대는 세 사람의 관인을 소나무에 걸었던 곳이라 하여 붙은 이름이다. 또한 이 절에는 천년 묵은 지네와 거지, 승려, 그리고 돈에 얽힌 전설 등이 전해진다.
			사찰 주변에는 강천산, 담양호, 강천산유원지, 금성산성, 내장산 등이 있다 <br><br>
	
			위치: 전북 순창군 팔덕면 강천산길 270 강천사
		</div>
		</div>
</body>
</html>