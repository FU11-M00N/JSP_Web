...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.366417,127.107533); // 위치값 위도 경도
	var Y_point			= 35.366417;		// Y 좌표
	var X_point			= 127.107533;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "전통고추장 민속마을";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>전통고추장 민속마을</h2>'+
	'<p>순창군 순창읍 백산리 265-66</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">전통고추장 민속마을</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\전통고추장민속마을.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			순창전통고추장민속마을에서는 각 호의 고추장 제조 기능인들이 저마다의 고추장을 생산하여 판매하며, <br>
			재래식된장과 간장, 감·깻잎·오이·마늘·고추·도라지·더덕·매실 등으로 만든 절임류(장아찌) 20여 종을 취급하는데 가격은 집집마다 모두 동일하다 <br>
			2007년 현재 연간 매출액은 330억 원에 이르는데 현장판매는 인터넷 판매를 통해 매출을 올리고 있다 마을은 행정안전부에 의해 정보화마을로 지정되어 있다 <br>
			마을에서 제조되는 장류와 절임류의 품질관리는 순창식품과학연구소에서 맡는다 <br><br>
	
			위치: 전북 순창군 순창읍 백산리 265-66
		</div>
		</div>
</body>
</html>