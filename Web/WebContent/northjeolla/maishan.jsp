...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.762699,127.404725); // 위치값 위도 경도
	var Y_point			= 35.762699;		// Y 좌표
	var X_point			= 127.40472;		// X 좌표
	var zoomLevel		= 14;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "마이산";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>마이산</h2>'+
	'<p>진안군 진안읍 단양리 산 127-1</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">마이산</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\마이산.jpg" width="500" height="250"/>		     
		</div>
		<div class="board2"><br>
			마이산은 계절에 따라 불리는 이름이 다르다.봄에는 안개 속에 우뚝 솟은 두 봉우리가 쌍돛배 같다 하여 돛대봉, 여름에는 수목 사이에서 드러난 봉우리가 용의 뿔처럼 보인다 하여 용각봉(龍角峰), <br>
			가을에는 단풍 든 모습이 말 귀처럼 보인다 해서 마이봉, 겨울에는 눈이 쌓이지 않아 먹물을 찍은 붓끝처럼 보인다해서 문필봉(文筆峰)이라 부르기도 한다 <br><br>

			
			위치: 전라북도 진안군 진안읍 단양리 산 127-1
		</div>
		</div>
</body>
</html>