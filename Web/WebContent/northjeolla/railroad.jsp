...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.981353,126.736377); // 위치값 위도 경도
	var Y_point			= 35.981353;		// Y 좌표
	var X_point			= 126.736377;		// X 좌표
	var zoomLevel		= 15;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "철길 마을";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>철길 마을</h2>'+
	'<p>군산시 경촌4길 14 경암동 539-4</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">철길 마을</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\철길마을.jpg" width="500" height="250"/>		     
		</div>
		
		<div class="board2"><br>
			전북 군산시 경암동 12통. 사람들은 이곳을 철길마을이라고 부른다. 참 묘한 풍경을 지닌 곳이다. 판잣집이 이열횡대로 마주보며 길게 늘어서 있다. 곧 무너질 것만 같다. <br>
			그 사이를 기찻길이 시냇물 흘러가듯 지나간다. 어떻게 이런 풍경이 만들어졌을까 하는 생각이 든다. 이를 두고 골목이라고 불러도 될까? 철길마을의 길은 우리가 생각하는 <br>
			골목길처럼 삐뚤빼뚤하지 않다. 모퉁이도 없고 꺾임도 없다. 좁지도 않다. 골목길의 가장 큰 특징 가운데 하나인 가파른 계단도 없다. 미로처럼 얽혀있는 것도 아니다. 하지만 골목이라 불러도 무방하리라 <br>
			벽, 문, 자동차가 들지 못하는 길 등 우리가 골목에서 기대하는 대부분의 것들이 모여 있고 그것들과 함께 서민들이 생생한 삶을 가꾸고 있다. 한국 근현대사의 한 풍경도 고스란히 간직하고 있다 <br><br>
			
			위치: 전북 군산시 경촌4길 14 경암동 539-4
		</div>
		</div>
		</div>
</body>
