...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.098010,128.401351); // 위치값 위도 경도
	var Y_point			= 36.098010;		// Y 좌표
	var X_point			= 128.401351;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "동락공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>동락공원</h2>'+
	'<p>경상북도 구미시 진평동 766</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">동락공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\동략공원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			동락공원의 환상적인 밤<br><br>

			경상북도 구미시에 위치해있는 동락공원은 민속정원과 국궁장, 롤러스케이트장, 축구장, 배구장, 농구장,야구장, 족구장, 게이트볼장 등 <br>
			체육 단련시설이 갖춰져 있는 공원으로, 구미 시민들이 즐겨 찾는 곳입니다. 특히 야경이 멋진 곳으로 유명한 공원입니다. <br>
			구미 동락공원의 매력은 해 질 녘에 알 수 있는데요,해가 지기 시작하면 풍차에 오색빛의 조명이 들어오고 풍차가 돌아가기 시작합니다.<br>
			가족, 친구, 연인과 여유롭게 산책을 즐기기 더없이 좋은 장소입니다.<br><br>




			
			위치: 경상북도 구미시 진평동 766<br>
		</div>
		</div>
		</div>
</body>
