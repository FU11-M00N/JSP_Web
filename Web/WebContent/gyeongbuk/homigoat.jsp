...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(36.077362,129.569229); // 위치값 위도 경도
	var Y_point			= 36.077362;		// Y 좌표
	var X_point			= 129.569229;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "호미곶 해국자생지";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>호미곶 해국자생지</h2>'+
	'<p>경상북도 포항시 남구 호미곶면 호미곶길 99</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">호미곶 해국자생지</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\호미곶해국자생지.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			우리나라에서 해가 가장 빨리 뜨는 곳<br><br>

			포항 외곽에 위치하여 호미곶과 해국자생지가 이어져 있는 구간이 있습니다. <br>
			이 곳은 우리나라에서 해가 가장 일찍 뜨는 곳으로 이미 포항의 유명 관광지이며,<br>
			탁 트인 일출을 보기 위한 관광객의 발길이 잦습니다. 해가 시작 할 때 가장 많이 찾는 곳이 해돋이 명소인데요,<br>
			해돋이 명소 하면 우리 나라에서 해가 가장 먼저 뜨는 호미곶이 아닐까 합니다.<br><br>
			
			위치: 경상북도 포항시 남구 호미곶면 호미곶길 99<br>
		</div>
		</div>
		</div>
</body>
