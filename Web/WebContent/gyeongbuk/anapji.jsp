...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.834455,129.226626); // 위치값 위도 경도
	var Y_point			= 35.834455;		// Y 좌표
	var X_point			= 129.226626;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "안압지";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>안압지</h2>'+
	'<p>경상북도 경주시 월성동 원화로 102</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">안압지</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\안압지.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			경주의 숨겨진 아름다운 금빛 야경<br><br>

			경상북도 경주시 인교동에 위치해있는 안압지는 신라 때 조성된 인공 연못으로 월성의 북동쪽에 인접해 있습니다. <br>
			본래 이름이 월지였지만, 신라가 망한 뒤로 관리를 하지 않고 방치해 두어 연못에 갈대가 무성하고, 기러기와 오리떼만 몰려와 안압지라 불렸습니다. <br>
			경상북도 경주시 인왕동에 위치해있는 안압지는 신라 문무왕 때 조성된 인공 연못입니다.<br><br>


			
			위치: 경상북도 경주시 월성동 원화로 102<br>
		</div>
		</div>
		</div>
</body>
