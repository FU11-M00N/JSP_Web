...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.807303,129.511299); // 위치값 위도 경도
	var Y_point			= 35.807303;		// Y 좌표
	var X_point			= 129.511299;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "송대말등대 일출";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>송대말등대 일출</h2>'+
	'<p>경상북도 경주시 감포읍 감포로 226-19</p>' +
	...
	<div>
		...
		<thead>
		  <tr>
		    ...
		    <th class="top2"style="font-weight:bold"><a href=".\..\gyeongbuk\kyungjulist.jsp" class="aaa">경주시</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">송대말등대 일출</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\송대말등대일출.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			감은사지 3층 석탑의 모습을 하고 있는 송대말등대<br><br>

			경북 경주시 감포읍에 위치하고 있는 송대말등대는 처음에는 선박들의 해난사고를 방지하기 위하여 지어진 곳이지만, <br>
			후에 문무왕의 은혜를 기리기 위하여 감은사지 3층 석탑의 모양을 형상화 하여 건립이 된 곳 입니다.<br>
			원래 등대는 백색의 원형이었으나 2001년 등대를 종합정비하면서 신라시대를 대표하고 문무왕의 은혜를 기리기 위해 <br>
			'감은사지3층석탑'모양으로 형상화 해 놓았습니다.<br><br>



			
			위치: 경상북도 경주시 감포읍 감포로 226-19<br>
		</div>
		</div>
		</div>
</body>
