...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(34.737104,127.740609); // 위치값 위도 경도
	var Y_point			= 34.737104;		// Y 좌표
	var X_point			= 127.740609;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "여수항 해양공원";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" style="font-weight:bold"><a href=".\..\jeollanamdo\yeosulist.jsp" class="aaa">여수</a></th>
		    <th class="top2"><a href=".\..\jeollanamdo\suncheonlist.jsp" class="aaa">순천</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		    <td class="bottom"><a href=".\..\jeollanamdo\damyanglist.jsp" class="aaa">담양</a></td>
		    <td class="bottom2"><a href=".\..\jeollanamdo\haenamlist.jsp" class="aaa">해남</a></td>
		  </tr>
		</tbody>
		<div>
		<table class="admin2">
			<tr>
				<td align="left" class="board2">여수항 해양공원</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\여수항해양공원.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			아름다운 여수밤바다를 즐길 수 있는 곳 <br>
			여수의 화려한 밤바다를 즐길 수 있는 여수항해양공원은 돌산대교와 거북선대교 사이에 위치해있으며, <br>
			바라만보아도 힐링할 수 있어 연인들의 데이트장소로 인기가 좋습니다. 가수 '버스커버스커'의 노래로 더 유명해진 여수밤바다는 노랫말로도 멋스러운 풍경이 그려지는데요 <br>
			여수항해변공원에는 많은 카페들이 자리해있어 차 한 잔 즐기며 야경을 감상하기도 좋고, 공원 내 비춰지는 다양한 조명으로 한층 더 멋스러운 분위기를 즐겨볼 수 있답니다 <br><br>
