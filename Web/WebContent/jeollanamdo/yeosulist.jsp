...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">여수항 해양공원</font>
			</div>
			<div class="admin4">
				<font class="board2">돌산공원</font>
			</div>
			<div class="slideshow">
					<a href="yeosuhang.jsp" class="aaa"><img src=".\..\img\여수항해양공원.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="dolsan.jsp" class="aaa"><img src=".\..\img\돌산공원.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>