...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">고산 윤선도 유적지</font>
			</div>
			<div class="admin4">
				<font class="board2">해남향교</font>
			</div>
			<div class="slideshow">
					<a href="gosan.jsp" class="aaa"><img src=".\..\img\고산윤선도유적지.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="hyangkyo.jsp" class="aaa"><img src=".\..\img\해남향교.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>