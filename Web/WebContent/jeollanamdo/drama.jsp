...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(34.957010,127.537601); // 위치값 위도 경도
	var Y_point			= 34.957010;		// Y 좌표
	var X_point			= 127.53760;		// X 좌표
	var zoomLevel		= 19;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "순천 드라마 촬영장";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>순천 드라마 촬영장</h2>'+
	'<p>순천시 왕조2동 비례골길 24</p>' +
	...
	<div>
		...
		<thead>
		  <tr>
		    ...
		    <th class="top2" style="font-weight:bold"><a href=".\..\jeollanamdo\suncheonlist.jsp" class="aaa">순천</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">순천 드라마 촬영장</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\순천드라마세트장.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			6080 추억의 드라마들의 촬영장소 <br>
			순천의 관광명소로 손꼽히는 순천드라마세트장은 많은 드라마와 영화 촬영지로, <br>
			옛 시대의 분위기와 상황을 그대로 살려 드라마 속 주인공이 된 것 같은 기분을 느낄 수 있는 곳입니다 <br>
			1960년대부터 80년대까지 시대별로 3개 마을 200여 채가 조성되어 국내 최대 규모를 자랑하는 곳으로, 최근 인기 드라마의 무대가 된 촬영장소입니다 <br><br>

 
			위치: 전남 순천시 왕조2동 비례골길 24
		</div>
		</div>
		</div>
</body>
