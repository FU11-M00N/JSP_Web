...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">광주 학생 독립운동기념관</font>
			</div>
			<div class="admin4">
				<font class="board2">시립미술관</font>
			</div>
			<div class="slideshow">
					<a href="independent.jsp" class="aaa"><img src=".\..\img\광주학생독립운동기념관.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="citymuseum.jsp" class="aaa"><img src=".\..\img\시립미술관.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>