...
$(document).ready(function() {
	...
	var markerTitle		= "지산재";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>지산재</h2>'+
	'<p>광주광역시 남구 지산재길 51 (양과동)</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">지산재</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\지산재.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			오랜 역사의 흔적을 간직하고 있는 곳<br><br>

			광주광역시 남구에 위치한 지산재는 고운 최치원의 신주를 모시고 있는 곳으로 오랜 역사의 흔적과 고즈넉한 분위기를 간직하고 있으며, <br>
			사계절 아름다운 경관을 감상할 수 있습니다. 1846년에 지산사를 새로 건립하여 최치원을 주벽으로 최운하, 최양안 등을 모셨으나<br>
			1886년 대원군의 서원철폐로 영당만 남고 모두 철거되었다고 합니다.<br><br>

			
			위치: 광주광역시 남구 지산재길 51 (양과동)<br>
		</div>
		</div>
		</div>
</body>
