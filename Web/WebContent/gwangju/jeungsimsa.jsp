...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.128958,126.969886); // 위치값 위도 경도
	var Y_point			= 35.128958;		// Y 좌표
	var X_point			= 126.969886;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "증심사";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>증심사</h2>'+
	'<p>광주광역시 동구 학운동 증심사길 177</p>' +
...
<body>
	...
	<div>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">증심사</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\증심사.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			수많은 보물을 간직하고 있는 곳<br>

			무등산의 서쪽자락에 위치한 중심사는 무등산을 배경으로 둘러보기 좋은 사찰로 석탑, 오백전 등 수많은 보물들이 자리하고 있어 <br>
			아름다운 볼거리를 눈과 마음에 담아볼 수 있습니다. 증심사는 수려한 산세의 무등산을 배경으로 산책을 즐기며 돌아보기 좋은 사찰로 <br>
			광주문화재자료 제1호로 지정되어 있는 문화재입니다.<br><br>
			
			위치: 광주광역시 동구 학운동 증심사길 177<br>
