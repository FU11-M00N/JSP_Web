...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(35.133134,126.961468); // 위치값 위도 경도
	var Y_point			= 35.133134;		// Y 좌표
	var X_point			= 126.961468;		// X 좌표
	var zoomLevel		= 16;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "문빈정사";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" style="font-weight:bold"><a href=".\..\gwangju\gwangjudonggulist.jsp" class="aaa">동구</a></th>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">문빈정사</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\문빈정사.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			여유로운 산책을 즐길 수 있는 사찰<br><br>

			무등산의 수려한 산세와 조화롭게 어우러져 있는 문빈정사는 정갈하고 아늑하게 꾸며진 정원과 멋스러운 사찰의 <br>
			건축물 등 눈에 담는 모든 것이 볼거리가 되고 있어 산책을 즐기며 쏠쏠한 재미를 느낄 수 있습니다. <br>
			문빈정사는 수려한 산세를 자랑하는 무등산을 배경으로 산책을 즐기며 둘러보기 좋은 사찰로 기존에 옛 절터였던 곳을 1959년에 다시 창건한 곳입니다.<br><br>
			
			위치: 광주광역시 동구 운림동 96<br>
