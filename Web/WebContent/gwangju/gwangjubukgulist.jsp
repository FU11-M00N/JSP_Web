...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">충효동 왕버들군</font>
			</div>
			<div class="admin4">
				<font class="board2">광주 패밀리랜드</font>
			</div>
			<div class="slideshow">
					<a href="wangbudlegun.jsp" class="aaa"><img src=".\..\img\충효동왕버들군.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="familyland.jsp" class="aaa"><img src=".\..\img\광주패밀리랜드.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>