...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">문빈정사</font>
			</div>
			<div class="admin4">
				<font class="board2">증심사</font>
			</div>
			<div class="slideshow">
					<a href="munbinjungsa.jsp" class="aaa"><img src=".\..\img\문빈정사.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="jeungsimsa.jsp" class="aaa"><img src=".\..\img\증심사.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>