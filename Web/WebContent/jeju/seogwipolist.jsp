...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">안덕계곡</font>
			</div>
			<div class="admin4">
				<font class="board2">헬로키티 아일랜드</font>
			</div>
			<div class="slideshow">
					<a href="andeok.jsp" class="aaa"><img src=".\..\img\안덕계곡.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="hellokitty.jsp" class="aaa"><img src=".\..\img\헬로키티아일랜드.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>