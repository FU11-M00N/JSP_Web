...
<body>
	...
	<div>
		...
		<div>
			<table></table>
			<div class="admin2">
				<font class="board2">만장굴</font>
			</div>
			<div class="admin4">
				<font class="board2">곽지 해수욕장</font>
			</div>
			<div class="slideshow">
					<a href="manjanggul.jsp" class="aaa"><img src=".\..\img\만장굴.jpg" width="550" height="250" /></a>
			</div>			
			<div class="slideshow2">
					<a href="kwakjibeach.jsp" class="aaa"><img src=".\..\img\곽지해수욕장.jpg" width="550" height="250" align="left"/></a>
			</div>
		</div>
</body>
</html>