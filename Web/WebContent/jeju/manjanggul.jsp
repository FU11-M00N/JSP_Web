...
$(document).ready(function() {
	var myLatlng = new google.maps.LatLng(33.528532,126.771476); // 위치값 위도 경도
	var Y_point			= 33.528532;		// Y 좌표
	var X_point			= 126.771476;		// X 좌표
	var zoomLevel		= 17;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "만장굴";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기
	
	//말풍선 내용
	var contentString	= '<div>' +
	'<h2>만장굴</h2>'+
	'<p>제주시 구좌읍 만장굴길 182</p>' +
...
<body>
	...
	<div>
		...
		<thead>
		  <tr>
		    <th class="top" style="font-weight:bold"><a href=".\..\jeju\jejulist.jsp" class="aaa">제주</a></th>
		    <th class="top2"><a href=".\..\jeju\seogwipolist.jsp" class="aaa">서귀포</a></th>
		  </tr>
		</thead>
		<tbody>
		  <tr>
		...
		<table class="admin2">
			<tr>
				<td align="left" class="board2">만장굴</td>
			</tr>
		</table>
		<table class="admin">
			<tr>
		...
		<div class="slideshow">
		     <img src=".\..\img\만장굴.jpg" width="500" height="250"/>	     
		</div>
		<div class="board2"><br>
			자연의 신비로움을 느낄 수 있는 곳 <br>
			만장굴은 세계적인 규모의 화산 용암 침하 운동으로 생성된 천연동굴로 유네스코 지정 세계문화유산으로 등록되어 있습니다 <br>
			총 길이 약 7.4km로 세계 최장 길이를 자랑하는 용암동굴인 만장굴은 총연장 13,422km에 달하며, 폭은 2~23m, 천정 높이는 2~30m이며 부분적으로 다층구조를 지니고 있습니다 <br>
			입구에서 1km 지점까지만 관광객들에게 공개되고 있으며, 한 여름에도 11~21℃의 기온을 유지할 만큼 시원함을 느낄 수 있는 곳 입니다 <br><br>
